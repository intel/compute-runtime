...
HWTEST_EXCLUDE_PRODUCT(ModuleTranslationUnitTest, givenAtLeastXeHpgCoreWhenGetInternalOptionsThenCorrectBuildOptionIsSet_IsAtLeastXeCore, IGFX_NVL_XE3G);
...
HWTEST_F(ModuleTranslationUnitTest, GivenNewCachePolicyAndFileWithIntermediateCodWithoutCachePolicyWhenCreatingModuleFromNativeBinaryThenModuleIsRecompiled) {
    VariableBackup ultConfigBackup(&ultHwConfig);
    ultHwConfig.recompileKernelsWhenL1PolicyMissmatch = true;
