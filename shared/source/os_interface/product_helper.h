...
class ProductHelper {
  public:
    ...
    virtual bool overridePatToUCAndCohForDcFlushMitigation(AllocationType allocationType) const = 0;
    virtual bool overridePatToUCAndNonCohForDcFlushMitigation(AllocationType allocationType) const = 0;
