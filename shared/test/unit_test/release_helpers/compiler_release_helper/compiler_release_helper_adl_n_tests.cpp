...
struct CompilerReleaseHelperAdlNTests : public CompilerReleaseHelperTests<12, 4> {
...
TEST_F(CompilerReleaseHelperAdlNTests, whenGettingCapabilitiesThenCorrectPropertiesAreReturned) {
...
TEST_F(CompilerReleaseHelperAdlNTests, whenIsForceEmuInt32DivRemSPRequiredCalledThenFalseReturned) {
