...
class DrmMock : public Drm {
  public:
    ...
    std::map<unsigned long, uint32_t> ioctlRequestCallCount = {
        {DRM_IOCTL_GEM_CLOSE, 0u},
        {DRM_IOCTL_I915_GEM_EXECBUFFER2, 0u},
        {DRM_IOCTL_I915_GEM_USERPTR, 0u},
        {DRM_IOCTL_I915_GEM_WAIT, 0u}};
    std::map<uint32_t, unsigned long> tearDownIoctlRequestExpects{};
