...
TEST_F(CompilerReleaseHelperDg2G12Tests, whenGettingCapabilitiesThenCorrectPropertiesAreReturned) {
    for (auto &revision : getRevisions()) {
        ...
        EXPECT_TRUE(compilerReleaseHelper->isSplitMatrixMultiplyAccumulateSupported());
