...
DECLARE_DEBUG_VARIABLE(bool, EnableFlushTaskSubmission, true, "true: driver uses csr flushTask for immediate submissions, false: driver uses legacy executeCommandList path")
