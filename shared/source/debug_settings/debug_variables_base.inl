...
DECLARE_DEBUG_VARIABLE(int32_t, ProgramBarrierInCommandStreamTask, -1, "Program barrier pipecontrol in task command stream. -1: default(disabled), 0: disabled (program in CSR command stream, 1: enabled")
