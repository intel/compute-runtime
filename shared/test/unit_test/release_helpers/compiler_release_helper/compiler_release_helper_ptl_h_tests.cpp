...
TEST_F(CompilerReleaseHelperPtlHTests, whenGettingCapabilitiesThenCorrectPropertiesAreReturned) {
    for (auto &revision : getRevisions()) {
        ...
        EXPECT_EQ(revision != 0, compilerReleaseHelper->getFtrXe2Compression());
