...
typedef struct tagMEDIA_SURFACE_STATE {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t Reserved115_5 : BITFIELD_RANGE(5, 11);
            uint32_t Reserved_12 : BITFIELD_RANGE(12, 15);
            uint32_t Reserved_16 : BITFIELD_RANGE(16, 19);
            uint32_t Reserved_20 : BITFIELD_RANGE(20, 26);
            uint32_t Reserved_27 : BITFIELD_RANGE(27, 29);
            ...
            // DWORD 4
            uint32_t Reserved_128 : BITFIELD_RANGE(0, 14);
            uint32_t Reserved_143 : BITFIELD_RANGE(15, 15);
            uint32_t Reserved_144 : BITFIELD_RANGE(16, 29);
        ...
        struct tagSurfaceFormatIsOneOfPlanarFormats {
            // DWORD 0
            uint32_t Reserved_0 : BITFIELD_RANGE(0, 4);
            uint32_t Reserved_5 : BITFIELD_RANGE(5, 11);
            uint32_t Reserved_12 : BITFIELD_RANGE(12, 15);
            uint32_t YOffset : BITFIELD_RANGE(16, 19);
            uint32_t XOffset : BITFIELD_RANGE(20, 26);
            uint32_t Reserved_27 : BITFIELD_RANGE(27, 29);
            uint32_t Reserved_30 : BITFIELD_RANGE(30, 31);
            // DWORD 1
            uint32_t Reserved_32 : BITFIELD_RANGE(0, 1);
            uint32_t Reserved_34 : BITFIELD_RANGE(2, 3);
            uint32_t Reserved_36 : BITFIELD_RANGE(4, 17);
            uint32_t Reserved_50 : BITFIELD_RANGE(18, 31);
            // DWORD 2
            uint32_t Reserved_64 : BITFIELD_RANGE(0, 1);
            uint32_t Reserved_66 : BITFIELD_RANGE(2, 2);
            uint32_t Reserved_67 : BITFIELD_RANGE(3, 20);
            uint32_t Reserved_85 : BITFIELD_RANGE(21, 21);
            uint32_t Reserved_86 : BITFIELD_RANGE(22, 22);
            uint32_t Reserved_87 : BITFIELD_RANGE(23, 23);
            uint32_t Reserved_88 : BITFIELD_RANGE(24, 24);
            uint32_t Reserved_89 : BITFIELD_RANGE(25, 25);
            uint32_t Reserved_90 : BITFIELD_RANGE(26, 26);
            uint32_t Reserved_91 : BITFIELD_RANGE(27, 31);
            // DWORD 3
            uint32_t Reserved_96 : BITFIELD_RANGE(0, 13);
            uint32_t Reserved_110 : BITFIELD_RANGE(14, 15);
            uint32_t Reserved_112 : BITFIELD_RANGE(16, 29);
            uint32_t Reserved_126 : BITFIELD_RANGE(30, 31);
            // DWORD 4
            uint32_t Reserved_128 : BITFIELD_RANGE(0, 14);
            uint32_t Reserved_143 : BITFIELD_RANGE(15, 15);
            ...
            uint32_t Reserved_161 : BITFIELD_RANGE(1, 6);
            uint32_t Reserved_167 : BITFIELD_RANGE(7, 17);
            uint32_t Reserved_178 : BITFIELD_RANGE(18, 19);
            uint32_t Reserved_180 : BITFIELD_RANGE(20, 29);
            uint32_t Reserved_190 : BITFIELD_RANGE(30, 30);
            uint32_t Reserved_191 : BITFIELD_RANGE(31, 31);
            // DWORD 6
            uint32_t Reserved_192;
            // DWORD 7
            uint32_t Reserved_224 : BITFIELD_RANGE(0, 15);
            uint32_t Reserved_240 : BITFIELD_RANGE(16, 31);
    ...
    inline void setWidth(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x3fff0);
    ...
    inline void setHeight(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0xfffc0000);
    ...
    inline void setSurfacePitch(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x1ffff8);
    ...
    inline void setYOffset(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0xf0000);
    ...
    inline void setXOffset(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x7f00000);
...
typedef struct tagMEM_COPY {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t CompressionFormat : BITFIELD_RANGE(8, 12);
            uint32_t DestinationCompressionEnable : BITFIELD_RANGE(13, 13);
            uint32_t Reserved_14 : BITFIELD_RANGE(14, 14);
            uint32_t DestinationCompressible : BITFIELD_RANGE(15, 15);
            uint32_t SourceCompressible : BITFIELD_RANGE(16, 16);
            ...
            // DWORD 1
            uint32_t TransferWidth : BITFIELD_RANGE(0, 17);
            uint32_t Reserved_50 : BITFIELD_RANGE(18, 31);
            // DWORD 2
            ...
            // DWORD 9
            uint32_t DestinationMocs : BITFIELD_RANGE(0, 6);
            uint32_t Reserved_295 : BITFIELD_RANGE(7, 24);
            uint32_t SourceMocs : BITFIELD_RANGE(25, 31);
        } Common;
        uint32_t RawData[10];
    } TheStructure;
    ...
    typedef enum tagDESTINATION_COMPRESSION_ENABLE {
        DESTINATION_COMPRESSION_ENABLE_DISABLE = 0x0,
        DESTINATION_COMPRESSION_ENABLE_ENABLE = 0x1,
    } DESTINATION_COMPRESSION_ENABLE;
    typedef enum tagDESTINATION_COMPRESSIBLE {
        DESTINATION_COMPRESSIBLE_NOT_COMPRESSIBLE = 0x0,
        DESTINATION_COMPRESSIBLE_COMPRESSIBLE = 0x1,
    } DESTINATION_COMPRESSIBLE;
    typedef enum tagSOURCE_COMPRESSIBLE {
        SOURCE_COMPRESSIBLE_NOT_COMPRESSIBLE = 0x0,
        SOURCE_COMPRESSIBLE_COMPRESSIBLE = 0x1,
    } SOURCE_COMPRESSIBLE;
    ...
    inline void init() {
        ...
        TheStructure.Common.DestinationCompressionEnable = DESTINATION_COMPRESSION_ENABLE_DISABLE;
        TheStructure.Common.DestinationCompressible = DESTINATION_COMPRESSIBLE_NOT_COMPRESSIBLE;
        TheStructure.Common.SourceCompressible = SOURCE_COMPRESSIBLE_NOT_COMPRESSIBLE;
    ...
    inline void setDestinationCompressible(const DESTINATION_COMPRESSIBLE value) {
        TheStructure.Common.DestinationCompressible = value;
    }
    inline DESTINATION_COMPRESSIBLE getDestinationCompressible() const {
        return static_cast<DESTINATION_COMPRESSIBLE>(TheStructure.Common.DestinationCompressible);
    }
    inline void setSourceCompressible(const SOURCE_COMPRESSIBLE value) {
        TheStructure.Common.SourceCompressible = value;
    }
    inline SOURCE_COMPRESSIBLE getSourceCompressible() const {
        return static_cast<SOURCE_COMPRESSIBLE>(TheStructure.Common.SourceCompressible);
    }
    ...
    inline void setDestinationX2CoordinateRight(const uint32_t value) {
        ...
        TheStructure.Common.TransferWidth = value - 1;
    }
    inline uint32_t getDestinationX2CoordinateRight() const {
        return TheStructure.Common.TransferWidth + 1;
    }
...
typedef struct tagSAMPLER_STATE {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t Reserved_26 : BITFIELD_RANGE(26, 26);
    ...
    inline void setMaxLod(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0xfff00);
    ...
    inline void setMinLod(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0xfff00000);
...
typedef struct tagSTATE_BASE_ADDRESS {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint64_t Reserved_33 : BITFIELD_RANGE(1, 4);
            ...
            uint64_t GeneralStateBaseAddress : BITFIELD_RANGE(12, 56);
            uint64_t GeneralStateBaseAddressReserved_89 : BITFIELD_RANGE(57, 63);
            // DWORD 3
            ...
            uint64_t Reserved_129 : BITFIELD_RANGE(1, 4);
            ...
            uint64_t Reserved_193 : BITFIELD_RANGE(1, 4);
            ...
            uint64_t InstructionMemoryObjectControlStateReserved_324 : BITFIELD_RANGE(4, 4); // patched
            ...
            uint64_t Reserved_513 : BITFIELD_RANGE(1, 4);
            ...
            uint64_t BindlessSamplerStateMemoryObjectControlStateReserved_612 : BITFIELD_RANGE(4, 4);
    ...
    typedef enum tagCOHERENCY_SETTING_MODIFY_ENABLE {
        COHERENCY_SETTING_MODIFY_ENABLE_DISABLE_WRITE_TO_THIS_DW = 0x0,
        COHERENCY_SETTING_MODIFY_ENABLE_ENABLE_WRITE_TO_THIS_DW = 0x1,
    } COHERENCY_SETTING_MODIFY_ENABLE;
    ...
    inline void init() {
        ...
        TheStructure.Common.CommandType = COMMAND_TYPE_GFXPIPE;
        TheStructure.Common.CoherencySettingModifyEnable = COHERENCY_SETTING_MODIFY_ENABLE_DISABLE_WRITE_TO_THIS_DW;
    ...
    inline void setGeneralStateBaseAddress(const uint64_t value) {
        UNRECOVERABLE_IF(value > 0x1ffffffffffffffL);
    ...
    inline void setCoherencySettingModifyEnable(const COHERENCY_SETTING_MODIFY_ENABLE value) {
        TheStructure.Common.CoherencySettingModifyEnable = value;
    }
    inline COHERENCY_SETTING_MODIFY_ENABLE getCoherencySettingModifyEnable() const {
        return static_cast<COHERENCY_SETTING_MODIFY_ENABLE>(TheStructure.Common.CoherencySettingModifyEnable);
    }
    ...
    inline void setInstructionMemoryObjectControlState(const uint32_t value) { // patched
        ...
        TheStructure.Common.InstructionMemoryObjectControlStateReserved_324 = val;
        TheStructure.Common.InstructionMemoryObjectControlStateIndexToMocsTables = (val >> 1);
    }
    inline uint32_t getInstructionMemoryObjectControlState() const { // patched
        uint64_t mocs = TheStructure.Common.InstructionMemoryObjectControlStateReserved_324;
        mocs |= (TheStructure.Common.InstructionMemoryObjectControlStateIndexToMocsTables << 1);
    ...
    inline void setBindlessSamplerStateMemoryObjectControlStateReserved(const uint64_t value) {
        TheStructure.Common.BindlessSamplerStateMemoryObjectControlStateReserved_612 = value;
    }
...
typedef struct tagMI_CONDITIONAL_BATCH_BUFFER_END {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint64_t CompareAddress : BITFIELD_RANGE(3, 56);
            uint64_t CompareAddressReserved_121 : BITFIELD_RANGE(57, 63);
        } Common;
        uint32_t RawData[4];
    } TheStructure;
    typedef enum tagDWORD_LENGTH {
...
struct XY_FAST_COLOR_BLT {
    union tagTheStructure {
        struct tagCommon {
            ...
            // DWORD 12
            uint32_t DestinationClearAddressHigh : BITFIELD_RANGE(0, 24);
            uint32_t Reserved1 : BITFIELD_RANGE(25, 31);
...
typedef struct tagCOMPUTE_WALKER {
    ...
    inline void setIndirectParameterEnable(const uint32_t value) {
...
typedef struct tagMI_BATCH_BUFFER_START {
    union tagTheStructure {
        struct tagCommon {
            ...
            // DWORD 1
            uint64_t Reserved_32 : BITFIELD_RANGE(0, 1);
            uint64_t BatchBufferStartAddress : BITFIELD_RANGE(2, 56);
            uint64_t BatchBufferStartAddressReserved_89 : BITFIELD_RANGE(57, 63);
        } Common;
        struct tagMi_Mode_Nestedbatchbufferenableis0 {
            ...
            uint32_t Reserved_19 : BITFIELD_RANGE(19, 19);
            uint32_t Reserved_20 : BITFIELD_RANGE(20, 20);
            uint32_t Reserved_21 : BITFIELD_RANGE(21, 21);
            uint32_t SecondLevelBatchBuffer : BITFIELD_RANGE(22, 22);
            uint32_t Reserved_23 : BITFIELD_RANGE(23, 28);
            uint32_t Reserved_29 : BITFIELD_RANGE(29, 31);
            // DWORD 1
            uint64_t Reserved_32 : BITFIELD_RANGE(0, 1);
            uint64_t Reserved_34 : BITFIELD_RANGE(2, 56);
            uint64_t Reserved_89 : BITFIELD_RANGE(57, 63);
...
typedef struct tagMI_SEMAPHORE_WAIT {
    union tagTheStructure {
        struct tagCommon {
            // DWORD 0
            uint32_t DwordLength : BITFIELD_RANGE(0, 7);
            uint32_t SemaphoreWaitContextSwitchMode : BITFIELD_RANGE(8, 9);
            uint32_t Reserved_10 : BITFIELD_RANGE(10, 11);
            uint32_t CompareOperation : BITFIELD_RANGE(12, 14);
            ...
            // DWORD 2
            uint64_t Reserved_64 : BITFIELD_RANGE(0, 1);
            uint64_t SemaphoreAddress : BITFIELD_RANGE(2, 56);
            uint64_t SemaphoreAddressReserved_121 : BITFIELD_RANGE(57, 63);
            // DWORD 4
            uint32_t Reserved_128 : BITFIELD_RANGE(0, 1);
            uint32_t WaitTokenNumber : BITFIELD_RANGE(2, 9);
            uint32_t Reserved_138 : BITFIELD_RANGE(10, 21);
            uint32_t ContextSwitchWaitTime : BITFIELD_RANGE(22, 31);
        } Common;
        uint32_t RawData[5];
    } TheStructure;
    typedef enum tagDWORD_LENGTH {
    ...
    typedef enum tagSEMAPHORE_WAIT_CONTEXT_SWITCH_MODE {
        SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE_LEGACY_MODE = 0x0,
        SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE_CONTEXT_SWITCH_ON_UN_SUCCESSFUL_SEMAPHORE_WAIT = 0x1,
        SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE_INHIBIT_CONTEXT_SWITCH_ON_UN_SUCCESSFUL_SEMAPHORE_WAIT = 0x2,
        SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE_DELAY_CONTEXT_SWITCH_ON_UN_SUCCESSFUL_SEMAPHORE_WAIT = 0x3,
    } SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE;
    typedef enum tagCOMPARE_OPERATION {
    ...
    inline void setSemaphoreWaitContextSwitchMode(const SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE value) {
        TheStructure.Common.SemaphoreWaitContextSwitchMode = value;
    }
    inline SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE getSemaphoreWaitContextSwitchMode() const {
        return static_cast<SEMAPHORE_WAIT_CONTEXT_SWITCH_MODE>(TheStructure.Common.SemaphoreWaitContextSwitchMode);
    }
    inline void setCompareOperation(const COMPARE_OPERATION value) {
        TheStructure.Common.CompareOperation = value;
    }
    ...
    inline void setContextSwitchWaitTime(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0xffc00000);
        TheStructure.Common.ContextSwitchWaitTime = value;
    }
    inline uint32_t getContextSwitchWaitTime() const {
        return TheStructure.Common.ContextSwitchWaitTime;
    }
} MI_SEMAPHORE_WAIT;
...
typedef struct tagMI_STORE_DATA_IMM {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint64_t Reserved_33 : BITFIELD_RANGE(1, 1);
            uint64_t Address : BITFIELD_RANGE(2, 56);
            uint64_t AddressReserved_89 : BITFIELD_RANGE(57, 63);
            // DWORD 3
            uint32_t DataDword0;
            // DWORD 4
            uint32_t DataDword1;
    ...
    inline void setAddress(const uint64_t value) {
        UNRECOVERABLE_IF(value > 0x1fffffffffffffcL);
        TheStructure.Common.Address = value >> ADDRESS_BIT_SHIFT;
    }
...
typedef struct tagMI_STORE_REGISTER_MEM {
    ...
    inline void setRegisterAddress(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x7ffffc);
        TheStructure.Common.RegisterAddress = value >> REGISTERADDRESS_BIT_SHIFT;
    }
    inline uint32_t getRegisterAddress() const {
        return TheStructure.Common.RegisterAddress << REGISTERADDRESS_BIT_SHIFT;
    ...
    inline void setMemoryAddress(const uint64_t value) {
        UNRECOVERABLE_IF(value > 0xfffffffffffffffcL);
        TheStructure.Common.MemoryAddress = value >> MEMORYADDRESS_BIT_SHIFT;
    }
    inline uint64_t getMemoryAddress() const {
        return TheStructure.Common.MemoryAddress << MEMORYADDRESS_BIT_SHIFT;
...
struct MI_MEM_FENCE {
    union tagTheStructure {
        struct tagCommon {
            uint32_t FenceType : BITFIELD_RANGE(0, 0);
            uint32_t Reserved_116 : BITFIELD_RANGE(1, 16);
...
struct STATE_SYSTEM_MEM_FENCE_ADDRESS {
    union tagTheStructure {
        struct tagCommon {
            // DWORD 0
            uint32_t DwordLength : BITFIELD_RANGE(0, 7);
            uint32_t Reserved814 : BITFIELD_RANGE(8, 14);
    ...
    typedef enum tagSYSTEM_MEMORY_FENCE_ADDRESS {
        SYSTEM_MEMORY_FENCE_ADDRESS_BIT_SHIFT = 0xc,
    } SYSTEM_MEMORY_FENCE_ADDRESS;

    inline void init() {
        memset(&TheStructure, 0, sizeof(TheStructure));
        TheStructure.Common.DwordLength = 0x1;
        TheStructure.Common._3DCommandSubOpcode = 0x9;
        TheStructure.Common._3DCommandOpcode = 0x1;
        TheStructure.Common.CommandType = 0x3;
    }

    static STATE_SYSTEM_MEM_FENCE_ADDRESS sInit() {
    ...
    inline void setSystemMemoryFenceAddress(const uint64_t value) {
        TheStructure.Common.SystemMemoryFenceAddress = (value >> SYSTEM_MEMORY_FENCE_ADDRESS_BIT_SHIFT);
    }
    inline uint64_t getSystemMemoryFenceAddress() const {
        return (TheStructure.Common.SystemMemoryFenceAddress << SYSTEM_MEMORY_FENCE_ADDRESS_BIT_SHIFT);
    }
};
STATIC_ASSERT(12 == sizeof(STATE_SYSTEM_MEM_FENCE_ADDRESS));

struct STATE_PREFETCH {
    union tagTheStructure {
        struct tagCommon {
            // DWORD 0
            uint32_t DwordLength : BITFIELD_RANGE(0, 7);
            ...
            uint32_t Reserved1015 : BITFIELD_RANGE(10, 15);
            uint32_t KernelInstructionPrefetch : BITFIELD_RANGE(16, 16);
            uint32_t Reserved1719 : BITFIELD_RANGE(17, 19);
            uint32_t ParserStall : BITFIELD_RANGE(20, 20);
            uint32_t Reserved2123 : BITFIELD_RANGE(21, 23);
            uint32_t MemoryObjectControlState : BITFIELD_RANGE(24, 30);
            uint32_t Reserved31 : BITFIELD_RANGE(31, 31);
            // DWORD 2-3
            uint64_t Reserved05 : BITFIELD_RANGE(0, 5);
    ...
    inline void setMemoryObjectControlState(const uint32_t value) {
        TheStructure.Common.MemoryObjectControlState = value;
    }
    inline uint32_t getMemoryObjectControlState() const {
        return TheStructure.Common.MemoryObjectControlState;
    }
...
typedef struct tagMEM_SET {
    union tagTheStructure {
        struct tagCommon {
            // DWORD 0
            uint32_t DwordLength : BITFIELD_RANGE(0, 7);
            uint32_t CompressionFormat40 : BITFIELD_RANGE(8, 12);
            uint32_t DestinationCompressionEnable : BITFIELD_RANGE(13, 13);
            uint32_t Reserved_14 : BITFIELD_RANGE(14, 14);
            uint32_t DestinationCompressible : BITFIELD_RANGE(15, 15);
            ...
            uint32_t Client : BITFIELD_RANGE(29, 31);
            // DWORD 1
            uint32_t FillWidth : BITFIELD_RANGE(0, 17);
            uint32_t Reserved_50 : BITFIELD_RANGE(18, 31);
            // DWORD 2
            ...
            uint32_t Reserved_114 : BITFIELD_RANGE(18, 31);
            // DWORD 4
            uint64_t DestinationStartAddress;
            // DWORD 6
            uint32_t DestinationMOCS : BITFIELD_RANGE(0, 6);
    ...
    inline void setCompressionFormat40(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x1f);
        TheStructure.Common.CompressionFormat40 = value;
    }
    inline uint32_t getCompressionFormat40() const {
        return TheStructure.Common.CompressionFormat40;
    }
    inline void setDestinationCompressionEnable(const DESTINATION_COMPRESSION_ENABLE value) {
        TheStructure.Common.DestinationCompressionEnable = value;
    }
    ...
    inline void setDestinationStartAddress(const uint64_t value) {
        TheStructure.Common.DestinationStartAddress = value;
    }
    inline uint64_t getDestinationStartAddress() const {
        return TheStructure.Common.DestinationStartAddress;
    }
    inline void setDestinationMOCS(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x7f);
        TheStructure.Common.DestinationMOCS = value;
