...
struct AppendFillEventPacketFixture : public AppendFillFixture {
    void setUp() {
...
using AppendFillSinglePacketEventTest = Test<AppendFillEventPacketFixture<0, 0>>;
...
using MultiTileAppendFillEventSinglePacketTest = Test<AppendFillEventPacketFixture<0, 1>>;
...
using AppendFillKernelSplitAndCompactL3EventTest = Test<AppendFillEventPacketFixture<1, 0>>;
...
using MultiTileAppendFillKernelSplitAndCompactL3EventTest = Test<AppendFillEventPacketFixture<1, 1>>;
