...
using AUBSimpleKernelStatelessTestXe3pCore = Test<KernelAUBFixture<SimpleKernelStatelessFixture>>;

XE3P_CORETEST_F(AUBSimpleKernelStatelessTestXe3pCore, givenPrefetchEnabledWhenEnqueuedKernelThenDataIsCorrect) {
