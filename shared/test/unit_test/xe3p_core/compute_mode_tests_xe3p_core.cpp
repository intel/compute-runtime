...
using ThreadArbitrationXe3pCore = ::testing::Test;
XE3P_CORETEST_F(ThreadArbitrationXe3pCore, whenCallingGetDefaultThreadArbitrationPolicyThenRoundRobinIsReturned) {
...
struct ComputeModeRequirementsXe3pCore : public ComputeModeRequirements {
    void SetUp() override {
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenNewRequiredThreadArbitrationPolicyWhenComputeModeIsProgrammedThenStateComputeIsProgrammedAgain) {
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenCoherencyWithoutSharedHandlesWhenCommandSizeIsCalculatedThenCorrectCommandSizeIsReturned) {
    using STATE_COMPUTE_MODE = typename FamilyType::STATE_COMPUTE_MODE;
    setUpImpl<FamilyType>();
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenNumGrfRequiredChangedWhenCommandSizeIsCalculatedThenCorrectCommandSizeIsReturned) {
    using STATE_COMPUTE_MODE = typename FamilyType::STATE_COMPUTE_MODE;
    setUpImpl<FamilyType>();
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenComputeModeProgrammingWhenLargeGrfModeDoesntChangeButRequiredThreadArbitrationPolicyIsNewThenSCMIsReloaded) {
    setUpImpl<FamilyType>();
    using STATE_COMPUTE_MODE = typename FamilyType::STATE_COMPUTE_MODE;
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenComputeModeProgrammingWhenLargeGrfModeChangedThenSCMIsReloadedAndLargeGrfModeProgrammed) {
    setUpImpl<FamilyType>();
    using STATE_COMPUTE_MODE = typename FamilyType::STATE_COMPUTE_MODE;
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenComputeModeProgrammingWhenLargeGrfRequiredChangedButValueIsDefaultThenSCMIsReloadedButLargeGrfModeNotProgrammed) {
    setUpImpl<FamilyType>();
    using STATE_COMPUTE_MODE = typename FamilyType::STATE_COMPUTE_MODE;
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenComputeModeProgrammingWhenLargeGrfModeChangeIsRequiredThenCorrectCommandsAreAdded) {
    setUpImpl<FamilyType>();
    using STATE_COMPUTE_MODE = typename FamilyType::STATE_COMPUTE_MODE;
...
XE3P_CORETEST_F(ComputeModeRequirementsXe3pCore, givenComputeModeCmdSizeWhenLargeGrfModeChangeIsRequiredThenSCMCommandSizeIsCalculated) {
    setUpImpl<FamilyType>();
    using STATE_COMPUTE_MODE = typename FamilyType::STATE_COMPUTE_MODE;
