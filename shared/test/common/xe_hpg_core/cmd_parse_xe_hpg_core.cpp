...
L3_CONTROL *genCmdCast<L3_CONTROL *>(void *buffer) {
    return matchCommandHeader<L3_CONTROL>(buffer, [](const L3_CONTROL &header) {
        return L3_CONTROL::TYPE_GFXPIPE == header.TheStructure.Common.Type &&
               L3_CONTROL::COMMAND_SUBTYPE_GFXPIPE_3D == header.TheStructure.Common.CommandSubtype &&
               L3_CONTROL::_3D_COMMAND_OPCODE_L3_CONTROL == header.TheStructure.Common._3DCommandOpcode &&
               L3_CONTROL::_3D_COMMAND_SUB_OPCODE_L3_CONTROL == header.TheStructure.Common._3DCommandSubOpcode;
    });
}
