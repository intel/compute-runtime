...
class DeviceQueue : public BaseObject<_device_queue> {
  public:
    ...
    void setupExecutionModelDispatch(IndirectHeap &surfaceStateHeap, IndirectHeap &dynamicStateHeap, Kernel *parentKernel, uint32_t parentCount, TaskCountType taskCount, TagNode<HwTimeStamps> *hwTimeStamp);
    ...
    virtual void addExecutionModelCleanUpSection(Kernel *parentKernel, TagNode<HwTimeStamps> *hwTimeStamp, TaskCountType taskCount);
