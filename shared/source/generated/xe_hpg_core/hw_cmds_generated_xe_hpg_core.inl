...
typedef struct tagPIPE_CONTROL {
    ...
    inline bool getUnTypedDataPortCacheFlush(void) const {
...
typedef struct tagRENDER_SURFACE_STATE {
    ...
    inline uint32_t getDecompressInL3(void) const {
...
typedef struct tagPOSTSYNC_DATA {
    ...
    inline bool getSystemMemoryFenceRequest(void) const {
    ...
    inline bool getDataportSubsliceCacheFlush(void) const {
...
typedef struct tagINTERFACE_DESCRIPTOR_DATA {
    ...
    inline uint32_t getNumberOfBarriers(void) const {
    ...
    inline PREFERRED_SLM_SIZE_OVERRIDE getPreferredSlmSizeOverride(void) const {
    ...
    inline PREFERRED_SLM_ALLOCATION_SIZE_PER_DSS getPreferredSlmAllocationSizePerDss(void) const {
...
typedef struct tagCOMPUTE_WALKER {
    ...
    inline bool getL3PrefetchDisable(void) const {
...
typedef struct tagSTATE_COMPUTE_MODE {
    ...
    inline Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT getZPassAsyncComputeThreadLimit(void) const {
    ...
    inline PIXEL_ASYNC_COMPUTE_THREAD_LIMIT getPixelAsyncComputeThreadLimit(void) const {
