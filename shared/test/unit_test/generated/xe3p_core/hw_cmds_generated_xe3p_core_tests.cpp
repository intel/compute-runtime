...
using CommandsXe3pCoreTest = ::testing::Test;

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMediaSurfaceStateWhenInitCalledThenFieldsSetToDefault) {
    using MEDIA_SURFACE_STATE = NEO::Xe3pCoreFamily::MEDIA_SURFACE_STATE;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMediaSurfaceStateWhenSetterUsedThenGetterReturnsValidValue) {
    using MEDIA_SURFACE_STATE = NEO::Xe3pCoreFamily::MEDIA_SURFACE_STATE;
    MEDIA_SURFACE_STATE cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMemCopyWhenInitCalledThenFieldsSetToDefault) {
    using MEM_COPY = NEO::Xe3pCoreFamily::MEM_COPY;
    MEM_COPY cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMemCopyWhenSetterUsedThenGetterReturnsValidValue) {
    using MEM_COPY = NEO::Xe3pCoreFamily::MEM_COPY;
    MEM_COPY cmd;
    cmd.init();
    ...
    cmd.setSourceBaseAddress(0xffffffffffffffffull);              // patched
    EXPECT_EQ(0xffffffffffffffffull, cmd.getSourceBaseAddress()); // patched

    cmd.setDestinationBaseAddress(0x0u);                               // patched
    EXPECT_EQ(0x0u, cmd.getDestinationBaseAddress());                  // patched
    cmd.setDestinationBaseAddress(0xffffffffffffffffull);              // patched
    EXPECT_EQ(0xffffffffffffffffull, cmd.getDestinationBaseAddress()); // patched
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPipeControlWhenInitCalledThenFieldsSetToDefault) {
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.UntypedDataPortCacheFlush);
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPipeControlWhenSetterUsedThenGetterReturnsValidValue) {
    using PIPE_CONTROL = NEO::Xe3pCoreFamily::PIPE_CONTROL;
    PIPE_CONTROL cmd;
    cmd.init();
    ...
    cmd.setPostSyncOperation(PIPE_CONTROL::POST_SYNC_OPERATION_WRITE_IMMEDIATE_DATA_32B);
    EXPECT_EQ(PIPE_CONTROL::POST_SYNC_OPERATION_WRITE_IMMEDIATE_DATA_32B, cmd.getPostSyncOperation());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiAtomicWhenInitCalledThenFieldsSetToDefault) {
    using MI_ATOMIC = NEO::Xe3pCoreFamily::MI_ATOMIC;
    MI_ATOMIC cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiAtomicWhenSetterUsedThenGetterReturnsValidValue) { // patched
    using MI_ATOMIC = NEO::Xe3pCoreFamily::MI_ATOMIC;
    MI_ATOMIC cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiBatchBufferEndWhenInitCalledThenFieldsSetToDefault) {
    using MI_BATCH_BUFFER_END = NEO::Xe3pCoreFamily::MI_BATCH_BUFFER_END;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiBatchBufferEndWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_BATCH_BUFFER_END = NEO::Xe3pCoreFamily::MI_BATCH_BUFFER_END;
    MI_BATCH_BUFFER_END cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiLoadRegisterImmWhenInitCalledThenFieldsSetToDefault) {
    using MI_LOAD_REGISTER_IMM = NEO::Xe3pCoreFamily::MI_LOAD_REGISTER_IMM;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiLoadRegisterImmWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_LOAD_REGISTER_IMM = NEO::Xe3pCoreFamily::MI_LOAD_REGISTER_IMM;
    MI_LOAD_REGISTER_IMM cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiNoopWhenInitCalledThenFieldsSetToDefault) {
    using MI_NOOP = NEO::Xe3pCoreFamily::MI_NOOP;
    MI_NOOP cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiNoopWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_NOOP = NEO::Xe3pCoreFamily::MI_NOOP;
    MI_NOOP cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenRenderSurfaceStateWhenInitCalledThenFieldsSetToDefault) {
    using RENDER_SURFACE_STATE = NEO::Xe3pCoreFamily::RENDER_SURFACE_STATE;
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.ExtendScratchSurfaceSize);
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.DisableSamplerBackingByLsc);
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenRenderSurfaceStateWhenSetterUsedThenGetterReturnsValidValue) {
    using RENDER_SURFACE_STATE = NEO::Xe3pCoreFamily::RENDER_SURFACE_STATE;
    RENDER_SURFACE_STATE cmd;
    cmd.init();
    ...
    cmd.setExtendScratchSurfaceSize(0x0u);
    EXPECT_EQ(0x0u, cmd.getExtendScratchSurfaceSize());
    cmd.setExtendScratchSurfaceSize(0x1u);
    EXPECT_EQ(0x1u, cmd.getExtendScratchSurfaceSize());
    ...
    cmd.setDisableSamplerBackingByLsc(0x0u);
    EXPECT_EQ(0x0u, cmd.getDisableSamplerBackingByLsc());
    cmd.setDisableSamplerBackingByLsc(0x1u);
    EXPECT_EQ(0x1u, cmd.getDisableSamplerBackingByLsc());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenSamplerStateWhenInitCalledThenFieldsSetToDefault) {
    using SAMPLER_STATE = NEO::Xe3pCoreFamily::SAMPLER_STATE;
    SAMPLER_STATE cmd;
    cmd.init();
    ...
    EXPECT_EQ(SAMPLER_STATE::YCRCB_BORDER_MODE_PASSTHROUGH, cmd.TheStructure.Common.YcrcbBorderMode);
    ...
    EXPECT_EQ(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_FULL, cmd.TheStructure.Common.MipLinearFilterQuality);
    ...
    EXPECT_EQ(0.0f, cmd.TheStructure.ChromakeyEnableIsFalse.BorderColorRed);
    EXPECT_EQ(0.0f, cmd.TheStructure.ChromakeyEnableIsFalse.BorderColorGreen);
    EXPECT_EQ(0x0u, cmd.TheStructure.ChromakeyEnableIsTrue.ChromakeyHigh);
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenSamplerStateWhenSetterUsedThenGetterReturnsValidValue) {
    using SAMPLER_STATE = NEO::Xe3pCoreFamily::SAMPLER_STATE;
    SAMPLER_STATE cmd;
    cmd.init();
    ...
    cmd.setMinModeFilter(SAMPLER_STATE::MIN_MODE_FILTER_ANISOTROPIC_FAST);
    EXPECT_EQ(SAMPLER_STATE::MIN_MODE_FILTER_ANISOTROPIC_FAST, cmd.getMinModeFilter());
    ...
    cmd.setMagModeFilter(SAMPLER_STATE::MAG_MODE_FILTER_ANISOTROPIC_FAST);
    EXPECT_EQ(SAMPLER_STATE::MAG_MODE_FILTER_ANISOTROPIC_FAST, cmd.getMagModeFilter());
    ...
    cmd.setYcrcbBorderMode(SAMPLER_STATE::YCRCB_BORDER_MODE_PASSTHROUGH);
    EXPECT_EQ(SAMPLER_STATE::YCRCB_BORDER_MODE_PASSTHROUGH, cmd.getYcrcbBorderMode());

    cmd.setYcrcbBorderMode(SAMPLER_STATE::YCRCB_BORDER_MODE_TRANSFORM_BLACK);
    EXPECT_EQ(SAMPLER_STATE::YCRCB_BORDER_MODE_TRANSFORM_BLACK, cmd.getYcrcbBorderMode());
    ...
    cmd.setIndirectStatePointer(0x0u);                 // patched
    EXPECT_EQ(0x0u, cmd.getIndirectStatePointer());    // patched
    cmd.setIndirectStatePointer(0x3fc0u);              // patched
    EXPECT_EQ(0x3fc0u, cmd.getIndirectStatePointer()); // patched
    ...
    cmd.setMipLinearFilterQuality(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_FULL);
    EXPECT_EQ(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_FULL, cmd.getMipLinearFilterQuality());

    cmd.setMipLinearFilterQuality(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_HIGH);
    EXPECT_EQ(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_HIGH, cmd.getMipLinearFilterQuality());

    cmd.setMipLinearFilterQuality(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_MEDIUM);
    EXPECT_EQ(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_MEDIUM, cmd.getMipLinearFilterQuality());

    cmd.setMipLinearFilterQuality(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_LOW);
    EXPECT_EQ(SAMPLER_STATE::MIP_LINEAR_FILTER_QUALITY_LOW, cmd.getMipLinearFilterQuality());
    ...
    cmd.setChromakeyHigh(0x0u);
    EXPECT_EQ(0x0u, cmd.getChromakeyHigh());
    cmd.setChromakeyHigh(0xffffffffu);
    EXPECT_EQ(0xffffffffu, cmd.getChromakeyHigh());
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateBaseAddressWhenInitCalledThenFieldsSetToDefault) {
    using STATE_BASE_ADDRESS = NEO::Xe3pCoreFamily::STATE_BASE_ADDRESS;
    ...
    EXPECT_EQ(STATE_BASE_ADDRESS::SAMPLER_ARBITRATION_CONTROL_ROUND_ROBIN, cmd.TheStructure.Common.SamplerArbitrationControl);
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateBaseAddressWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_BASE_ADDRESS = NEO::Xe3pCoreFamily::STATE_BASE_ADDRESS;
    STATE_BASE_ADDRESS cmd;
    cmd.init();
    ...
    cmd.setSamplerArbitrationControl(STATE_BASE_ADDRESS::SAMPLER_ARBITRATION_CONTROL_ROUND_ROBIN);
    EXPECT_EQ(STATE_BASE_ADDRESS::SAMPLER_ARBITRATION_CONTROL_ROUND_ROBIN, cmd.getSamplerArbitrationControl());

    cmd.setSamplerArbitrationControl(STATE_BASE_ADDRESS::SAMPLER_ARBITRATION_CONTROL_EU_BASED);
    EXPECT_EQ(STATE_BASE_ADDRESS::SAMPLER_ARBITRATION_CONTROL_EU_BASED, cmd.getSamplerArbitrationControl());

    cmd.setSamplerArbitrationControl(STATE_BASE_ADDRESS::SAMPLER_ARBITRATION_CONTROL_STATE_BASED);
    EXPECT_EQ(STATE_BASE_ADDRESS::SAMPLER_ARBITRATION_CONTROL_STATE_BASED, cmd.getSamplerArbitrationControl());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiReportPerfCountWhenInitCalledThenFieldsSetToDefault) {
    using MI_REPORT_PERF_COUNT = NEO::Xe3pCoreFamily::MI_REPORT_PERF_COUNT;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiReportPerfCountWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_REPORT_PERF_COUNT = NEO::Xe3pCoreFamily::MI_REPORT_PERF_COUNT;
    MI_REPORT_PERF_COUNT cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiUserInterruptWhenInitCalledThenFieldsSetToDefault) {
    using MI_USER_INTERRUPT = NEO::Xe3pCoreFamily::MI_USER_INTERRUPT;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiUserInterruptWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_USER_INTERRUPT = NEO::Xe3pCoreFamily::MI_USER_INTERRUPT;
    MI_USER_INTERRUPT cmd;
    cmd.init();
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiSetPredicateWhenInitCalledThenFieldsSetToDefault) {
    using MI_SET_PREDICATE = NEO::Xe3pCoreFamily::MI_SET_PREDICATE;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiSetPredicateWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_SET_PREDICATE = NEO::Xe3pCoreFamily::MI_SET_PREDICATE;
    MI_SET_PREDICATE cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiConditionalBatchBufferEndWhenInitCalledThenFieldsSetToDefault) {
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiConditionalBatchBufferEndWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_CONDITIONAL_BATCH_BUFFER_END = NEO::Xe3pCoreFamily::MI_CONDITIONAL_BATCH_BUFFER_END;
    MI_CONDITIONAL_BATCH_BUFFER_END cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenXyBlockCopyBltWhenInitCalledThenFieldsSetToDefault) {
    using XY_BLOCK_COPY_BLT = NEO::Xe3pCoreFamily::XY_BLOCK_COPY_BLT;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenXyBlockCopyBltWhenSetterUsedThenGetterReturnsValidValue) {
    using XY_BLOCK_COPY_BLT = NEO::Xe3pCoreFamily::XY_BLOCK_COPY_BLT;
    XY_BLOCK_COPY_BLT cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenXyFastColorBltWhenInitCalledThenFieldsSetToDefault) { // patched
    using XY_FAST_COLOR_BLT = NEO::Xe3pCoreFamily::XY_FAST_COLOR_BLT;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenXyFastColorBltWhenSetterUsedThenGetterReturnsValidValue) {
    using XY_FAST_COLOR_BLT = NEO::Xe3pCoreFamily::XY_FAST_COLOR_BLT;
    XY_FAST_COLOR_BLT cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiFlushDwWhenInitCalledThenFieldsSetToDefault) {
    using MI_FLUSH_DW = NEO::Xe3pCoreFamily::MI_FLUSH_DW;
    MI_FLUSH_DW cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiFlushDwWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_FLUSH_DW = NEO::Xe3pCoreFamily::MI_FLUSH_DW;
    MI_FLUSH_DW cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, Given3dstateBtdWhenInitCalledThenFieldsSetToDefault) {
    using _3DSTATE_BTD = NEO::Xe3pCoreFamily::_3DSTATE_BTD;
    _3DSTATE_BTD cmd;
    cmd.init();
    ...
    EXPECT_EQ(_3DSTATE_BTD::MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_32, cmd.TheStructure.Common.MaximumBtdLaneOccupancy);
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, Given3dstateBtdWhenSetterUsedThenGetterReturnsValidValue) {
    using _3DSTATE_BTD = NEO::Xe3pCoreFamily::_3DSTATE_BTD;
    _3DSTATE_BTD cmd;
    cmd.init();
    ...
    cmd.setMaximumBtdLaneOccupancy(_3DSTATE_BTD::MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_32);
    EXPECT_EQ(_3DSTATE_BTD::MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_32, cmd.getMaximumBtdLaneOccupancy());

    cmd.setMaximumBtdLaneOccupancy(_3DSTATE_BTD::MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_16);
    EXPECT_EQ(_3DSTATE_BTD::MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_16, cmd.getMaximumBtdLaneOccupancy());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPostsyncDataWhenInitCalledThenFieldsSetToDefault) {
    using POSTSYNC_DATA = NEO::Xe3pCoreFamily::POSTSYNC_DATA;
    POSTSYNC_DATA cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPostsyncDataWhenSetterUsedThenGetterReturnsValidValue) {
    using POSTSYNC_DATA = NEO::Xe3pCoreFamily::POSTSYNC_DATA;
    POSTSYNC_DATA cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPostsyncData2WhenInitCalledThenFieldsSetToDefault) {
    using POSTSYNC_DATA_2 = NEO::Xe3pCoreFamily::POSTSYNC_DATA_2;
    POSTSYNC_DATA_2 cmd;
    cmd.init();
    ...
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_DATA_SIZE_DWORD, cmd.TheStructure.Common.AtomicDataSize);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.AtomicOpcode);
    EXPECT_EQ_VAL(0x0ull, cmd.TheStructure.Common.DestinationAddress); // patched
    EXPECT_EQ_VAL(0x0ull, cmd.TheStructure.Common.Data);               // patched
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPostsyncData2WhenSetterUsedThenGetterReturnsValidValue) {
    using POSTSYNC_DATA_2 = NEO::Xe3pCoreFamily::POSTSYNC_DATA_2;
    POSTSYNC_DATA_2 cmd;
    cmd.init();
    ...
    cmd.setOperation(POSTSYNC_DATA_2::OPERATION_NO_WRITE);
    EXPECT_EQ(POSTSYNC_DATA_2::OPERATION_NO_WRITE, cmd.getOperation());

    cmd.setOperation(POSTSYNC_DATA_2::OPERATION_WRITE_IMMEDIATE_DATA);
    EXPECT_EQ(POSTSYNC_DATA_2::OPERATION_WRITE_IMMEDIATE_DATA, cmd.getOperation());

    cmd.setOperation(POSTSYNC_DATA_2::OPERATION_ATOMIC_OPN);
    EXPECT_EQ(POSTSYNC_DATA_2::OPERATION_ATOMIC_OPN, cmd.getOperation());

    cmd.setOperation(POSTSYNC_DATA_2::OPERATION_WRITE_TIMESTAMP);
    EXPECT_EQ(POSTSYNC_DATA_2::OPERATION_WRITE_TIMESTAMP, cmd.getOperation());

    cmd.setAtomicDataSize(POSTSYNC_DATA_2::ATOMIC_DATA_SIZE_DWORD);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_DATA_SIZE_DWORD, cmd.getAtomicDataSize());

    cmd.setAtomicDataSize(POSTSYNC_DATA_2::ATOMIC_DATA_SIZE_QWORD);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_DATA_SIZE_QWORD, cmd.getAtomicDataSize());

    cmd.setImmediateData(0x0ull);                             // patched
    EXPECT_EQ(0x0ull, cmd.getImmediateData());                // patched
    cmd.setImmediateData(0xffffffffffffffffull);              // patched
    EXPECT_EQ(0xffffffffffffffffull, cmd.getImmediateData()); // patched

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_AND);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_AND, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_OR);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_OR, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_XOR);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_XOR, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MOVE);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MOVE, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_INC);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_INC, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_DEC);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_DEC, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_ADD);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_ADD, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_SUB);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_SUB, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMAX);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMAX, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMIN);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMIN, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMAX);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMAX, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMIN);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMIN, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_CMPWR);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_CMPWR, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_AND8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_AND8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_OR8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_OR8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_XOR8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_XOR8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MOVE8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MOVE8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_INC8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_INC8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_DEC8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_DEC8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_ADD8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_ADD8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_SUB8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_SUB8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMAX8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMAX8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMIN8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_IMIN8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMAX8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMAX8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMIN8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_UMIN8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_CMPWR8B);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_CMPWR8B, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_FADD);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_FADD, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_FSUB);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_FSUB, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MAX_FLOAT32);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MAX_FLOAT32, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MIN_FLOAT32);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_MIN_FLOAT32, cmd.getAtomicOpcode());

    cmd.setAtomicOpcode(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_CMPWR_FLOAT32);
    EXPECT_EQ(POSTSYNC_DATA_2::ATOMIC_OPCODE_ATOMIC_CMPWR_FLOAT32, cmd.getAtomicOpcode());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenInterfaceDescriptorDataWhenInitCalledThenFieldsSetToDefault) {
    using INTERFACE_DESCRIPTOR_DATA = NEO::Xe3pCoreFamily::INTERFACE_DESCRIPTOR_DATA;
    ...
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_32, cmd.TheStructure.Common.RegistersPerThread);
    ...
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::DYNAMIC_PREF_SLM_INCREASE_DISABLE, cmd.TheStructure.Common.DynamicPrefSlmIncrease);
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenInterfaceDescriptorDataWhenSetterUsedThenGetterReturnsValidValue) {
    using INTERFACE_DESCRIPTOR_DATA = NEO::Xe3pCoreFamily::INTERFACE_DESCRIPTOR_DATA;
    INTERFACE_DESCRIPTOR_DATA cmd;
    cmd.init();
    ...
    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_512);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_512, cmd.getRegistersPerThread());
    ...
    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_320K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_320K, cmd.getSharedLocalMemorySize());
    ...
    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_320K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_320K, cmd.getPreferredSlmAllocationSize());
    ...
    cmd.setDynamicPrefSlmIncrease(INTERFACE_DESCRIPTOR_DATA::DYNAMIC_PREF_SLM_INCREASE_DISABLE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::DYNAMIC_PREF_SLM_INCREASE_DISABLE, cmd.getDynamicPrefSlmIncrease());

    cmd.setDynamicPrefSlmIncrease(INTERFACE_DESCRIPTOR_DATA::DYNAMIC_PREF_SLM_INCREASE_MAX_FULL);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::DYNAMIC_PREF_SLM_INCREASE_MAX_FULL, cmd.getDynamicPrefSlmIncrease());

    cmd.setDynamicPrefSlmIncrease(INTERFACE_DESCRIPTOR_DATA::DYNAMIC_PREF_SLM_INCREASE_MAX_2X);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::DYNAMIC_PREF_SLM_INCREASE_MAX_2X, cmd.getDynamicPrefSlmIncrease());
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenInterfaceDescriptorData2WhenInitCalledThenFieldsSetToDefault) {
    using INTERFACE_DESCRIPTOR_DATA_2 = NEO::Xe3pCoreFamily::INTERFACE_DESCRIPTOR_DATA_2;
    INTERFACE_DESCRIPTOR_DATA_2 cmd;
    cmd.init();

    EXPECT_EQ(0x0ull, cmd.TheStructure.Common.KernelStartPointer);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_STALL_BASED_ROUND_ROBIN, cmd.TheStructure.Common.EuThreadSchedulingModeOverride); // patched
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::FLOATING_POINT_MODE_IEEE_754, cmd.TheStructure.Common.FloatingPointMode);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SINGLE_PROGRAM_FLOW_MULTIPLE, cmd.TheStructure.Common.SingleProgramFlow);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::DENORM_MODE_FTZ, cmd.TheStructure.Common.DenormMode);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_32, cmd.TheStructure.Common.RegistersPerThread);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.NumberOfThreadsInGpgpuThreadGroup);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::BTD_MODE_DISABLE, cmd.TheStructure.Common.BtdMode);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_0K, cmd.TheStructure.Common.SharedLocalMemorySize);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RTNE, cmd.TheStructure.Common.RoundingMode);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_8, cmd.TheStructure.Common.ThreadGroupDispatchSize);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_NONE, cmd.TheStructure.Common.NumberOfBarriers);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_60, cmd.TheStructure.Common.ZPassAsyncComputeThreadLimit);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.NpZAsyncThrottleSettings);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_DISABLED, cmd.TheStructure.Common.PsAsyncThreadLimit);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_0K, cmd.TheStructure.Common.PreferredSlmAllocationSize);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::DYNAMIC_PREF_SLM_INCREASE_DISABLE, cmd.TheStructure.Common.DynamicPrefSlmIncrease);
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenInterfaceDescriptorData2WhenSetterUsedThenGetterReturnsValidValue) {
    using INTERFACE_DESCRIPTOR_DATA_2 = NEO::Xe3pCoreFamily::INTERFACE_DESCRIPTOR_DATA_2;
    INTERFACE_DESCRIPTOR_DATA_2 cmd;
    cmd.init();

    cmd.setKernelStartPointer(0x0ull);
    EXPECT_EQ(0x0ull, cmd.getKernelStartPointer());
    cmd.setKernelStartPointer(0xffffffffffffffc0ull);
    EXPECT_EQ(0xffffffffffffffc0ull, cmd.getKernelStartPointer());

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_HW_DEFAULT);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_HW_DEFAULT, cmd.getEuThreadSchedulingModeOverride());

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_OLDEST_FIRST);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_OLDEST_FIRST, cmd.getEuThreadSchedulingModeOverride());

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_ROUND_ROBIN);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_ROUND_ROBIN, cmd.getEuThreadSchedulingModeOverride());

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_STALL_BASED_ROUND_ROBIN);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::EU_THREAD_SCHEDULING_MODE_OVERRIDE_STALL_BASED_ROUND_ROBIN, cmd.getEuThreadSchedulingModeOverride());

    cmd.setFloatingPointMode(INTERFACE_DESCRIPTOR_DATA_2::FLOATING_POINT_MODE_IEEE_754);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::FLOATING_POINT_MODE_IEEE_754, cmd.getFloatingPointMode());

    cmd.setFloatingPointMode(INTERFACE_DESCRIPTOR_DATA_2::FLOATING_POINT_MODE_ALTERNATE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::FLOATING_POINT_MODE_ALTERNATE, cmd.getFloatingPointMode());

    cmd.setSingleProgramFlow(INTERFACE_DESCRIPTOR_DATA_2::SINGLE_PROGRAM_FLOW_MULTIPLE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SINGLE_PROGRAM_FLOW_MULTIPLE, cmd.getSingleProgramFlow());

    cmd.setSingleProgramFlow(INTERFACE_DESCRIPTOR_DATA_2::SINGLE_PROGRAM_FLOW_SINGLE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SINGLE_PROGRAM_FLOW_SINGLE, cmd.getSingleProgramFlow());

    cmd.setDenormMode(INTERFACE_DESCRIPTOR_DATA_2::DENORM_MODE_FTZ);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::DENORM_MODE_FTZ, cmd.getDenormMode());

    cmd.setDenormMode(INTERFACE_DESCRIPTOR_DATA_2::DENORM_MODE_SETBYKERNEL);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::DENORM_MODE_SETBYKERNEL, cmd.getDenormMode());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_32, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_64);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_64, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_96);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_96, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_128);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_128, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_160);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_160, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_192);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_192, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_256);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_256, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_512);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::REGISTERS_PER_THREAD_REGISTERS_512, cmd.getRegistersPerThread());

    cmd.setNumberOfThreadsInGpgpuThreadGroup(0x0u);
    EXPECT_EQ(0x0u, cmd.getNumberOfThreadsInGpgpuThreadGroup());
    cmd.setNumberOfThreadsInGpgpuThreadGroup(0xffu);
    EXPECT_EQ(0xffu, cmd.getNumberOfThreadsInGpgpuThreadGroup());

    cmd.setBtdMode(INTERFACE_DESCRIPTOR_DATA_2::BTD_MODE_DISABLE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::BTD_MODE_DISABLE, cmd.getBtdMode());

    cmd.setBtdMode(INTERFACE_DESCRIPTOR_DATA_2::BTD_MODE_ENABLE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::BTD_MODE_ENABLE, cmd.getBtdMode());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_0K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_0K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_1K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_1K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_2K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_2K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_4K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_4K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_8K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_8K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_16K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_16K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_32K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_32K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_64K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_64K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_24K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_24K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_48K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_48K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_96K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_96K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_128K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_128K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_192K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_192K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_256K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_256K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_320K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_320K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_384K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_384K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_3K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_3K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_5K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_5K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_6K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_6K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_7K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_7K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_9K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_9K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_10K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_10K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_11K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_11K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_12K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_12K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_13K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_13K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_14K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_14K, cmd.getSharedLocalMemorySize());

    cmd.setSharedLocalMemorySize(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_15K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_15K, cmd.getSharedLocalMemorySize());

    cmd.setRoundingMode(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RTNE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RTNE, cmd.getRoundingMode());

    cmd.setRoundingMode(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RU);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RU, cmd.getRoundingMode());

    cmd.setRoundingMode(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RD);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RD, cmd.getRoundingMode());

    cmd.setRoundingMode(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RTZ);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::ROUNDING_MODE_RTZ, cmd.getRoundingMode());

    cmd.setThreadGroupDispatchSize(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_8);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_8, cmd.getThreadGroupDispatchSize());

    cmd.setThreadGroupDispatchSize(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_4);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_4, cmd.getThreadGroupDispatchSize());

    cmd.setThreadGroupDispatchSize(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_2);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_2, cmd.getThreadGroupDispatchSize());

    cmd.setThreadGroupDispatchSize(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_1);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_1, cmd.getThreadGroupDispatchSize());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_NONE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_NONE, cmd.getNumberOfBarriers());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B1);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B1, cmd.getNumberOfBarriers());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B2);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B2, cmd.getNumberOfBarriers());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B4);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B4, cmd.getNumberOfBarriers());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B8);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B8, cmd.getNumberOfBarriers());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B16);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B16, cmd.getNumberOfBarriers());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B24);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B24, cmd.getNumberOfBarriers());

    cmd.setNumberOfBarriers(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NUMBER_OF_BARRIERS_B32, cmd.getNumberOfBarriers());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_60);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_60, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_64);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_64, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_56);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_56, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_48);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_48, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_40);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_40, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_32, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_24);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_24, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_16);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_16, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setNpZAsyncThrottleSettings(INTERFACE_DESCRIPTOR_DATA_2::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_32, cmd.getNpZAsyncThrottleSettings());

    cmd.setNpZAsyncThrottleSettings(INTERFACE_DESCRIPTOR_DATA_2::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_40);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_40, cmd.getNpZAsyncThrottleSettings());

    cmd.setNpZAsyncThrottleSettings(INTERFACE_DESCRIPTOR_DATA_2::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_48);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_48, cmd.getNpZAsyncThrottleSettings());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_DISABLED);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_DISABLED, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_2);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_2, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_8);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_8, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_16);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_16, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_24);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_24, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_32, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_40);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_40, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_48);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PS_ASYNC_THREAD_LIMIT_MAX_48, cmd.getPsAsyncThreadLimit());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_0K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_0K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_16K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_16K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_32K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_32K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_64K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_64K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_96K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_96K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_128K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_128K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_160K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_160K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_192K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_192K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_256K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_256K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_320K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_320K, cmd.getPreferredSlmAllocationSize());

    cmd.setPreferredSlmAllocationSize(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_384K);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_384K, cmd.getPreferredSlmAllocationSize());

    cmd.setDynamicPrefSlmIncrease(INTERFACE_DESCRIPTOR_DATA_2::DYNAMIC_PREF_SLM_INCREASE_DISABLE);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::DYNAMIC_PREF_SLM_INCREASE_DISABLE, cmd.getDynamicPrefSlmIncrease());

    cmd.setDynamicPrefSlmIncrease(INTERFACE_DESCRIPTOR_DATA_2::DYNAMIC_PREF_SLM_INCREASE_MAX_FULL);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::DYNAMIC_PREF_SLM_INCREASE_MAX_FULL, cmd.getDynamicPrefSlmIncrease());

    cmd.setDynamicPrefSlmIncrease(INTERFACE_DESCRIPTOR_DATA_2::DYNAMIC_PREF_SLM_INCREASE_MAX_2X);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA_2::DYNAMIC_PREF_SLM_INCREASE_MAX_2X, cmd.getDynamicPrefSlmIncrease());
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenComputeWalkerWhenInitCalledThenFieldsSetToDefault) {
    using COMPUTE_WALKER = NEO::Xe3pCoreFamily::COMPUTE_WALKER;
    COMPUTE_WALKER cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenComputeWalkerWhenSetterUsedThenGetterReturnsValidValue) { // patched
    using COMPUTE_WALKER = NEO::Xe3pCoreFamily::COMPUTE_WALKER;
    COMPUTE_WALKER cmd;
    cmd.init();
    ...
    cmd.setWalkerId(0xfu);              // patched
    EXPECT_EQ(0xfu, cmd.getWalkerId()); // patched

    cmd.setOverDispatchTgCount(0x0u);
    EXPECT_EQ(0x0u, cmd.getOverDispatchTgCount());
    cmd.setOverDispatchTgCount(0x3fffu);
    EXPECT_EQ(0x3fffu, cmd.getOverDispatchTgCount());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenComputeWalker2WhenInitCalledThenFieldsSetToDefault) {
    using COMPUTE_WALKER_2 = NEO::Xe3pCoreFamily::COMPUTE_WALKER_2;
    COMPUTE_WALKER_2 cmd;
    cmd.init();

    EXPECT_EQ(COMPUTE_WALKER_2::DWORD_LENGTH_FIXED_SIZE, cmd.TheStructure.Common.DwordLength);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PreemptHighPri);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.DispatchComplete);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PostsyncAllocated);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_STANDARD, cmd.TheStructure.Common.CfeSubopcodeVariant);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_COMPUTE_WALKER_2, cmd.TheStructure.Common.CfeSubopcode);
    EXPECT_EQ(COMPUTE_WALKER_2::COMPUTE_COMMAND_OPCODE_NEW_CFE_COMMAND, cmd.TheStructure.Common.ComputeCommandOpcode);
    EXPECT_EQ(COMPUTE_WALKER_2::PIPELINE_COMPUTE, cmd.TheStructure.Common.Pipeline);
    EXPECT_EQ(COMPUTE_WALKER_2::COMMAND_TYPE_GFXPIPE, cmd.TheStructure.Common.CommandType);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_DISPATCH_POLICY_BREADTH_WISE, cmd.TheStructure.Common.ThreadDispatchPolicy);
    EXPECT_EQ(COMPUTE_WALKER_2::STACK_ID_CONTROL_2K, cmd.TheStructure.Common.StackIdControl);
    EXPECT_EQ(COMPUTE_WALKER_2::DYNAMIC_STACK_ID_CONTROL_ENABLED, cmd.TheStructure.Common.DynamicStackIdControl);
    EXPECT_EQ(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_NORMAL, cmd.TheStructure.Common.OverDispatchControl);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ALWAYS_ROUND_ROBIN, cmd.TheStructure.Common.ThreadArbitrationPolicy);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.MaximumNumberOfThreads);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_1, cmd.TheStructure.Common.ThreadGroupBatchSize);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_WALK_ORDER_LINEAR_WALK, cmd.TheStructure.Common.DispatchWalkOrder);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.MessageSimd);
    EXPECT_EQ(COMPUTE_WALKER_2::TILE_LAYOUT_LINEAR, cmd.TheStructure.Common.TileLayout);
    EXPECT_EQ(COMPUTE_WALKER_2::WALK_ORDER_WALK_012, cmd.TheStructure.Common.WalkOrder);
    EXPECT_EQ(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_NONE, cmd.TheStructure.Common.EmitLocal);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.SimdSize);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.ExecutionMask);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.LocalXMaximum);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.LocalYMaximum);
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.ThreadGroupIdStartingZ);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PartitionId);
    EXPECT_EQ(COMPUTE_WALKER_2::PARTITION_TYPE_DISABLED, cmd.TheStructure.Common.PartitionType);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_ALL_MOD_VALUE_MOD1, cmd.TheStructure.Common.DispatchAllModValue);
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_DISPATCH_DISABLED, cmd.TheStructure.Common.Quantumsize); // patched
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PartitionSize);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PreemptX);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PreemptY);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PreemptZ);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.WalkerId);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.OverDispatchTgCount);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PostsyncId);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.Apqid); // patched
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PreemptCsInterruptVector);
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenComputeWalker2WhenSetterUsedThenGetterReturnsValidValue) {
    using COMPUTE_WALKER_2 = NEO::Xe3pCoreFamily::COMPUTE_WALKER_2;
    COMPUTE_WALKER_2 cmd;
    cmd.init();

    cmd.setPreemptHighPri(0x0u);
    EXPECT_EQ(0x0u, cmd.getPreemptHighPri());
    cmd.setPreemptHighPri(0x1u);
    EXPECT_EQ(0x1u, cmd.getPreemptHighPri());
    ...
    cmd.setPostsyncAllocated(0x0u);
    EXPECT_EQ(0x0u, cmd.getPostsyncAllocated());
    cmd.setPostsyncAllocated(0x1u);
    EXPECT_EQ(0x1u, cmd.getPostsyncAllocated());

    cmd.setCfeSubopcodeVariant(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_STANDARD);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_STANDARD, cmd.getCfeSubopcodeVariant());

    cmd.setCfeSubopcodeVariant(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_PASS1_RESUME);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_PASS1_RESUME, cmd.getCfeSubopcodeVariant());

    cmd.setCfeSubopcodeVariant(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_PASS2_RESUME);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_PASS2_RESUME, cmd.getCfeSubopcodeVariant());

    cmd.setCfeSubopcodeVariant(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_BTD_PASS2);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_BTD_PASS2, cmd.getCfeSubopcodeVariant());

    cmd.setCfeSubopcodeVariant(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_TG_RESUME);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_TG_RESUME, cmd.getCfeSubopcodeVariant());

    cmd.setCfeSubopcodeVariant(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_W_DONE);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_VARIANT_W_DONE, cmd.getCfeSubopcodeVariant());

    cmd.setCfeSubopcode(COMPUTE_WALKER_2::CFE_SUBOPCODE_COMPUTE_WALKER_2);
    EXPECT_EQ(COMPUTE_WALKER_2::CFE_SUBOPCODE_COMPUTE_WALKER_2, cmd.getCfeSubopcode());

    cmd.setComputeCommandOpcode(COMPUTE_WALKER_2::COMPUTE_COMMAND_OPCODE_NEW_CFE_COMMAND);
    EXPECT_EQ(COMPUTE_WALKER_2::COMPUTE_COMMAND_OPCODE_NEW_CFE_COMMAND, cmd.getComputeCommandOpcode());

    cmd.setThreadDispatchPolicy(COMPUTE_WALKER_2::THREAD_DISPATCH_POLICY_BREADTH_WISE);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_DISPATCH_POLICY_BREADTH_WISE, cmd.getThreadDispatchPolicy());

    cmd.setThreadDispatchPolicy(COMPUTE_WALKER_2::THREAD_DISPATCH_POLICY_DEPTH_WISE);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_DISPATCH_POLICY_DEPTH_WISE, cmd.getThreadDispatchPolicy());

    cmd.setStackIdControl(COMPUTE_WALKER_2::STACK_ID_CONTROL_2K);
    EXPECT_EQ(COMPUTE_WALKER_2::STACK_ID_CONTROL_2K, cmd.getStackIdControl());

    cmd.setStackIdControl(COMPUTE_WALKER_2::STACK_ID_CONTROL_1K);
    EXPECT_EQ(COMPUTE_WALKER_2::STACK_ID_CONTROL_1K, cmd.getStackIdControl());

    cmd.setStackIdControl(COMPUTE_WALKER_2::STACK_ID_CONTROL_512);
    EXPECT_EQ(COMPUTE_WALKER_2::STACK_ID_CONTROL_512, cmd.getStackIdControl());

    cmd.setStackIdControl(COMPUTE_WALKER_2::STACK_ID_CONTROL_256);
    EXPECT_EQ(COMPUTE_WALKER_2::STACK_ID_CONTROL_256, cmd.getStackIdControl());

    cmd.setDynamicStackIdControl(COMPUTE_WALKER_2::DYNAMIC_STACK_ID_CONTROL_DISABLED);
    EXPECT_EQ(COMPUTE_WALKER_2::DYNAMIC_STACK_ID_CONTROL_DISABLED, cmd.getDynamicStackIdControl());

    cmd.setDynamicStackIdControl(COMPUTE_WALKER_2::DYNAMIC_STACK_ID_CONTROL_ENABLED);
    EXPECT_EQ(COMPUTE_WALKER_2::DYNAMIC_STACK_ID_CONTROL_ENABLED, cmd.getDynamicStackIdControl());

    cmd.setOverDispatchControl(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_NONE);
    EXPECT_EQ(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_NONE, cmd.getOverDispatchControl());

    cmd.setOverDispatchControl(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_LOW);
    EXPECT_EQ(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_LOW, cmd.getOverDispatchControl());

    cmd.setOverDispatchControl(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_NORMAL);
    EXPECT_EQ(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_NORMAL, cmd.getOverDispatchControl());

    cmd.setOverDispatchControl(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_HIGH);
    EXPECT_EQ(COMPUTE_WALKER_2::OVER_DISPATCH_CONTROL_HIGH, cmd.getOverDispatchControl());

    cmd.setThreadArbitrationPolicy(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ALWAYS_ROUND_ROBIN);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ALWAYS_ROUND_ROBIN, cmd.getThreadArbitrationPolicy());

    cmd.setThreadArbitrationPolicy(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_50);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_50, cmd.getThreadArbitrationPolicy());

    cmd.setThreadArbitrationPolicy(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_25);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_25, cmd.getThreadArbitrationPolicy());

    cmd.setThreadArbitrationPolicy(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_75);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_75, cmd.getThreadArbitrationPolicy());
    ...
    cmd.setThreadGroupBatchSize(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_1);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_1, cmd.getThreadGroupBatchSize());

    cmd.setThreadGroupBatchSize(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_2);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_2, cmd.getThreadGroupBatchSize());

    cmd.setThreadGroupBatchSize(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_4);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_4, cmd.getThreadGroupBatchSize());

    cmd.setThreadGroupBatchSize(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_8);
    EXPECT_EQ(COMPUTE_WALKER_2::THREAD_GROUP_BATCH_SIZE_TG_BATCH_8, cmd.getThreadGroupBatchSize());

    cmd.setDispatchWalkOrder(COMPUTE_WALKER_2::DISPATCH_WALK_ORDER_LINEAR_WALK);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_WALK_ORDER_LINEAR_WALK, cmd.getDispatchWalkOrder());

    cmd.setDispatchWalkOrder(COMPUTE_WALKER_2::DISPATCH_WALK_ORDER_Y_ORDER_WALK);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_WALK_ORDER_Y_ORDER_WALK, cmd.getDispatchWalkOrder());

    cmd.setDispatchWalkOrder(COMPUTE_WALKER_2::DISPATCH_WALK_ORDER_MORTON_2X2_XY_WALK);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_WALK_ORDER_MORTON_2X2_XY_WALK, cmd.getDispatchWalkOrder());

    cmd.setMessageSimd(COMPUTE_WALKER_2::MESSAGE_SIMD_SIMT16);
    EXPECT_EQ(COMPUTE_WALKER_2::MESSAGE_SIMD_SIMT16, cmd.getMessageSimd());

    cmd.setMessageSimd(COMPUTE_WALKER_2::MESSAGE_SIMD_SIMT32);
    EXPECT_EQ(COMPUTE_WALKER_2::MESSAGE_SIMD_SIMT32, cmd.getMessageSimd());

    cmd.setTileLayout(COMPUTE_WALKER_2::TILE_LAYOUT_LINEAR);
    EXPECT_EQ(COMPUTE_WALKER_2::TILE_LAYOUT_LINEAR, cmd.getTileLayout());

    cmd.setTileLayout(COMPUTE_WALKER_2::TILE_LAYOUT_TILEY_32BPE);
    EXPECT_EQ(COMPUTE_WALKER_2::TILE_LAYOUT_TILEY_32BPE, cmd.getTileLayout());

    cmd.setTileLayout(COMPUTE_WALKER_2::TILE_LAYOUT_TILEY_64BPE);
    EXPECT_EQ(COMPUTE_WALKER_2::TILE_LAYOUT_TILEY_64BPE, cmd.getTileLayout());

    cmd.setTileLayout(COMPUTE_WALKER_2::TILE_LAYOUT_TILEY_128BPE);
    EXPECT_EQ(COMPUTE_WALKER_2::TILE_LAYOUT_TILEY_128BPE, cmd.getTileLayout());

    cmd.setWalkOrder(COMPUTE_WALKER_2::WALK_ORDER_WALK_012);
    EXPECT_EQ(COMPUTE_WALKER_2::WALK_ORDER_WALK_012, cmd.getWalkOrder());

    cmd.setWalkOrder(COMPUTE_WALKER_2::WALK_ORDER_WALK_021);
    EXPECT_EQ(COMPUTE_WALKER_2::WALK_ORDER_WALK_021, cmd.getWalkOrder());

    cmd.setWalkOrder(COMPUTE_WALKER_2::WALK_ORDER_WALK_102);
    EXPECT_EQ(COMPUTE_WALKER_2::WALK_ORDER_WALK_102, cmd.getWalkOrder());

    cmd.setWalkOrder(COMPUTE_WALKER_2::WALK_ORDER_WALK_120);
    EXPECT_EQ(COMPUTE_WALKER_2::WALK_ORDER_WALK_120, cmd.getWalkOrder());

    cmd.setWalkOrder(COMPUTE_WALKER_2::WALK_ORDER_WALK_201);
    EXPECT_EQ(COMPUTE_WALKER_2::WALK_ORDER_WALK_201, cmd.getWalkOrder());

    cmd.setWalkOrder(COMPUTE_WALKER_2::WALK_ORDER_WALK_210);
    EXPECT_EQ(COMPUTE_WALKER_2::WALK_ORDER_WALK_210, cmd.getWalkOrder());

    cmd.setEmitLocalId(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_NONE);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_NONE, cmd.getEmitLocalId()); // patched

    cmd.setEmitLocalId(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_X);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_X, cmd.getEmitLocalId()); // patched

    cmd.setEmitLocalId(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_XY);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_XY, cmd.getEmitLocalId()); // patched

    cmd.setEmitLocalId(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_XYZ);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::EMIT_LOCAL_EMIT_XYZ, cmd.getEmitLocalId()); // patched

    cmd.setSimdSize(COMPUTE_WALKER_2::SIMD_SIZE_SIMT16);
    EXPECT_EQ(COMPUTE_WALKER_2::SIMD_SIZE_SIMT16, cmd.getSimdSize());

    cmd.setSimdSize(COMPUTE_WALKER_2::SIMD_SIZE_SIMT32);
    EXPECT_EQ(COMPUTE_WALKER_2::SIMD_SIZE_SIMT32, cmd.getSimdSize());
    ...
    cmd.setPartitionId(0x0u);
    EXPECT_EQ(0x0u, cmd.getPartitionId());
    cmd.setPartitionId(0xffu);
    EXPECT_EQ(0xffu, cmd.getPartitionId());

    cmd.setPartitionType(COMPUTE_WALKER_2::PARTITION_TYPE_DISABLED);
    EXPECT_EQ(COMPUTE_WALKER_2::PARTITION_TYPE_DISABLED, cmd.getPartitionType());

    cmd.setPartitionType(COMPUTE_WALKER_2::PARTITION_TYPE_X);
    EXPECT_EQ(COMPUTE_WALKER_2::PARTITION_TYPE_X, cmd.getPartitionType());

    cmd.setPartitionType(COMPUTE_WALKER_2::PARTITION_TYPE_Y);
    EXPECT_EQ(COMPUTE_WALKER_2::PARTITION_TYPE_Y, cmd.getPartitionType());

    cmd.setPartitionType(COMPUTE_WALKER_2::PARTITION_TYPE_Z);
    EXPECT_EQ(COMPUTE_WALKER_2::PARTITION_TYPE_Z, cmd.getPartitionType());

    cmd.setDispatchAllModValue(COMPUTE_WALKER_2::DISPATCH_ALL_MOD_VALUE_MOD1);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_ALL_MOD_VALUE_MOD1, cmd.getDispatchAllModValue());

    cmd.setDispatchAllModValue(COMPUTE_WALKER_2::DISPATCH_ALL_MOD_VALUE_MOD2);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_ALL_MOD_VALUE_MOD2, cmd.getDispatchAllModValue());

    cmd.setDispatchAllModValue(COMPUTE_WALKER_2::DISPATCH_ALL_MOD_VALUE_MOD4);
    EXPECT_EQ(COMPUTE_WALKER_2::DISPATCH_ALL_MOD_VALUE_MOD4, cmd.getDispatchAllModValue());

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_DISPATCH_DISABLED);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_DISPATCH_DISABLED, cmd.getQuantumsize()); // patched

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_4);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_4, cmd.getQuantumsize()); // patched

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_8);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_8, cmd.getQuantumsize()); // patched

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_14);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_14, cmd.getQuantumsize()); // patched

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_16);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_16, cmd.getQuantumsize()); // patched

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_20);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_20, cmd.getQuantumsize()); // patched

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_24);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_24, cmd.getQuantumsize()); // patched

    cmd.setQuantumsize(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_28);              // patched
    EXPECT_EQ(COMPUTE_WALKER_2::QUANTUMSIZE_QUANTUM_SIZE_28, cmd.getQuantumsize()); // patched
    ...
    cmd.setWalkerId(0x0u);
    EXPECT_EQ(0x0u, cmd.getWalkerId());
    cmd.setWalkerId(0x1fu);
    EXPECT_EQ(0x1fu, cmd.getWalkerId());
    ...
    cmd.setPostsyncId(0x0u);
    EXPECT_EQ(0x0u, cmd.getPostsyncId());
    cmd.setPostsyncId(0x7fu);
    EXPECT_EQ(0x7fu, cmd.getPostsyncId());

    cmd.setApqid(0x0u);               // patched
    EXPECT_EQ(0x0u, cmd.getApqid());  // patched
    cmd.setApqid(0x3fu);              // patched
    EXPECT_EQ(0x3fu, cmd.getApqid()); // patched

    EXPECT_EQ(reinterpret_cast<uint32_t *>(&cmd.TheStructure.Common.InlineData), cmd.getInlineDataPointer());
    EXPECT_EQ(sizeof(cmd.TheStructure.Common.InlineData), cmd.getInlineDataSize());

    cmd.setPreemptCsInterruptVector(0x0u);
    EXPECT_EQ(0x0u, cmd.getPreemptCsInterruptVector());
    cmd.setPreemptCsInterruptVector(0x3ffu);
    EXPECT_EQ(0x3ffu, cmd.getPreemptCsInterruptVector());
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenCfeStateWhenInitCalledThenFieldsSetToDefault) {
    using CFE_STATE = NEO::Xe3pCoreFamily::CFE_STATE;
    CFE_STATE cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenCfeStateWhenSetterUsedThenGetterReturnsValidValue) {
    using CFE_STATE = NEO::Xe3pCoreFamily::CFE_STATE;
    CFE_STATE cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiArbCheckWhenInitCalledThenFieldsSetToDefault) {
    using MI_ARB_CHECK = NEO::Xe3pCoreFamily::MI_ARB_CHECK;
    MI_ARB_CHECK cmd;
    cmd.init();

    EXPECT_EQ(0x0u, cmd.TheStructure.Common.PreParserDisable);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.DisableMultiQSwitching); // patched
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiArbCheckWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_ARB_CHECK = NEO::Xe3pCoreFamily::MI_ARB_CHECK;
    MI_ARB_CHECK cmd;
    cmd.init();
    ...
    cmd.setDisableMultiQSwitching(false);              // patched
    EXPECT_EQ(false, cmd.getDisableMultiQSwitching()); // patched
    cmd.setDisableMultiQSwitching(true);               // patched
    EXPECT_EQ(true, cmd.getDisableMultiQSwitching());  // patched
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiBatchBufferStartWhenInitCalledThenFieldsSetToDefault) {
    using MI_BATCH_BUFFER_START = NEO::Xe3pCoreFamily::MI_BATCH_BUFFER_START;
    ...
    EXPECT_EQ(MI_BATCH_BUFFER_START::SECOND_LEVEL_BATCH_BUFFER_FIRST_LEVEL_BATCH, cmd.TheStructure.Mi_Mode_NestedbatchbufferenableIs0.SecondLevelBatchBuffer);
    EXPECT_EQ(MI_BATCH_BUFFER_START::NESTED_LEVEL_BATCH_BUFFER_CHAIN, cmd.TheStructure.Mi_Mode_NestedbatchbufferenableIs1.NestedLevelBatchBuffer);
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiBatchBufferStartWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_BATCH_BUFFER_START = NEO::Xe3pCoreFamily::MI_BATCH_BUFFER_START;
    MI_BATCH_BUFFER_START cmd;
    cmd.init();
    ...
    cmd.setBatchBufferStartAddress(0xfffffffffffffffcull);
    EXPECT_EQ(0xfffffffffffffffcull, cmd.getBatchBufferStartAddress());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiLoadRegisterMemWhenInitCalledThenFieldsSetToDefault) {
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiLoadRegisterMemWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_LOAD_REGISTER_MEM = NEO::Xe3pCoreFamily::MI_LOAD_REGISTER_MEM;
    MI_LOAD_REGISTER_MEM cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiLoadRegisterRegWhenInitCalledThenFieldsSetToDefault) {
    using MI_LOAD_REGISTER_REG = NEO::Xe3pCoreFamily::MI_LOAD_REGISTER_REG;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiLoadRegisterRegWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_LOAD_REGISTER_REG = NEO::Xe3pCoreFamily::MI_LOAD_REGISTER_REG;
    MI_LOAD_REGISTER_REG cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiSemaphoreWaitWhenInitCalledThenFieldsSetToDefault) {
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.WorkloadPartitionIdOffsetEnable);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common._64bCompareEnableWithGpr); // patched
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiSemaphoreWaitWhenSetterUsedThenGetterReturnsValidValue) {
    ...
    cmd.setQueueSwitchMode(MI_SEMAPHORE_WAIT::QUEUE_SWITCH_MODE_SWITCH_QUEUE_ON_UNSUCCESSFUL);
    EXPECT_EQ(MI_SEMAPHORE_WAIT::QUEUE_SWITCH_MODE_SWITCH_QUEUE_ON_UNSUCCESSFUL, cmd.getQueueSwitchMode());
    ...
    cmd.set64BCompareEnableWithGpr(MI_SEMAPHORE_WAIT::_64B_COMPARE_ENABLE_WITH_GPR_64B_GPR_COMPARE);
    EXPECT_EQ(MI_SEMAPHORE_WAIT::_64B_COMPARE_ENABLE_WITH_GPR_64B_GPR_COMPARE, cmd.get64BCompareEnableWithGpr());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiSemaphoreWait64WhenInitCalledThenFieldsSetToDefault) {
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.CommandControlledInhibitContextSwitch);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::REGISTER_POLL_MODE_MEMORY_POLL, cmd.TheStructure.Common.RegisterPollMode); // patched
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.IndirectSemaphoreDataDword);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.WorkloadPartitionIdOffsetEnable);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::_64B_COMPARE_DISABLE_64B_COMPARE, cmd.TheStructure.Common._64BCompareDisable);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.SemaphoreInterrupt);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.FastModePoll);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::MEMORY_TYPE_PER_PROCESS_GRAPHICS_ADDRESS, cmd.TheStructure.Common.MemoryType);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::MI_COMMAND_OPCODE_MI_SEMAPHORE_WAIT, cmd.TheStructure.Common.MiCommandOpcode);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::COMMAND_TYPE_MI_COMMAND, cmd.TheStructure.Common.CommandType);
    EXPECT_EQ(0x0ull, cmd.TheStructure.Common.SemaphoreDataDword);
    EXPECT_EQ(0x0ull, cmd.TheStructure.Common.SemaphoreAddress);
    EXPECT_EQ(0x0ull, cmd.TheStructure.Common.SemaphoreToken);
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiSemaphoreWait64WhenSetterUsedThenGetterReturnsValidValue) {
    using MI_SEMAPHORE_WAIT_64 = NEO::Xe3pCoreFamily::MI_SEMAPHORE_WAIT_64;
    MI_SEMAPHORE_WAIT_64 cmd;
    cmd.init();
    ...
    cmd.setSwTokenInfo(0x7u);
    EXPECT_EQ(0x7u, cmd.getSwTokenInfo());

    cmd.setQueueSwitchMode(MI_SEMAPHORE_WAIT_64::QUEUE_SWITCH_MODE_SWITCH_AFTER_COMMAND_IS_PARSED);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::QUEUE_SWITCH_MODE_SWITCH_AFTER_COMMAND_IS_PARSED, cmd.getQueueSwitchMode());

    cmd.setQueueSwitchMode(MI_SEMAPHORE_WAIT_64::QUEUE_SWITCH_MODE_SWITCH_QUEUE_ON_UNSUCCESSFUL);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::QUEUE_SWITCH_MODE_SWITCH_QUEUE_ON_UNSUCCESSFUL, cmd.getQueueSwitchMode());

    cmd.setCompareOperation(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_GREATER_THAN_SDD);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_GREATER_THAN_SDD, cmd.getCompareOperation());

    cmd.setCompareOperation(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_GREATER_THAN_OR_EQUAL_SDD);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_GREATER_THAN_OR_EQUAL_SDD, cmd.getCompareOperation());

    cmd.setCompareOperation(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_LESS_THAN_SDD);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_LESS_THAN_SDD, cmd.getCompareOperation());

    cmd.setCompareOperation(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_LESS_THAN_OR_EQUAL_SDD);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_LESS_THAN_OR_EQUAL_SDD, cmd.getCompareOperation());

    cmd.setCompareOperation(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_EQUAL_SDD);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_EQUAL_SDD, cmd.getCompareOperation());

    cmd.setCompareOperation(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_NOT_EQUAL_SDD);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::COMPARE_OPERATION_SAD_NOT_EQUAL_SDD, cmd.getCompareOperation());

    cmd.setCommandControlledInhibitContextSwitch(0x0u);
    EXPECT_EQ(0x0u, cmd.getCommandControlledInhibitContextSwitch());
    cmd.setCommandControlledInhibitContextSwitch(0x1u);
    EXPECT_EQ(0x1u, cmd.getCommandControlledInhibitContextSwitch());

    cmd.setRegisterPollMode(MI_SEMAPHORE_WAIT_64::REGISTER_POLL_MODE_MEMORY_POLL);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::REGISTER_POLL_MODE_MEMORY_POLL, cmd.getRegisterPollMode());

    cmd.setRegisterPollMode(MI_SEMAPHORE_WAIT_64::REGISTER_POLL_MODE_REGISTER_POLL);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::REGISTER_POLL_MODE_REGISTER_POLL, cmd.getRegisterPollMode());
    ...
    cmd.set64BCompareDisable(MI_SEMAPHORE_WAIT_64::_64B_COMPARE_DISABLE_64B_COMPARE);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::_64B_COMPARE_DISABLE_64B_COMPARE, cmd.get64BCompareDisable());

    cmd.set64BCompareDisable(MI_SEMAPHORE_WAIT_64::_64B_COMPARE_DISABLE_32B_COMPARE);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::_64B_COMPARE_DISABLE_32B_COMPARE, cmd.get64BCompareDisable());

    cmd.setSemaphoreInterrupt(0x0u);
    EXPECT_EQ(0x0u, cmd.getSemaphoreInterrupt());
    cmd.setSemaphoreInterrupt(0x1u);
    EXPECT_EQ(0x1u, cmd.getSemaphoreInterrupt());

    cmd.setFastModePoll(0x0u);
    EXPECT_EQ(0x0u, cmd.getFastModePoll());
    cmd.setFastModePoll(0x1u);
    EXPECT_EQ(0x1u, cmd.getFastModePoll());

    cmd.setMemoryType(MI_SEMAPHORE_WAIT_64::MEMORY_TYPE_PER_PROCESS_GRAPHICS_ADDRESS);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::MEMORY_TYPE_PER_PROCESS_GRAPHICS_ADDRESS, cmd.getMemoryType());

    cmd.setMemoryType(MI_SEMAPHORE_WAIT_64::MEMORY_TYPE_GLOBAL_GRAPHICS_ADDRESS);
    EXPECT_EQ(MI_SEMAPHORE_WAIT_64::MEMORY_TYPE_GLOBAL_GRAPHICS_ADDRESS, cmd.getMemoryType());

    cmd.setSemaphoreDataDword(0x0ull);
    EXPECT_EQ(0x0ull, cmd.getSemaphoreDataDword());
    cmd.setSemaphoreDataDword(0xffffffffffffffffull);
    EXPECT_EQ(0xffffffffffffffffull, cmd.getSemaphoreDataDword());

    cmd.setSemaphoreGraphicsAddress(0x0ull);
    EXPECT_EQ(0x0ull, cmd.getSemaphoreGraphicsAddress());
    cmd.setSemaphoreGraphicsAddress(0xfffffffffffffffcull);              // patched
    EXPECT_EQ(0xfffffffffffffffcull, cmd.getSemaphoreGraphicsAddress()); // patched

    cmd.setSemaphoreToken(0x0ull);
    EXPECT_EQ(0x0ull, cmd.getSemaphoreToken());
    cmd.setSemaphoreToken(0xffffffffffffffffull);
    EXPECT_EQ(0xffffffffffffffffull, cmd.getSemaphoreToken());
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiStoreDataImmWhenInitCalledThenFieldsSetToDefault) {
    using MI_STORE_DATA_IMM = NEO::Xe3pCoreFamily::MI_STORE_DATA_IMM;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiStoreDataImmWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_STORE_DATA_IMM = NEO::Xe3pCoreFamily::MI_STORE_DATA_IMM;
    MI_STORE_DATA_IMM cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiStoreRegisterMemWhenInitCalledThenFieldsSetToDefault) {
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiStoreRegisterMemWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_STORE_REGISTER_MEM = NEO::Xe3pCoreFamily::MI_STORE_REGISTER_MEM;
    MI_STORE_REGISTER_MEM cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPipelineSelectWhenInitCalledThenFieldsSetToDefault) {
    using PIPELINE_SELECT = NEO::Xe3pCoreFamily::PIPELINE_SELECT;
    PIPELINE_SELECT cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenPipelineSelectWhenSetterUsedThenGetterReturnsValidValue) {
    using PIPELINE_SELECT = NEO::Xe3pCoreFamily::PIPELINE_SELECT;
    PIPELINE_SELECT cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateComputeModeWhenInitCalledThenFieldsSetToDefault) {
    using STATE_COMPUTE_MODE = NEO::Xe3pCoreFamily::STATE_COMPUTE_MODE;
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.NpZAsyncThrottleSettings);
    EXPECT_EQ(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_0, cmd.TheStructure.Common.LscSamplerBackingThreshold); // patched
    ...
    EXPECT_EQ(STATE_COMPUTE_MODE::OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_DISABLE, cmd.TheStructure.Common.OutOfBoundariesInTranslationExceptionEnable);
    EXPECT_EQ(STATE_COMPUTE_MODE::PAGE_FAULT_EXCEPTION_ENABLE_DISABLE, cmd.TheStructure.Common.PageFaultExceptionEnable);
    EXPECT_EQ(STATE_COMPUTE_MODE::TDL_ROW_ARBITRATION_POLICY_LEGACY_ROUND_ROBIN, cmd.TheStructure.Common.TdlRowArbitrationPolicy);
    EXPECT_EQ(STATE_COMPUTE_MODE::MEMORY_EXCEPTION_ENABLE_DISABLE, cmd.TheStructure.Common.MemoryExceptionEnable);
    EXPECT_EQ(STATE_COMPUTE_MODE::SYSTEM_MEMORY_READ_FENCE_ENABLE_DISABLE, cmd.TheStructure.Common.SystemMemoryReadFenceEnable);
    EXPECT_EQ(STATE_COMPUTE_MODE::ENABLE_BREAKPOINTS_DISABLE, cmd.TheStructure.Common.EnableBreakpoints);
    EXPECT_EQ(STATE_COMPUTE_MODE::ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_DISABLE, cmd.TheStructure.Common.EnableForceExternalHaltAndForceException);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.Mask2);
}

XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateComputeModeWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_COMPUTE_MODE = NEO::Xe3pCoreFamily::STATE_COMPUTE_MODE;
    STATE_COMPUTE_MODE cmd;
    cmd.init();
    ...
    cmd.setLscSamplerBackingThreshold(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_0);              // patched
    EXPECT_EQ(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_0, cmd.getLscSamplerBackingThreshold()); // patched

    cmd.setLscSamplerBackingThreshold(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_1);              // patched
    EXPECT_EQ(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_1, cmd.getLscSamplerBackingThreshold()); // patched

    cmd.setLscSamplerBackingThreshold(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_2);              // patched
    EXPECT_EQ(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_2, cmd.getLscSamplerBackingThreshold()); // patched

    cmd.setLscSamplerBackingThreshold(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_3);              // patched
    EXPECT_EQ(STATE_COMPUTE_MODE::LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_3, cmd.getLscSamplerBackingThreshold()); // patched
    ...
    cmd.setOutOfBoundariesInTranslationExceptionEnable(STATE_COMPUTE_MODE::OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_DISABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_DISABLE, cmd.getOutOfBoundariesInTranslationExceptionEnable());

    cmd.setOutOfBoundariesInTranslationExceptionEnable(STATE_COMPUTE_MODE::OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_ENABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_ENABLE, cmd.getOutOfBoundariesInTranslationExceptionEnable());

    cmd.setPageFaultExceptionEnable(STATE_COMPUTE_MODE::PAGE_FAULT_EXCEPTION_ENABLE_DISABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::PAGE_FAULT_EXCEPTION_ENABLE_DISABLE, cmd.getPageFaultExceptionEnable());

    cmd.setPageFaultExceptionEnable(STATE_COMPUTE_MODE::PAGE_FAULT_EXCEPTION_ENABLE_ENABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::PAGE_FAULT_EXCEPTION_ENABLE_ENABLE, cmd.getPageFaultExceptionEnable());

    cmd.setTdlRowArbitrationPolicy(STATE_COMPUTE_MODE::TDL_ROW_ARBITRATION_POLICY_LEGACY_ROUND_ROBIN);
    EXPECT_EQ(STATE_COMPUTE_MODE::TDL_ROW_ARBITRATION_POLICY_LEGACY_ROUND_ROBIN, cmd.getTdlRowArbitrationPolicy());

    cmd.setTdlRowArbitrationPolicy(STATE_COMPUTE_MODE::TDL_ROW_ARBITRATION_POLICY_ORDERED_ROUND_ROBIN);
    EXPECT_EQ(STATE_COMPUTE_MODE::TDL_ROW_ARBITRATION_POLICY_ORDERED_ROUND_ROBIN, cmd.getTdlRowArbitrationPolicy());

    cmd.setMemoryExceptionEnable(STATE_COMPUTE_MODE::MEMORY_EXCEPTION_ENABLE_DISABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::MEMORY_EXCEPTION_ENABLE_DISABLE, cmd.getMemoryExceptionEnable());

    cmd.setMemoryExceptionEnable(STATE_COMPUTE_MODE::MEMORY_EXCEPTION_ENABLE_ENABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::MEMORY_EXCEPTION_ENABLE_ENABLE, cmd.getMemoryExceptionEnable());

    cmd.setSystemMemoryReadFenceEnable(STATE_COMPUTE_MODE::SYSTEM_MEMORY_READ_FENCE_ENABLE_DISABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::SYSTEM_MEMORY_READ_FENCE_ENABLE_DISABLE, cmd.getSystemMemoryReadFenceEnable());

    cmd.setSystemMemoryReadFenceEnable(STATE_COMPUTE_MODE::SYSTEM_MEMORY_READ_FENCE_ENABLE_ENABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::SYSTEM_MEMORY_READ_FENCE_ENABLE_ENABLE, cmd.getSystemMemoryReadFenceEnable());

    cmd.setEnableBreakpoints(STATE_COMPUTE_MODE::ENABLE_BREAKPOINTS_DISABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::ENABLE_BREAKPOINTS_DISABLE, cmd.getEnableBreakpoints());

    cmd.setEnableBreakpoints(STATE_COMPUTE_MODE::ENABLE_BREAKPOINTS_ENABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::ENABLE_BREAKPOINTS_ENABLE, cmd.getEnableBreakpoints());

    cmd.setEnableForceExternalHaltAndForceException(STATE_COMPUTE_MODE::ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_DISABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_DISABLE, cmd.getEnableForceExternalHaltAndForceException());

    cmd.setEnableForceExternalHaltAndForceException(STATE_COMPUTE_MODE::ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_ENABLE);
    EXPECT_EQ(STATE_COMPUTE_MODE::ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_ENABLE, cmd.getEnableForceExternalHaltAndForceException());
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, Given3dstateBindingTablePoolAllocWhenInitCalledThenFieldsSetToDefault) {
    using _3DSTATE_BINDING_TABLE_POOL_ALLOC = NEO::Xe3pCoreFamily::_3DSTATE_BINDING_TABLE_POOL_ALLOC;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, Given3dstateBindingTablePoolAllocWhenSetterUsedThenGetterReturnsValidValue) {
    using _3DSTATE_BINDING_TABLE_POOL_ALLOC = NEO::Xe3pCoreFamily::_3DSTATE_BINDING_TABLE_POOL_ALLOC;
    _3DSTATE_BINDING_TABLE_POOL_ALLOC cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiMemFenceWhenInitCalledThenFieldsSetToDefault) {
    using MI_MEM_FENCE = NEO::Xe3pCoreFamily::MI_MEM_FENCE;
    MI_MEM_FENCE cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMiMemFenceWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_MEM_FENCE = NEO::Xe3pCoreFamily::MI_MEM_FENCE;
    MI_MEM_FENCE cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateSystemMemFenceAddressWhenInitCalledThenFieldsSetToDefault) {
    using STATE_SYSTEM_MEM_FENCE_ADDRESS = NEO::Xe3pCoreFamily::STATE_SYSTEM_MEM_FENCE_ADDRESS;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateSystemMemFenceAddressWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_SYSTEM_MEM_FENCE_ADDRESS = NEO::Xe3pCoreFamily::STATE_SYSTEM_MEM_FENCE_ADDRESS;
    STATE_SYSTEM_MEM_FENCE_ADDRESS cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMemSetWhenInitCalledThenFieldsSetToDefault) {
    using MEM_SET = NEO::Xe3pCoreFamily::MEM_SET;
    MEM_SET cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenMemSetWhenSetterUsedThenGetterReturnsValidValue) {
    using MEM_SET = NEO::Xe3pCoreFamily::MEM_SET;
    MEM_SET cmd;
    cmd.init();
    ...
    cmd.setDestinationStartAddress(0x0ull);                             // patched
    EXPECT_EQ(0x0ull, cmd.getDestinationStartAddress());                // patched
    cmd.setDestinationStartAddress(0xfffffffffffffffcull);              // patched
    EXPECT_EQ(0xfffffffffffffffcull, cmd.getDestinationStartAddress()); // patched
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateSipWhenInitCalledThenFieldsSetToDefault) {
    using STATE_SIP = NEO::Xe3pCoreFamily::STATE_SIP;
    STATE_SIP cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateSipWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_SIP = NEO::Xe3pCoreFamily::STATE_SIP;
    STATE_SIP cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenSamplerBorderColorStateWhenInitCalledThenFieldsSetToDefault) {
    using SAMPLER_BORDER_COLOR_STATE = NEO::Xe3pCoreFamily::SAMPLER_BORDER_COLOR_STATE;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenSamplerBorderColorStateWhenSetterUsedThenGetterReturnsValidValue) {
    using SAMPLER_BORDER_COLOR_STATE = NEO::Xe3pCoreFamily::SAMPLER_BORDER_COLOR_STATE;
    SAMPLER_BORDER_COLOR_STATE cmd;
    cmd.init();
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateContextDataBaseAddressWhenInitCalledThenFieldsSetToDefault) {
    using STATE_CONTEXT_DATA_BASE_ADDRESS = NEO::Xe3pCoreFamily::STATE_CONTEXT_DATA_BASE_ADDRESS;
...
XE3P_CORETEST_F(CommandsXe3pCoreTest, GivenStateContextDataBaseAddressWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_CONTEXT_DATA_BASE_ADDRESS = NEO::Xe3pCoreFamily::STATE_CONTEXT_DATA_BASE_ADDRESS;
    STATE_CONTEXT_DATA_BASE_ADDRESS cmd;
    cmd.init();
