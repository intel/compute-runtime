...
typedef struct _zex_label_desc_t {
    ze_structure_type_ext_t stype; ///< [in] type of this structure ZEX_STRUCTURE_TYPE_LABEL_DESCRIPTOR
...
typedef struct _zex_operand_desc_t {
    ze_structure_type_ext_t stype; ///< [in] type of this structure ZEX_STRUCTURE_TYPE_OPERAND_DESCRIPTOR
    const void *pNext;             ///< [in][optional] pointer to extension-specific structure
