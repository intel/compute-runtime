...
class ProductHelperHw : public ProductHelper {
  public:
    ...
    bool overridePatToUCAndCohForDcFlushMitigation(AllocationType allocationType) const override;
    bool overridePatToUCAndNonCohForDcFlushMitigation(AllocationType allocationType) const override;
