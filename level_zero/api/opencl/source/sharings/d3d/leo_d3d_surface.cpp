...
#include "level_zero/api/opencl/source/sharings/d3d/leo_d3d_surface.h"
...
Image *D3DSurface::create(Context *context, cl_dx9_surface_info_khr *surfaceInfo, cl_mem_flags flags,
    ...
    findImgFormat(surfaceDesc.Format, imgFormat, plane, imagePlane);
    ...
    l0imageDesc.width = surfaceDesc.Width;
    l0imageDesc.height = surfaceDesc.Height;
    l0imageDesc.depth = 1;
    l0imageDesc.arraylevels = 0;

    L0::ze_image_allocation_type_ext_desc_t l0imageAllocationTypeDesc{};
    ...
    if (needsView) {
        int d3dFormatValue = surfaceDesc.Format;
        switch (d3dFormatValue) {
        case MAKEFOURCC('N', 'V', '1', '2'):
            l0imageDesc.format.layout = ZE_IMAGE_FORMAT_LAYOUT_NV12;
            break;
        case MAKEFOURCC('Y', 'V', '1', '2'):
            l0imageDesc.format.layout = ZE_IMAGE_FORMAT_LAYOUT_YV12;
            break;
        default:
        ...
        l0imagePlannarDesc.pNext = l0imageDesc.pNext;
        l0imageDesc.pNext = &l0imagePlannarDesc;
    }

    NEO::LEO::Image::clToL0ImageFormat(l0imageDesc.format, imgFormat.image_channel_order, imgFormat.image_channel_data_type);

    ze_srgb_ext_desc_t srgbExtDesc{ZE_STRUCTURE_TYPE_SRGB_EXT_DESC, l0imageDesc.pNext, NEO::LEO::Image::isSRGB(imgFormat.image_channel_order)};
    ...
    auto image = new NEO::LEO::Image(context, memoryProperties, flags, imageHandle, nullptr, baseImageHandle, false, imgFormat, nullptr);

    auto surface = new D3DSurface(context, surfaceInfo, surfaceStaging, plane, imagePlane, adapterType, isSharedResource, lockable);
    image->setSharingHandler(surface);
