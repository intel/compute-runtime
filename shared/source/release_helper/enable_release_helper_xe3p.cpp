...
EnableReleaseHelper<ReleaseType::release3510> enablerReleaseHelperNvlP{releaseHelperFactoryXe3p[10]};
EnableReleaseHelper<ReleaseType::release3511> enablerReleaseHelperCri{releaseHelperFactoryXe3p[11]};
} // namespace NEO
