...
DECLARE_DEBUG_VARIABLE(int32_t, OverrideReadWritePatForDcFlushMitigation, -1, "-1: default, >=0: PatIndex to override for read write resources when mitigating dc flush")
DECLARE_DEBUG_VARIABLE(int32_t, OverrideWriteOnlyPatForDcFlushMitigation, -1, "-1: default, >=0: PatIndex to override for write only resources when mitigating dc flush")
...
DECLARE_DEBUG_VARIABLE(bool, DestroyAllocationsViaGmm, true, "Use DeAllocate2 wrapper instead of raw GDI destroy allocations")
