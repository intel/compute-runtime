...
HWTEST_TEMPLATED_F(DrmCommandStreamTest, givenFlushStampWhenWaitCalledThenWaitForSpecifiedBoHandle) {
    ...
    EXPECT_EQ(1u, mock->ioctlRequestCallCount[DRM_IOCTL_I915_GEM_WAIT]);
}
...
HWTEST_TEMPLATED_F(DrmCommandStreamTest, WhenMakingResidentThenSucceeds) {
    ...
    EXPECT_EQ(0u, mock->ioctlRequestCallCount[DRM_IOCTL_I915_GEM_USERPTR]);
    EXPECT_EQ(0u, mock->ioctlRequestCallCount[DRM_IOCTL_I915_GEM_EXECBUFFER2]);

    mock->tearDownIoctlRequestExpects.insert({0u, DRM_IOCTL_I915_GEM_WAIT});
    mock->tearDownIoctlRequestExpects.insert({0u, DRM_IOCTL_GEM_CLOSE});
}
...
HWTEST_TEMPLATED_F(DrmCommandStreamTest, WhenFlushingThenAvailableSpaceDoesNotChange) {
    ...
    mock->tearDownIoctlRequestExpects.insert({2u, DRM_IOCTL_I915_GEM_WAIT});
    mock->tearDownIoctlRequestExpects.insert({1u, DRM_IOCTL_GEM_CLOSE});

    EXPECT_EQ(1u, mock->ioctlRequestCallCount[DRM_IOCTL_I915_GEM_USERPTR]);
    EXPECT_EQ(1u, mock->ioctlRequestCallCount[DRM_IOCTL_I915_GEM_EXECBUFFER2]);
...
HWTEST_TEMPLATED_F(DrmCommandStreamTest, givenDrmContextIdWhenFlushingThenSetIdToAllExecBuffersAndObjects) {
    ...
    EXPECT_EQ(1u, mock->ioctlRequestCallCount[DRM_IOCTL_I915_GEM_CONTEXT_CREATE_EXT]);
    EXPECT_EQ(1u, mock->ioctlRequestCallCount[DRM_IOCTL_I915_GEM_EXECBUFFER2]);
