...
if(CMAKE_SIZEOF_VOID_P EQUAL 8)
  SET_FLAGS_FOR_CURRENT("XE3P_CORE" "CRI" "NVLP")
  DISABLE_WDDM_LINUX_FOR("XE3P_CORE" "CRI")
  SET_FLAGS_FOR_CURRENT("XE3_CORE" "PTL" "NVLS")
  SET_FLAGS_FOR_CURRENT("XE_HPC_CORE" "PVC")
else()
  DISABLE_32BIT_FLAGS_FOR("XE3P_CORE" "CRI" "NVLP")
...
foreach(CORE_TYPE ${XE3P_AND_LATER_CORE_TYPES})
  if(TESTS_${CORE_TYPE})
    set(TESTS_XE3P_AND_LATER 1)
  endif()
  if(SUPPORT_${CORE_TYPE})
    set(SUPPORT_XE3P_AND_LATER 1)
  endif()
endforeach()
...
if(SUPPORT_GEN12LP)
  ...
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "GEN12LP" "bindful_image_bindful_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "GEN12LP" "bindful_image_stateless_buffer_wide")
  if(TESTS_GEN12LP)
...
if(SUPPORT_XE_HPG_CORE)
  ADD_AOT_DEFINITION(XE)
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE_HPG_CORE" "bindful_image_bindful_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE_HPG_CORE" "bindful_image_stateless_buffer_wide")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE_HPG_CORE" "bindless_image_bindless_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE_HPG_CORE" "bindless_image_stateless_buffer_wide")
...
if(SUPPORT_XE_HPC_CORE)
  ...
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE_HPC_CORE" "bindful_image_stateless_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE_HPC_CORE" "bindful_image_stateless_buffer_wide")
...
if(SUPPORT_XE2_HPG_CORE)
  ...
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE2_HPG_CORE" "bindful_image_stateless_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE2_HPG_CORE" "bindful_image_stateless_buffer_wide")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE2_HPG_CORE" "bindless_image_stateless_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE2_HPG_CORE" "bindless_image_stateless_buffer_wide")
...
if(SUPPORT_XE3_CORE)
  ...
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE3_CORE" "bindful_image_stateless_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE3_CORE" "bindful_image_stateless_buffer_wide")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE3_CORE" "bindless_image_stateless_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE3_CORE" "bindless_image_stateless_buffer_wide")
  ...
  if(SUPPORT_PTL)
    ...
    set(PTL_XE3_CORE_RELEASES "30.0.0" "30.0.4" "30.1.0" "30.3.0" "30.3.1")
  ...
  if(SUPPORT_NVLS)
    ...
    set(NVLS_XE3_CORE_REVISIONS 0)
    set(NVLS_XE3_CORE_RELEASES "30.4.0" "30.4.4" "30.5.0" "30.5.1" "30.5.4")
    ADD_PRODUCT("SUPPORTED" "NVLS" "IGFX_NVL_XE3G")
    ...
    if(TESTS_NVLS)
      ...
      ADD_PRODUCT("TESTED" "NVLS" "IGFX_NVL_XE3G")
    endif()
  endif()
endif()

if(SUPPORT_XE3P_CORE)
  ADD_AOT_DEFINITION(XE3P)
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE3P_CORE" "bindless_image_stateless_buffer")
  ADD_ITEM_FOR_CORE_TYPE("ADDRESSING_MODES" "BUILTIN" "XE3P_CORE" "bindless_image_stateless_buffer_wide")
  set(XE3P_CORE_TEST_KERNELS_BLOCKLIST "CopyBuffer_simd8.cl")
  if(TESTS_XE3P_CORE)
    ADD_ITEM_FOR_CORE_TYPE("FAMILY_NAME" "TESTED" "XE3P_CORE" "Xe3pCoreFamily")
  endif()

  if(SUPPORT_CRI)
    ADD_AOT_DEFINITION(XE3P_XPC)
    ADD_AOT_DEFINITION(CRI)
    set(CRI_XE3P_CORE_REVISIONS 0)
    set(CRI_XE3P_CORE_RELEASES "35.11.0")
    set(CRI_XE3P_CORE_GRF_ADDITIONAL_SIZES 512)
    ADD_PRODUCT("SUPPORTED" "CRI" "IGFX_CRI")
    ADD_PLATFORM_FOR_CORE_TYPE("SUPPORTED" "XE3P_CORE" "CRI")
    ADD_PLATFORM_FOR_CORE_TYPE("SUPPORTED_HEAPLESS" "XE3P_CORE" "CRI")
    ADD_PLATFORM_FOR_CORE_TYPE("SUPPORTED_STATELESS" "XE3P_CORE" "CRI")
    if(TESTS_CRI)
      ADD_ITEM_FOR_CORE_TYPE("PLATFORMS" "TESTED" "XE3P_CORE" "CRI")
      ADD_PRODUCT("TESTED" "CRI" "IGFX_CRI")
    endif()
  endif()

  if(SUPPORT_NVLP)
    ADD_AOT_DEFINITION(XE3P_LPG)
    ADD_AOT_DEFINITION(NVL)
    set(NVLP_XE3P_CORE_REVISIONS 4)
    set(NVLP_XE3P_CORE_RELEASES "35.10.0" "35.10.4")
    set(NVLP_XE3P_CORE_GRF_ADDITIONAL_SIZES 512)
    ADD_PRODUCT("SUPPORTED" "NVLP" "IGFX_NVL")
    ADD_PLATFORM_FOR_CORE_TYPE("SUPPORTED" "XE3P_CORE" "NVLP")
    ADD_PLATFORM_FOR_CORE_TYPE("SUPPORTED_IMAGES" "XE3P_CORE" "NVLP")
    ADD_PLATFORM_FOR_CORE_TYPE("SUPPORTED_HEAPLESS" "XE3P_CORE" "NVLP")
    ADD_PLATFORM_FOR_CORE_TYPE("SUPPORTED_STATELESS" "XE3P_CORE" "NVLP")
    if(TESTS_NVLP)
      ADD_ITEM_FOR_CORE_TYPE("PLATFORMS" "TESTED" "XE3P_CORE" "NVLP")
      ADD_PRODUCT("TESTED" "NVLP" "IGFX_NVL")
    endif()
  endif()
endif()
