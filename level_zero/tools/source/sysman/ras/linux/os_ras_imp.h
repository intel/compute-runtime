...
class LinuxRasImp : public OsRas, NEO::NonCopyableAndNonMovableClass {
  ...
  private:
    ...
    std::vector<std::pair<zes_ras_error_category_exp_t, uint64_t>> categoryExpThresholds = {};
...
class LinuxRasSources : NEO::NonCopyableAndNonMovableClass {
  public:
    ...
    virtual ze_result_t osRasGetStateExp2(const uint32_t categoryCount, const zes_ras_error_category_exp_t *pCategories, zes_ras_state_exp2_t *pStates) = 0;
