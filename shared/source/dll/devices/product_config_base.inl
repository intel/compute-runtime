...
DEVICE_CONFIG_IDS_AND_REVISION(PVC_XL_A0P, PVC_CONFIG, PVC_XL_IDS, 0x01)
DEVICE_CONFIG_IDS_AND_REVISION(PVC_XT_A0, PVC_CONFIG, PVC_XT_IDS, 0x03)
DEVICE_CONFIG_IDS_AND_REVISION(PVC_XT_B0, PVC_CONFIG, PVC_XT_IDS, 0x05)
DEVICE_CONFIG_IDS_AND_REVISION(PVC_XT_B1, PVC_CONFIG, PVC_XT_IDS, 0x06)
DEVICE_CONFIG_IDS_AND_REVISION(PVC_XT_C0, PVC_CONFIG, PVC_XT_IDS, 0x07)
#endif
#endif
