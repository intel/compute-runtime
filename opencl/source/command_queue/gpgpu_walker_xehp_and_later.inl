...
size_t GpgpuWalkerHelper<GfxFamily>::setGpgpuWalkerThreadData(
    ...
    const auto numLocalIdChannels = kernelDescriptor.kernelAttributes.numLocalIdChannels;
