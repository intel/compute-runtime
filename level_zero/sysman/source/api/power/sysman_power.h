...
class Power : _zes_pwr_handle_t {
  public:
    ...
    virtual ze_result_t powerGetLimitsExt2(uint32_t *pLimit) = 0;
    virtual ze_result_t powerSetLimitsExt2(const uint32_t limit) = 0;
    virtual ze_result_t powerGetUsage(uint32_t *pInstantPower, uint32_t *pAveragePower) = 0;
