...
HWTEST_EXCLUDE_PRODUCT(AubHelperCompressionTests, givenStatelessCompressionAndAddMmioRegisterListDebugFlagsWhenCreatingAubCenterThenPassAdditionalMmioList, IGFX_XE2_HPG_CORE);
HWTEST_EXCLUDE_PRODUCT(AubHelperCompressionTests, givenStatelessCompressionDebugFlagWhenCreatingAubCenterThenPassAdditionalMmioList, IGFX_XE2_HPG_CORE);
