...
template <GFXCORE_FAMILY gfxCoreFamily>
ze_result_t CommandListCoreFamilyImmediate<gfxCoreFamily>::flushInOrderCounterSignal(bool copyOffload) {
    ze_result_t ret = ZE_RESULT_SUCCESS;
    if (copyOffload && !this->isHeaplessModeEnabled() && this->latestOperationHasOptimizedCbEvent) {
        ...
        this->handleInOrderCounterOverflow(copyOffload);
