...
typedef struct tagPIPE_CONTROL {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t HdcFlushEnable : BITFIELD_RANGE(9, 9);
            uint32_t Reserved_23 : BITFIELD_RANGE(10, 15);
    ...
    inline void setHdcFlushEnable(const bool value) {
        TheStructure.Common.HdcFlushEnable = value;
    }
    inline bool getHdcFlushEnable(void) const {
        return (TheStructure.Common.HdcFlushEnable);
    }
