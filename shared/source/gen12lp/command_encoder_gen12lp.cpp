...
void EncodeDispatchKernel<Family>::encode(CommandContainer &container, EncodeDispatchKernelArgs &args) {
    ...
    auto slmSizeNew = args.dispatchInterface->getSlmTotalSizePerThreadGroup();
...
void EncodeDispatchKernel<Family>::encodeSlmSizePerThreadGroup(InterfaceDescriptorType *pInterfaceDescriptor, const RootDeviceEnvironment &rootDeviceEnvironment, uint32_t slmTotalSizePerThreadGroup, bool heaplessModeEnabled) {
    ...
    auto programmableIDSLMSize = EncodeDispatchKernel<Family>::computeSlmValues(hwInfo, slmTotalSizePerThreadGroup, rootDeviceEnvironment.getReleaseHelper());
