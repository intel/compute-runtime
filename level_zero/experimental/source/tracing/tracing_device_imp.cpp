...
zeDeviceGetTracing(ze_driver_handle_t hDriver,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGet,
                               hDriver,
                               pCount,
                               phDevices);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGet,
                                   &tracerParams,
...
zeDeviceGetPropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetProperties,
                               hDevice,
                               pDeviceProperties);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetComputePropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetComputeProperties,
                               hDevice,
                               pComputeProperties);
...
zeDeviceGetMemoryPropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetMemoryProperties,
                               hDevice,
                               pCount,
                               pMemProperties);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetMemoryProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetCachePropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetCacheProperties,
                               hDevice,
                               pCount,
                               pCacheProperties);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetCacheProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetImagePropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetImageProperties,
                               hDevice,
                               pImageProperties);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetImageProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetSubDevicesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetSubDevices,
                               hDevice,
                               pCount,
                               phSubdevices);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetSubDevices,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetP2PPropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetP2PProperties,
                               hDevice,
                               hPeerDevice,
                               pP2PProperties);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetP2PProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceCanAccessPeerTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnCanAccessPeer,
                               hDevice,
                               hPeerDevice,
                               value);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnCanAccessPeer,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeKernelSetCacheConfigTracing(ze_kernel_handle_t hKernel,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Kernel.pfnSetCacheConfig,
                               hKernel,
                               flags);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Kernel.pfnSetCacheConfig,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetMemoryAccessPropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetMemoryAccessProperties,
                               hDevice,
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetMemoryAccessProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetModulePropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetModuleProperties,
                               hDevice,
                               pModuleProperties);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetModuleProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetCommandQueueGroupPropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetCommandQueueGroupProperties,
                               hDevice,
                               pCount,
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetCommandQueueGroupProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetExternalMemoryPropertiesTracing(ze_device_handle_t hDevice,
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetExternalMemoryProperties,
                               hDevice,
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetExternalMemoryProperties,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
...
zeDeviceGetStatusTracing(ze_device_handle_t hDevice) {
    ...
    ZE_HANDLE_TRACER_RECURSION(driverDdiTable.coreDdiTable.Device.pfnGetStatus,
                               hDevice);
    ...
    return L0::apiTracerWrapperImp(driverDdiTable.coreDdiTable.Device.pfnGetStatus,
                                   &tracerParams,
                                   apiCallbackData.apiOrdinal,
                                   apiCallbackData.prologCallbacks,
                                   apiCallbackData.epilogCallbacks,
