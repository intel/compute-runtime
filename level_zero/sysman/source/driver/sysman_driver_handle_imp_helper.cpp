...
namespace L0 {
namespace Sysman {
const std::vector<std::pair<std::string, uint32_t>> SysmanDriverHandleImp::extensionsSupported = {
    // Standard Sysman extensions
    ...
    // Experimental Sysman extensions
    {ZES_INTEL_DEVICE_HEALTH_EXP_NAME, ZES_INTEL_DEVICE_HEALTH_EXP_VERSION_CURRENT},
    {ZES_INTEL_DEVICE_STATE_EXP_NAME, ZES_INTEL_DEVICE_STATE_EXP_VERSION_CURRENT},
