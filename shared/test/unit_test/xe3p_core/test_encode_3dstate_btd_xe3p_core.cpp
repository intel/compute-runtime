...
using CommandEncodeEnableRayTracingXe3pCore = Test<CommandEncodeStatesFixture>;

XE3P_CORETEST_F(CommandEncodeEnableRayTracingXe3pCore, givenDefaultDebugFlagsWhenProgramEnableRayTracingThenIsSetProperly) {
...
XE3P_CORETEST_F(CommandEncodeEnableRayTracingXe3pCore, givenDebugFlagsWhenProgramEnableRayTracingThenIsSetProperly) {
    using _3DSTATE_BTD = typename FamilyType::_3DSTATE_BTD;
    DebugManagerStateRestore restore;
    debugManager.flags.ForceTheMaximumNumberOfOutstandingRayqueriesPerSs.set(1);
...
XE3P_CORETEST_F(CommandEncodeEnableRayTracingXe3pCore, givenRtMemStructures64bModeEnableWhenProgramEnableRayTracingThenIsSetProperly) {
    using _3DSTATE_BTD = typename FamilyType::_3DSTATE_BTD;
    ...
    auto cmd3dStateBtd = genCmdCast<_3DSTATE_BTD *>(*iterator3dStateBtd);
    EXPECT_EQ(static_cast<bool>(cmd3dStateBtd->getRtMemStructures64BModeEnable()), true);
}
