...
#include "opencl/test/unit_test/api/cl_get_platform_info_tests.inl"
#include "opencl/test/unit_test/api/cl_get_program_build_info_tests.inl"
...
#include "opencl/test/unit_test/api/cl_release_context_tests.inl"
#include "opencl/test/unit_test/api/cl_release_event_tests.inl"
#include "opencl/test/unit_test/api/cl_release_kernel_tests.inl"
#include "opencl/test/unit_test/api/cl_release_mem_obj_tests.inl"
#include "opencl/test/unit_test/api/cl_release_program_tests.inl"
#include "opencl/test/unit_test/api/cl_retain_mem_obj_tests.inl"
#include "opencl/test/unit_test/api/cl_retain_release_command_queue_tests.inl"
...
#include "opencl/test/unit_test/api/cl_set_program_release_callback.inl"
#include "opencl/test/unit_test/api/cl_set_program_specialization_constant_tests.inl"
#include "opencl/test/unit_test/api/cl_svm_alloc_tests.inl"
#include "opencl/test/unit_test/api/cl_svm_free_tests.inl"
#include "opencl/test/unit_test/api/cl_unload_compiler_tests.inl"
#include "opencl/test/unit_test/api/cl_unload_platform_compiler_tests.inl"
