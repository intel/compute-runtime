...
using namespace NEO;
namespace Ult {
class AggregatedSmallBuffersMtlDefaultTest : public ContextFixture,
...
MTLTEST_F(AggregatedSmallBuffersMtlDefaultTest, givenDifferentFlagValuesAndSingleOrMultiDeviceContextWhenCheckIfEnabledThenReturnCorrectValue) {
