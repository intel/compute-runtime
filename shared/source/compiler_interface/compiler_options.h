...
inline constexpr ConstStringRef bindlessImages = "-cl-intel-use-bindless-images";
inline constexpr ConstStringRef bindlessAdvancedMode = "-cl-intel-use-bindless-advanced-mode";
