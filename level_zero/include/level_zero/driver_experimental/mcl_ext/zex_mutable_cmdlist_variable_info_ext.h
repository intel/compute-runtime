...
typedef struct _zex_variable_info_t {
    ze_structure_type_ext_t stype; ///< [in] type of this structure ZEX_STRUCTURE_TYPE_VARIABLE_INFO
    ...
    zex_variable_flags_t flags;    ///< [out] flags providing additional metadata about the variable
    zex_variable_type_t type;      ///< [out] type of value represented by this variable
} zex_variable_info_t;
