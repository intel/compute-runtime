...
class ProductHelperHw : public ProductHelper {
  public:
    ...
    uint32_t getDeviceMemoryMaxBusWidthInBits(const HardwareInfo &hwInfo) const override;
    ...
    bool initializeInternalEngineImmediately() const override;
    ...
    bool isVmBindResourceDecompressionSupported() const override;
    ...
    uint32_t adjustMaxThreadsPerThreadGroup(uint32_t maxThreadsPerThreadGroup, uint32_t simt, uint32_t grfCount) const override;
