...
struct SysmanDevice : _ze_device_handle_t {
    ...
    static ze_result_t pciLinkSpeedUpdate(zes_device_handle_t hDevice, ze_bool_t downgradeUpgrade, zes_device_action_t *pendingAction);
    ...
    static ze_result_t getDeviceHealthStatus(zes_device_handle_t hDevice, zes_device_health_status_ext_t *pHealth);
