...
struct CommandListCoreFamily : public CommandList {
  ...
  protected:
    ...
    std::pair<NEO::GraphicsAllocation *, size_t> getIohAllocationAndOffsetForPrefetch(const Kernel &kernel, CmdListKernelLaunchParams &launchParams, bool isThreadDataMapAllowed);
