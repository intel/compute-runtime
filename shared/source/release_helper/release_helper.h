...
class ReleaseHelper {
  public:
    ...
    virtual void adjustRTDispatchGlobals(void *rtDispatchGlobals, uint32_t rtStacksPerDss, uint32_t maxBvhLevels) const = 0;
...
class ReleaseHelperHw : public ReleaseHelper {
  public:
    ...
    void adjustRTDispatchGlobals(void *rtDispatchGlobals, uint32_t rtStacksPerDss, uint32_t maxBvhLevels) const override;
