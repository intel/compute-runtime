...
enum TOK : uint32_t {
    ...
    TOK_FBD_SKU_FEATURE_TABLE__FTR_EFFICIENT64_BIT_ADDRESSING = 4298,
    TOK_FBD_SKU_FEATURE_TABLE__FTR_HW_SEMAPHORE64 = 4299,
    TOK_FBD_CREATECONTEXT_PVTDATA__USE_HW64B_TOKEN = 4307,
    TOK_FBC_CREATECONTEXT_PVTDATA__DISABLE_WMTP = 4308,
    TOK_FBC_CREATECONTEXT_PVTDATA__NOTIFY_PREEMPT_EXCEED_THRESHOLD = 4309,
    TOK_FBQ_CREATECONTEXT_PVTDATA__H_PREEMPT_CPU_EVENT_OBJECT = 4310,
    TOK_FBC_CREATECONTEXT_PVTDATA__DEBUG_SIPINSTALLED = 4311,
    TOK_FBC_CREATECONTEXT_PVTDATA__NUM_HW_QUEUES = 4312,
    TOK_S_CREATEHWQUEUE_PVTDATA = 4313,
    TOK_FBD_CREATEHWQUEUE_PVTDATA__QUEUE_PRIORITY = 4314,
