...
TEST_F(SysmanDriverFromHandleFixture, GivenNullHandleWhenFromHandleCalledThenReturnsNull) {
    auto result = SysmanDriverHandle::fromHandle(nullptr);
    EXPECT_EQ(result, nullptr);
}

TEST_F(SysmanDriverFromHandleFixture, GivenGlobalSysmanDriverHandleWhenFromHandleCalledThenReturnsGlobalDriver) {
...
TEST_F(SysmanDriverFromHandleFixture, GivenCoreDriverHandleWhenFromHandleCalledAndMappingIsFoundIncoreToSysmanDriverMapThenSysmanDriverIsReturned) {
...
TEST_F(SysmanDriverFromHandleFixture, GivenCoreDriverHandleWhenFromHandleCalledAndGetDeviceFailsThenNullPtrIsReturned) {
...
TEST_F(SysmanDriverFromHandleFixture, GivenCoreDriverHandleWhenFromHandleCalledAndGetDeviceReturnsDeviceCountZeroThenNullPtrIsReturned) {
...
TEST_F(SysmanDriverFromHandleFixture,
       GivenCoreDriverHandleWhenSysmanDriverCountQueryFailsThenNullIsReturned) {
...
TEST_F(SysmanDriverFromHandleFixture,
       GivenCoreDriverHandleWhenGettingSysmanDriverHandleAndGetDeviceByUuidFailsThenNullPtrIsReturned) {
...
TEST_F(SysmanDriverFromHandleFixture,
       GivenValidCoreDriverHandleWhenGettingSysmanDriverHandleThenValidSysmanHandleIsReturned) {
    VariableBackup<uint32_t> backupDriverCount(&L0::Sysman::driverCount, 1u);
...
TEST_F(SysmanDriverFromHandleFixture,
       GivenValidCoreDriverHandleWhenGettingSysmanDriverHandleTwiceThenValidSysmanHandleIsReturned) {
    VariableBackup<uint32_t> backupDriverCount(&L0::Sysman::driverCount, 1u);
    VariableBackup<_ze_driver_handle_t *> backupGlobal(
        &L0::Sysman::globalSysmanDriverHandle,
        static_cast<_ze_driver_handle_t *>(static_cast<SysmanDriverHandle *>(mockSysmanDriver.get())->toHandle()));
