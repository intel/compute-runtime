...
class OsContextLinux : public OsContext {
  public:
    ...
    Drm &getDrm() const;
    OsContextLinux *asOsContextLinux() override { return this; }
    virtual std::optional<std::pair<uint64_t, uint64_t>> getFenceAddressAndValToWait(uint32_t vmHandleId, bool isLocked);
