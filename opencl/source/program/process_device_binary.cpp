...
void Program::callGenerateDefaultExtendedArgsMetadataOnce(uint32_t rootDeviceIndex) {
    ...
    auto getTypeName = [](std::string &type, size_t argSize) -> void {
        switch (argSize) {
        case 1:
            type = std::string("char");
            break;
        case 2:
            type = std::string("short");
            break;
        case 4:
            type = std::string("int");
            break;
        case 8:
            ...
            break;
        case 12:
            type = std::string("int3");
            break;
        case 16:
            type = std::string("long2");
            break;
        case 24:
            type = std::string("long3");
            break;
        case 32:
            type = std::string("long4");
            break;
        case 64:
            type = std::string("long8");
            break;
        case 128:
            type = std::string("long16");
            break;
        default:
            break;
        }
            ...
            for (auto &kernelArg : kernelInfo->kernelDescriptor.payloadMappings.explicitArgs) {
                ...
                if (kernelArg.is<ArgDescriptor::ArgTValue>()) {
                    ...
                    if (maxSourceOffset != 0u) {
                        argMetadataExtended.type = std::string("char[" + std::to_string(maxSourceOffset + elemSize) + "]");
                    } else {
                        getTypeName(argMetadataExtended.type, elemSize);
                    }
                    ...
                    argMetadataExtended.type = std::string("void*");
