...
HWTEST_F(AubCommandStreamReceiverTests, givenAubCommandStreamReceiverWhenObtainingPreferredTagPoolSizeThenReturnDefaultValue) {
    ...
    EXPECT_EQ(2048u, aubCsr->getPreferredTagPoolSize());
}
