...
HWTEST2_F(CommandListAppendLaunchKernelMockModule,
          givenStateCacheInvalidationWaIsRequiredWhenTwoKernelsWithStatefulAccessAreAppendedThenPipeControlWithStateCacheInvalidationAndCsStallIsInsertedBetweenWalkers, IsAtLeastXeCore) {
    using PIPE_CONTROL = typename FamilyType::PIPE_CONTROL;
    using COMPUTE_WALKER = typename FamilyType::DefaultWalkerType;
