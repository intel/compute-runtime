...
using CommandsXe3CoreTest = ::testing::Test;

XE3_CORETEST_F(CommandsXe3CoreTest, GivenMediaSurfaceStateWhenInitCalledThenFieldsSetToDefault) {
    using MEDIA_SURFACE_STATE = NEO::Xe3CoreFamily::MEDIA_SURFACE_STATE;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMediaSurfaceStateWhenSetterUsedThenGetterReturnsValidValue) {
    using MEDIA_SURFACE_STATE = NEO::Xe3CoreFamily::MEDIA_SURFACE_STATE;
    MEDIA_SURFACE_STATE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenPipeControlWhenInitCalledThenFieldsSetToDefault) {
    using PIPE_CONTROL = NEO::Xe3CoreFamily::PIPE_CONTROL;
    PIPE_CONTROL cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenPipeControlWhenSetterUsedThenGetterReturnsValidValue) {
    using PIPE_CONTROL = NEO::Xe3CoreFamily::PIPE_CONTROL;
    PIPE_CONTROL cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiAtomicWhenInitCalledThenFieldsSetToDefault) {
    using MI_ATOMIC = NEO::Xe3CoreFamily::MI_ATOMIC;
    MI_ATOMIC cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiAtomicWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_ATOMIC = NEO::Xe3CoreFamily::MI_ATOMIC;
    MI_ATOMIC cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiBatchBufferEndWhenInitCalledThenFieldsSetToDefault) {
    using MI_BATCH_BUFFER_END = NEO::Xe3CoreFamily::MI_BATCH_BUFFER_END;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiBatchBufferEndWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_BATCH_BUFFER_END = NEO::Xe3CoreFamily::MI_BATCH_BUFFER_END;
    MI_BATCH_BUFFER_END cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiLoadRegisterImmWhenInitCalledThenFieldsSetToDefault) {
    using MI_LOAD_REGISTER_IMM = NEO::Xe3CoreFamily::MI_LOAD_REGISTER_IMM;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiLoadRegisterImmWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_LOAD_REGISTER_IMM = NEO::Xe3CoreFamily::MI_LOAD_REGISTER_IMM;
    MI_LOAD_REGISTER_IMM cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiNoopWhenInitCalledThenFieldsSetToDefault) {
    using MI_NOOP = NEO::Xe3CoreFamily::MI_NOOP;
    MI_NOOP cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiNoopWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_NOOP = NEO::Xe3CoreFamily::MI_NOOP;
    MI_NOOP cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenRenderSurfaceStateWhenInitCalledThenFieldsSetToDefault) {
    using RENDER_SURFACE_STATE = NEO::Xe3CoreFamily::RENDER_SURFACE_STATE;
    ...
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.EnableSamplerRouteToLsc);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.VerticalLineStrideOffset);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.VerticalLineStride);
    ...
    EXPECT_EQ(0x0ull, cmd.TheStructure._PropertyauxiliarySurfaceModeIsnotAux_NoneAnd_PropertyauxiliarySurfaceModeIsnotAux_Append.AuxiliarySurfaceBaseAddress); // patdhed
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenRenderSurfaceStateWhenSetterUsedThenGetterReturnsValidValue) { // patched
    using RENDER_SURFACE_STATE = NEO::Xe3CoreFamily::RENDER_SURFACE_STATE;
    RENDER_SURFACE_STATE cmd;
    cmd.init();
    ...
    cmd.setResourceMinLod(0x0u);                // patched
    EXPECT_EQ(0x0u, cmd.getResourceMinLod());   // patched
    cmd.setResourceMinLod(0xfffu);              // patched
    EXPECT_EQ(0xfffu, cmd.getResourceMinLod()); // patched
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenSamplerStateWhenInitCalledThenFieldsSetToDefault) {
    using SAMPLER_STATE = NEO::Xe3CoreFamily::SAMPLER_STATE;
    SAMPLER_STATE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenSamplerStateWhenSetterUsedThenGetterReturnsValidValue) { // patched
    using SAMPLER_STATE = NEO::Xe3CoreFamily::SAMPLER_STATE;
    SAMPLER_STATE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateBaseAddressWhenInitCalledThenFieldsSetToDefault) {
    using STATE_BASE_ADDRESS = NEO::Xe3CoreFamily::STATE_BASE_ADDRESS;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateBaseAddressWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_BASE_ADDRESS = NEO::Xe3CoreFamily::STATE_BASE_ADDRESS;
    STATE_BASE_ADDRESS cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiReportPerfCountWhenInitCalledThenFieldsSetToDefault) {
    using MI_REPORT_PERF_COUNT = NEO::Xe3CoreFamily::MI_REPORT_PERF_COUNT;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiReportPerfCountWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_REPORT_PERF_COUNT = NEO::Xe3CoreFamily::MI_REPORT_PERF_COUNT;
    MI_REPORT_PERF_COUNT cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiSetPredicateWhenInitCalledThenFieldsSetToDefault) {
    using MI_SET_PREDICATE = NEO::Xe3CoreFamily::MI_SET_PREDICATE;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiSetPredicateWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_SET_PREDICATE = NEO::Xe3CoreFamily::MI_SET_PREDICATE;
    MI_SET_PREDICATE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiConditionalBatchBufferEndWhenInitCalledThenFieldsSetToDefault) {
    using MI_CONDITIONAL_BATCH_BUFFER_END = NEO::Xe3CoreFamily::MI_CONDITIONAL_BATCH_BUFFER_END;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiConditionalBatchBufferEndWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_CONDITIONAL_BATCH_BUFFER_END = NEO::Xe3CoreFamily::MI_CONDITIONAL_BATCH_BUFFER_END;
    MI_CONDITIONAL_BATCH_BUFFER_END cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenPostsyncDataWhenInitCalledThenFieldsSetToDefault) {
    using POSTSYNC_DATA = NEO::Xe3CoreFamily::POSTSYNC_DATA;
    POSTSYNC_DATA cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenPostsyncDataWhenSetterUsedThenGetterReturnsValidValue) {
    using POSTSYNC_DATA = NEO::Xe3CoreFamily::POSTSYNC_DATA;
    POSTSYNC_DATA cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenInterfaceDescriptorDataWhenInitCalledThenFieldsSetToDefault) {
    using INTERFACE_DESCRIPTOR_DATA = NEO::Xe3CoreFamily::INTERFACE_DESCRIPTOR_DATA;
    INTERFACE_DESCRIPTOR_DATA cmd;
    cmd.init();

    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_STALL_BASED_ROUND_ROBIN, cmd.TheStructure.Common.EuThreadSchedulingModeOverride); // patched
    ...
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_128, cmd.TheStructure.Common.RegistersPerThread); // patched
    ...
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_60, cmd.TheStructure.Common.ZPassAsyncComputeThreadLimit);
    EXPECT_EQ(0x0u, cmd.TheStructure.Common.NpZAsyncThrottleSettings);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_DISABLED, cmd.TheStructure.Common.PsAsyncThreadLimit);
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenInterfaceDescriptorDataWhenSetterUsedThenGetterReturnsValidValue) {
    using INTERFACE_DESCRIPTOR_DATA = NEO::Xe3CoreFamily::INTERFACE_DESCRIPTOR_DATA;
    INTERFACE_DESCRIPTOR_DATA cmd;
    cmd.init();

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_HW_DEFAULT);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_HW_DEFAULT, cmd.getEuThreadSchedulingModeOverride());

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_OLDEST_FIRST);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_OLDEST_FIRST, cmd.getEuThreadSchedulingModeOverride());

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_ROUND_ROBIN);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_ROUND_ROBIN, cmd.getEuThreadSchedulingModeOverride());

    cmd.setEuThreadSchedulingModeOverride(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_STALL_BASED_ROUND_ROBIN);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::EU_THREAD_SCHEDULING_MODE_OVERRIDE_STALL_BASED_ROUND_ROBIN, cmd.getEuThreadSchedulingModeOverride());
    ...
    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_32, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_64);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_64, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_96);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_96, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_128);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_128, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_160);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_160, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_192);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_192, cmd.getRegistersPerThread());

    cmd.setRegistersPerThread(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_256);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::REGISTERS_PER_THREAD_REGISTERS_256, cmd.getRegistersPerThread());
    ...
    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_60);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_60, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_64);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_64, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_56);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_56, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_48);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_48, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_40);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_40, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_32, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_24);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_24, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setZPassAsyncComputeThreadLimit(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_16);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_16, cmd.getZPassAsyncComputeThreadLimit());

    cmd.setNpZAsyncThrottleSettings(INTERFACE_DESCRIPTOR_DATA::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_32, cmd.getNpZAsyncThrottleSettings());

    cmd.setNpZAsyncThrottleSettings(INTERFACE_DESCRIPTOR_DATA::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_40);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_40, cmd.getNpZAsyncThrottleSettings());

    cmd.setNpZAsyncThrottleSettings(INTERFACE_DESCRIPTOR_DATA::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_48);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::NP_Z_ASYNC_THROTTLE_SETTINGS_MAX_48, cmd.getNpZAsyncThrottleSettings());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_DISABLED);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_DISABLED, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_2);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_2, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_8);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_8, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_16);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_16, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_24);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_24, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_32);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_32, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_40);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_40, cmd.getPsAsyncThreadLimit());

    cmd.setPsAsyncThreadLimit(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_48);
    EXPECT_EQ(INTERFACE_DESCRIPTOR_DATA::PS_ASYNC_THREAD_LIMIT_MAX_48, cmd.getPsAsyncThreadLimit());
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenComputeWalkerWhenInitCalledThenFieldsSetToDefault) {
    using COMPUTE_WALKER = NEO::Xe3CoreFamily::COMPUTE_WALKER;
    COMPUTE_WALKER cmd;
    cmd.init();
    ...
    EXPECT_EQ(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_1, cmd.TheStructure.Common.ThreadGroupBatchSize);
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenComputeWalkerWhenSetterUsedThenGetterReturnsValidValue) {
    using COMPUTE_WALKER = NEO::Xe3CoreFamily::COMPUTE_WALKER;
    COMPUTE_WALKER cmd;
    cmd.init();
    ...
    cmd.setThreadGroupBatchSize(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_1);
    EXPECT_EQ(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_1, cmd.getThreadGroupBatchSize());

    cmd.setThreadGroupBatchSize(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_2);
    EXPECT_EQ(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_2, cmd.getThreadGroupBatchSize());

    cmd.setThreadGroupBatchSize(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_4);
    EXPECT_EQ(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_4, cmd.getThreadGroupBatchSize());

    cmd.setThreadGroupBatchSize(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_8);
    EXPECT_EQ(COMPUTE_WALKER::THREAD_GROUP_BATCH_SIZE_TG_BATCH_8, cmd.getThreadGroupBatchSize());
    ...
    cmd.setDispatchWalkOrder(COMPUTE_WALKER::DISPATCH_WALK_ORDER_MORTON_WALK);
    EXPECT_EQ(COMPUTE_WALKER::DISPATCH_WALK_ORDER_MORTON_WALK, cmd.getDispatchWalkOrder());
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenCfeStateWhenInitCalledThenFieldsSetToDefault) {
    using CFE_STATE = NEO::Xe3CoreFamily::CFE_STATE;
    CFE_STATE cmd;
    cmd.init();
    ...
    EXPECT_EQ(CFE_STATE::DYNAMIC_STACK_ID_CONTROL_ENABLED, cmd.TheStructure.Common.DynamicStackIdControl);
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenCfeStateWhenSetterUsedThenGetterReturnsValidValue) {
    using CFE_STATE = NEO::Xe3CoreFamily::CFE_STATE;
    CFE_STATE cmd;
    cmd.init();
    ...
    cmd.setDynamicStackIdControl(CFE_STATE::DYNAMIC_STACK_ID_CONTROL_DISABLED);
    EXPECT_EQ(CFE_STATE::DYNAMIC_STACK_ID_CONTROL_DISABLED, cmd.getDynamicStackIdControl());

    cmd.setDynamicStackIdControl(CFE_STATE::DYNAMIC_STACK_ID_CONTROL_ENABLED);
    EXPECT_EQ(CFE_STATE::DYNAMIC_STACK_ID_CONTROL_ENABLED, cmd.getDynamicStackIdControl());
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiArbCheckWhenInitCalledThenFieldsSetToDefault) {
    using MI_ARB_CHECK = NEO::Xe3CoreFamily::MI_ARB_CHECK;
    MI_ARB_CHECK cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiArbCheckWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_ARB_CHECK = NEO::Xe3CoreFamily::MI_ARB_CHECK;
    MI_ARB_CHECK cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiBatchBufferStartWhenInitCalledThenFieldsSetToDefault) {
    using MI_BATCH_BUFFER_START = NEO::Xe3CoreFamily::MI_BATCH_BUFFER_START;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiBatchBufferStartWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_BATCH_BUFFER_START = NEO::Xe3CoreFamily::MI_BATCH_BUFFER_START;
    MI_BATCH_BUFFER_START cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiLoadRegisterMemWhenInitCalledThenFieldsSetToDefault) {
    using MI_LOAD_REGISTER_MEM = NEO::Xe3CoreFamily::MI_LOAD_REGISTER_MEM;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiLoadRegisterMemWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_LOAD_REGISTER_MEM = NEO::Xe3CoreFamily::MI_LOAD_REGISTER_MEM;
    MI_LOAD_REGISTER_MEM cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiLoadRegisterRegWhenInitCalledThenFieldsSetToDefault) {
    using MI_LOAD_REGISTER_REG = NEO::Xe3CoreFamily::MI_LOAD_REGISTER_REG;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiLoadRegisterRegWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_LOAD_REGISTER_REG = NEO::Xe3CoreFamily::MI_LOAD_REGISTER_REG;
    MI_LOAD_REGISTER_REG cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiSemaphoreWaitWhenInitCalledThenFieldsSetToDefault) {
    using MI_SEMAPHORE_WAIT = NEO::Xe3CoreFamily::MI_SEMAPHORE_WAIT;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiSemaphoreWaitWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_SEMAPHORE_WAIT = NEO::Xe3CoreFamily::MI_SEMAPHORE_WAIT;
    MI_SEMAPHORE_WAIT cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiStoreDataImmWhenInitCalledThenFieldsSetToDefault) {
    using MI_STORE_DATA_IMM = NEO::Xe3CoreFamily::MI_STORE_DATA_IMM;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiStoreDataImmWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_STORE_DATA_IMM = NEO::Xe3CoreFamily::MI_STORE_DATA_IMM;
    MI_STORE_DATA_IMM cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiStoreRegisterMemWhenInitCalledThenFieldsSetToDefault) {
    using MI_STORE_REGISTER_MEM = NEO::Xe3CoreFamily::MI_STORE_REGISTER_MEM;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiStoreRegisterMemWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_STORE_REGISTER_MEM = NEO::Xe3CoreFamily::MI_STORE_REGISTER_MEM;
    MI_STORE_REGISTER_MEM cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenPipelineSelectWhenInitCalledThenFieldsSetToDefault) {
    using PIPELINE_SELECT = NEO::Xe3CoreFamily::PIPELINE_SELECT;
    PIPELINE_SELECT cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenPipelineSelectWhenSetterUsedThenGetterReturnsValidValue) {
    using PIPELINE_SELECT = NEO::Xe3CoreFamily::PIPELINE_SELECT;
    PIPELINE_SELECT cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateComputeModeWhenInitCalledThenFieldsSetToDefault) {
    using STATE_COMPUTE_MODE = NEO::Xe3CoreFamily::STATE_COMPUTE_MODE;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateComputeModeWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_COMPUTE_MODE = NEO::Xe3CoreFamily::STATE_COMPUTE_MODE;
    STATE_COMPUTE_MODE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMemSetWhenInitCalledThenFieldsSetToDefault) {
    using MEM_SET = NEO::Xe3CoreFamily::MEM_SET;
    MEM_SET cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMemSetWhenSetterUsedThenGetterReturnsValidValue) {
    using MEM_SET = NEO::Xe3CoreFamily::MEM_SET;
    MEM_SET cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMemCopyWhenInitCalledThenFieldsSetToDefault) {
    using MEM_COPY = NEO::Xe3CoreFamily::MEM_COPY;
    MEM_COPY cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMemCopyWhenSetterUsedThenGetterReturnsValidValue) {
    using MEM_COPY = NEO::Xe3CoreFamily::MEM_COPY;
    MEM_COPY cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenXyBlockCopyBltWhenInitCalledThenFieldsSetToDefault) {
    using XY_BLOCK_COPY_BLT = NEO::Xe3CoreFamily::XY_BLOCK_COPY_BLT;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenXyBlockCopyBltWhenSetterUsedThenGetterReturnsValidValue) {
    using XY_BLOCK_COPY_BLT = NEO::Xe3CoreFamily::XY_BLOCK_COPY_BLT;
    XY_BLOCK_COPY_BLT cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiMemFenceWhenInitCalledThenFieldsSetToDefault) {
    using MI_MEM_FENCE = NEO::Xe3CoreFamily::MI_MEM_FENCE;
    MI_MEM_FENCE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiMemFenceWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_MEM_FENCE = NEO::Xe3CoreFamily::MI_MEM_FENCE;
    MI_MEM_FENCE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, Given3dstateBindingTablePoolAllocWhenInitCalledThenFieldsSetToDefault) {
    using _3DSTATE_BINDING_TABLE_POOL_ALLOC = NEO::Xe3CoreFamily::_3DSTATE_BINDING_TABLE_POOL_ALLOC;
...
XE3_CORETEST_F(CommandsXe3CoreTest, Given3dstateBindingTablePoolAllocWhenSetterUsedThenGetterReturnsValidValue) {
    using _3DSTATE_BINDING_TABLE_POOL_ALLOC = NEO::Xe3CoreFamily::_3DSTATE_BINDING_TABLE_POOL_ALLOC;
    _3DSTATE_BINDING_TABLE_POOL_ALLOC cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenSamplerBorderColorStateWhenInitCalledThenFieldsSetToDefault) {
    using SAMPLER_BORDER_COLOR_STATE = NEO::Xe3CoreFamily::SAMPLER_BORDER_COLOR_STATE;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenSamplerBorderColorStateWhenSetterUsedThenGetterReturnsValidValue) {
    using SAMPLER_BORDER_COLOR_STATE = NEO::Xe3CoreFamily::SAMPLER_BORDER_COLOR_STATE;
    SAMPLER_BORDER_COLOR_STATE cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateSystemMemFenceAddressWhenInitCalledThenFieldsSetToDefault) {
    using STATE_SYSTEM_MEM_FENCE_ADDRESS = NEO::Xe3CoreFamily::STATE_SYSTEM_MEM_FENCE_ADDRESS;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateSystemMemFenceAddressWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_SYSTEM_MEM_FENCE_ADDRESS = NEO::Xe3CoreFamily::STATE_SYSTEM_MEM_FENCE_ADDRESS;
    STATE_SYSTEM_MEM_FENCE_ADDRESS cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, Given3dstateBtdWhenInitCalledThenFieldsSetToDefault) {
    using _3DSTATE_BTD = NEO::Xe3CoreFamily::_3DSTATE_BTD;
    _3DSTATE_BTD cmd;
    cmd.init();
    ...
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_16, cmd.TheStructure.Common.DynamicStackManagementMechanismMissPenalty);     // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_1, cmd.TheStructure.Common.DynamicStackManagementMechanismHitReward);          // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_16, cmd.TheStructure.Common.DynamicStackManagementMechanismScalingFactor); // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_256, cmd.TheStructure.Common.DynamicStackManagementMechanismReductionCap);  // patched
...
XE3_CORETEST_F(CommandsXe3CoreTest, Given3dstateBtdWhenSetterUsedThenGetterReturnsValidValue) {
    using _3DSTATE_BTD = NEO::Xe3CoreFamily::_3DSTATE_BTD;
    _3DSTATE_BTD cmd;
    cmd.init();
    ...
    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_1);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_1, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_2);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_2, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_4);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_4, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_8);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_8, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_16);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_16, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_32);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_32, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_64);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_64, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismMissPenalty(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_128);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_MISS_PENALTY_128, cmd.getDynamicStackManagementMechanismMissPenalty()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_1);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_1, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_2);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_2, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_4);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_4, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_8);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_8, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_16);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_16, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_32);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_32, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_64);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_64, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismHitReward(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_128);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_HIT_REWARD_128, cmd.getDynamicStackManagementMechanismHitReward()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_1);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_1, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_2);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_2, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_4);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_4, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_8);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_8, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_16);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_16, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_32);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_32, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_64);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_64, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismScalingFactor(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_128);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_SCALING_FACTOR_128, cmd.getDynamicStackManagementMechanismScalingFactor()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_128);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_128, cmd.getDynamicStackManagementMechanismReductionCap()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_256);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_256, cmd.getDynamicStackManagementMechanismReductionCap()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_384);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_384, cmd.getDynamicStackManagementMechanismReductionCap()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_512);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_512, cmd.getDynamicStackManagementMechanismReductionCap()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_640);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_640, cmd.getDynamicStackManagementMechanismReductionCap()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_768);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_768, cmd.getDynamicStackManagementMechanismReductionCap()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_896);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_896, cmd.getDynamicStackManagementMechanismReductionCap()); // patched

    cmd.setDynamicStackManagementMechanismReductionCap(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_1024);              // patched
    EXPECT_EQ(_3DSTATE_BTD::DYNAMIC_STACK_MANAGEMENT_MECHANISM_REDUCTION_CAP_1024, cmd.getDynamicStackManagementMechanismReductionCap()); // patched
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiUserInterruptWhenInitCalledThenFieldsSetToDefault) {
    using MI_USER_INTERRUPT = NEO::Xe3CoreFamily::MI_USER_INTERRUPT;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiUserInterruptWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_USER_INTERRUPT = NEO::Xe3CoreFamily::MI_USER_INTERRUPT;
    MI_USER_INTERRUPT cmd;
    cmd.init();
}

XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateSipWhenInitCalledThenFieldsSetToDefault) {
    using STATE_SIP = NEO::Xe3CoreFamily::STATE_SIP;
    STATE_SIP cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateSipWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_SIP = NEO::Xe3CoreFamily::STATE_SIP;
    STATE_SIP cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiFlushDwWhenInitCalledThenFieldsSetToDefault) {
    using MI_FLUSH_DW = NEO::Xe3CoreFamily::MI_FLUSH_DW;
    MI_FLUSH_DW cmd;
    cmd.init();

    EXPECT_EQ(MI_FLUSH_DW::DWORD_LENGTH_EXCLUDES_DWORD_0_1_, cmd.TheStructure.Common.DwordLength); // patched
    ...
    EXPECT_EQ_VAL(0x0ull, cmd.TheStructure.Common.DestinationAddress);
    EXPECT_EQ_VAL(0x0ull, cmd.TheStructure.Common.ImmediateData);
}

XE3_CORETEST_F(CommandsXe3CoreTest, GivenMiFlushDwWhenSetterUsedThenGetterReturnsValidValue) {
    using MI_FLUSH_DW = NEO::Xe3CoreFamily::MI_FLUSH_DW;
    MI_FLUSH_DW cmd;
    cmd.init();
    ...
    cmd.setDestinationAddress(0x0ull);
    EXPECT_EQ(0x0ull, cmd.getDestinationAddress());
    cmd.setDestinationAddress(0xfffffffffffffff8ull);
    EXPECT_EQ(0xfffffffffffffff8ull, cmd.getDestinationAddress());
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateContextDataBaseAddressWhenInitCalledThenFieldsSetToDefault) {
    using STATE_CONTEXT_DATA_BASE_ADDRESS = NEO::Xe3CoreFamily::STATE_CONTEXT_DATA_BASE_ADDRESS;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenStateContextDataBaseAddressWhenSetterUsedThenGetterReturnsValidValue) {
    using STATE_CONTEXT_DATA_BASE_ADDRESS = NEO::Xe3CoreFamily::STATE_CONTEXT_DATA_BASE_ADDRESS;
    STATE_CONTEXT_DATA_BASE_ADDRESS cmd;
    cmd.init();
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenXyFastColorBltWhenInitCalledThenFieldsSetToDefault) { // patched
    using XY_FAST_COLOR_BLT = NEO::Xe3CoreFamily::XY_FAST_COLOR_BLT;
...
XE3_CORETEST_F(CommandsXe3CoreTest, GivenXyFastColorBltWhenSetterUsedThenGetterReturnsValidValue) {
    using XY_FAST_COLOR_BLT = NEO::Xe3CoreFamily::XY_FAST_COLOR_BLT;
    XY_FAST_COLOR_BLT cmd;
    cmd.init();
    ...
    cmd.setSpecialModeOfOperation(XY_FAST_COLOR_BLT::SPECIAL_MODE_OF_OPERATION_NONE);
    EXPECT_EQ(XY_FAST_COLOR_BLT::SPECIAL_MODE_OF_OPERATION_NONE, cmd.getSpecialModeOfOperation());

    cmd.setSpecialModeOfOperation(XY_FAST_COLOR_BLT::SPECIAL_MODE_OF_OPERATION_USE_AUX_SPECIAL_OPERATIONS_MODE);
    EXPECT_EQ(XY_FAST_COLOR_BLT::SPECIAL_MODE_OF_OPERATION_USE_AUX_SPECIAL_OPERATIONS_MODE, cmd.getSpecialModeOfOperation());
    ...
    cmd.setColorDepth(XY_FAST_COLOR_BLT::COLOR_DEPTH_96_BIT_COLOR_ONLY_SUPPORTED_FOR_LINEAR_CASE);
    EXPECT_EQ(XY_FAST_COLOR_BLT::COLOR_DEPTH_96_BIT_COLOR_ONLY_SUPPORTED_FOR_LINEAR_CASE, cmd.getColorDepth());
