...
TEST_F(ReleaseHelper1274Tests, whenIsPreImageReadFlushRequiredCalledThenFalseReturned) {
...
TEST_F(ReleaseHelper1274Tests, whenIsStateCacheInvalidationWaRequiredCalledThenTrueOnlyForImmediateAndImageOrSampler) {
