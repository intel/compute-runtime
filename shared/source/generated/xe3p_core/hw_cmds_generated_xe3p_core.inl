...
typedef struct tagPIPE_CONTROL {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t PostSyncOperation : BITFIELD_RANGE(14, 16);
            ...
            uint32_t Reserved_62 : BITFIELD_RANGE(30, 30);
    ...
    typedef enum tagPOST_SYNC_OPERATION {
        ...
        POST_SYNC_OPERATION_WRITE_IMMEDIATE_DATA_32B = 0x4,
    } POST_SYNC_OPERATION;
...
typedef struct tagRENDER_SURFACE_STATE {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t DisableL1P5 : BITFIELD_RANGE(16, 16);
            uint32_t Reserved_49 : BITFIELD_RANGE(17, 18);
            ...
            uint32_t ExtendScratchSurfaceSize : BITFIELD_RANGE(14, 14);
            ...
            uint32_t Reserved_236 : BITFIELD_RANGE(12, 12);
            uint32_t OverrideTileBPP : BITFIELD_RANGE(13, 15);
    ...
    typedef enum tagOVERRIDETILEBPP {
        OVERRIDETILEBPP_TILE64_LEGACY = 0x0,
        OVERRIDETILEBPP_TILE64_64BPP = 0x1,
        OVERRIDETILEBPP_TILE64_32BPP = 0x2,
        OVERRIDETILEBPP_TILE64_16BPP = 0x3,
        OVERRIDETILEBPP_TILE64_8BPP = 0x4,
    } OVERRIDETILEBPP;
    ...
    inline void init() {
        ...
        TheStructure.Common.OverrideTileBPP = OVERRIDETILEBPP_TILE64_LEGACY;
        TheStructure.Common.CompressionFormat = COMPRESSION_FORMAT_CMF_R8;
    ...
    inline void setDisableL1P5(const bool value) {
        TheStructure.Common.DisableL1P5 = value;
    }
    inline bool getDisableL1P5() const {
        return TheStructure.Common.DisableL1P5;
    }
    ...
    inline void setExtendScratchSurfaceSize(const bool value) {
        TheStructure.Common.ExtendScratchSurfaceSize = value;
    }
    inline bool getExtendScratchSurfaceSize() const {
        return TheStructure.Common.ExtendScratchSurfaceSize;
    }
    ...
    inline void setOverrideTileBPP(const OVERRIDETILEBPP value) {
        TheStructure.Common.OverrideTileBPP = value;
    }
    inline OVERRIDETILEBPP getOverrideTileBPP() const {
        return static_cast<OVERRIDETILEBPP>(TheStructure.Common.OverrideTileBPP);
    }
...
typedef struct tagSAMPLER_STATE {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t YcrcbBorderMode : BITFIELD_RANGE(29, 29);
            ...
            uint32_t Reserved_66 : BITFIELD_RANGE(2, 4);
            ...
            uint32_t AnisotropicQuality : BITFIELD_RANGE(27, 28);
            uint32_t Reserved_125 : BITFIELD_RANGE(29, 31);
            // DWORD 4
            float Reserved_128;
            // DWORD 5
            uint32_t Reserved_160;
        ...
        struct tagChromakeyEnableIsFalse {
            // DWORD 0
            uint32_t Reserved_0;
            // DWORD 1
            uint32_t Reserved_32;
            ...
            // DWORD 7
            float Reserved_224;
        } ChromakeyEnableIsFalse;
        struct tagChromakeyEnableIsTrue {
            // DWORD 0
            uint32_t Reserved_0;
            // DWORD 1
            uint32_t Reserved_32;
            ...
            float Reserved_128;
            // DWORD 5
            uint32_t ChromakeyHigh;
            // DWORD 6
            float Reserved_192;
            // DWORD 7
            float Reserved_224;
        } ChromakeyEnableIsTrue;
        uint32_t RawData[8];
    } TheStructure;
    ...
    typedef enum tagYCRCB_BORDER_MODE {
        YCRCB_BORDER_MODE_PASSTHROUGH = 0x0,
        YCRCB_BORDER_MODE_TRANSFORM_BLACK = 0x1,
    } YCRCB_BORDER_MODE;
    ...
    typedef enum tagMIP_LINEAR_FILTER_QUALITY {
        MIP_LINEAR_FILTER_QUALITY_FULL = 0x0,
        MIP_LINEAR_FILTER_QUALITY_HIGH = 0x1,
        MIP_LINEAR_FILTER_QUALITY_MEDIUM = 0x2,
        MIP_LINEAR_FILTER_QUALITY_LOW = 0x3,
    ...
    typedef enum tagLOW_QUALITY_FILTER { // patched
        LOW_QUALITY_FILTER_DISABLE = 0x0,
        LOW_QUALITY_FILTER_ENABLE = 0x1,
    } LOW_QUALITY_FILTER;
    typedef enum tagANISOTROPIC_QUALITY {
        ANISOTROPIC_QUALITY_FULL = 0x0,
        ANISOTROPIC_QUALITY_HIGH = 0x1,
        ANISOTROPIC_QUALITY_MEDIUM = 0x2,
        ANISOTROPIC_QUALITY_LOW = 0x3,
    } ANISOTROPIC_QUALITY;
    inline void init() {
        memset(&TheStructure, 0, sizeof(TheStructure));
        ...
        TheStructure.Common.YcrcbBorderMode = YCRCB_BORDER_MODE_PASSTHROUGH;
        ...
        TheStructure.Common.MipLinearFilterQuality = MIP_LINEAR_FILTER_QUALITY_FULL;
        ...
        TheStructure.Common.AnisotropicQuality = ANISOTROPIC_QUALITY_FULL;
        TheStructure.Common.BorderColorBlue = 0.0;
        TheStructure.Common.BorderColorAlpha = 0.0;
        TheStructure.ChromakeyEnableIsFalse.BorderColorRed = 0.0;
        TheStructure.ChromakeyEnableIsFalse.BorderColorGreen = 0.0;
    }
    ...
    inline void setYcrcbBorderMode(const YCRCB_BORDER_MODE value) {
        TheStructure.Common.YcrcbBorderMode = value;
    }
    inline YCRCB_BORDER_MODE getYcrcbBorderMode() const {
        return static_cast<YCRCB_BORDER_MODE>(TheStructure.Common.YcrcbBorderMode);
    }
    ...
    inline void setIndirectStatePointer(const uint32_t value) { // patched
    ...
    inline void setAnisotropicQuality(const ANISOTROPIC_QUALITY value) {
        TheStructure.Common.AnisotropicQuality = value;
    }
    inline ANISOTROPIC_QUALITY getAnisotropicQuality() const {
        return static_cast<ANISOTROPIC_QUALITY>(TheStructure.Common.AnisotropicQuality);
    }
    ...
    inline void setBorderColorRed(const float value) {
        TheStructure.ChromakeyEnableIsFalse.BorderColorRed = value;
    }
    inline float getBorderColorRed() const {
        return TheStructure.ChromakeyEnableIsFalse.BorderColorRed;
    }
    inline void setBorderColorGreen(const float value) {
        TheStructure.ChromakeyEnableIsFalse.BorderColorGreen = value;
    }
    inline float getBorderColorGreen() const {
        return TheStructure.ChromakeyEnableIsFalse.BorderColorGreen;
    }
    inline void setChromakeyHigh(const uint32_t value) {
        TheStructure.ChromakeyEnableIsTrue.ChromakeyHigh = value;
    }
    inline uint32_t getChromakeyHigh() const {
        return TheStructure.ChromakeyEnableIsTrue.ChromakeyHigh;
    }
} SAMPLER_STATE;
STATIC_ASSERT(32 == sizeof(SAMPLER_STATE));
...
typedef struct tagSTATE_BASE_ADDRESS {
    ...
    inline bool getBaseAddressDisable() const {
        return TheStructure.Common.BaseAddressDisable;
    }
...
typedef struct tag_3DSTATE_BTD {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t MaximumBtdLaneOccupancy : BITFIELD_RANGE(3, 3);
            uint32_t Reserved_36 : BITFIELD_RANGE(4, 6);
    ...
    typedef enum tagMAXIMUM_BTD_LANE_OCCUPANCY {
        MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_32 = 0x0,
        MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_16 = 0x1,
    } MAXIMUM_BTD_LANE_OCCUPANCY;
    ...
    inline void init() {
        ...
        TheStructure.Common.MaximumBtdLaneOccupancy = MAXIMUM_BTD_LANE_OCCUPANCY_MAX_OCCUPANCY_32;
    ...
    inline void setMaximumBtdLaneOccupancy(const MAXIMUM_BTD_LANE_OCCUPANCY value) {
        TheStructure.Common.MaximumBtdLaneOccupancy = value;
    }
    inline MAXIMUM_BTD_LANE_OCCUPANCY getMaximumBtdLaneOccupancy() const {
        return static_cast<MAXIMUM_BTD_LANE_OCCUPANCY>(TheStructure.Common.MaximumBtdLaneOccupancy);
    }
...
typedef struct tagPOSTSYNC_DATA_2 {
    union tagTheStructure {
        struct tagCommon {
            // DWORD 0
            uint32_t Reserved_0 : BITFIELD_RANGE(0, 1);
            uint32_t DataportPipelineFlush : BITFIELD_RANGE(2, 2);
            uint32_t InterruptSignalEnable : BITFIELD_RANGE(3, 3);
            uint32_t MocsEncryptedData : BITFIELD_RANGE(4, 4);
            uint32_t MocsIndexToMocsTables : BITFIELD_RANGE(5, 10);
            uint32_t SystemMemoryFenceRequest : BITFIELD_RANGE(11, 11);
            uint32_t DataportSubsliceCacheFlush : BITFIELD_RANGE(12, 12);
            uint32_t L2Flush : BITFIELD_RANGE(13, 13);
            uint32_t L2TransientFlush : BITFIELD_RANGE(14, 14);
            uint32_t Reserved_15 : BITFIELD_RANGE(15, 15);
            uint32_t Operation : BITFIELD_RANGE(16, 17);
            uint32_t ReservedForFuturePostsyncOp_18 : BITFIELD_RANGE(18, 18);
            uint32_t SerializePostsyncOps : BITFIELD_RANGE(19, 19);
            uint32_t AtomicDataSize : BITFIELD_RANGE(20, 20);
            uint32_t ImmediateDataSize : BITFIELD_RANGE(21, 21);
            uint32_t Reserved_22 : BITFIELD_RANGE(22, 23);
            uint32_t AtomicOpcode : BITFIELD_RANGE(24, 31);
            // DWORD 1
            uint64_t DestinationAddress;
            // DWORD 3
            uint64_t Data;
    ...
    typedef enum tagOPERATION {
        OPERATION_NO_WRITE = 0x0,
        OPERATION_WRITE_IMMEDIATE_DATA = 0x1,
        OPERATION_ATOMIC_OPN = 0x2,
        OPERATION_WRITE_TIMESTAMP = 0x3,
    } OPERATION;
    typedef enum tagATOMIC_DATA_SIZE {
        ATOMIC_DATA_SIZE_DWORD = 0x0,
        ATOMIC_DATA_SIZE_QWORD = 0x1,
    } ATOMIC_DATA_SIZE;
    typedef enum tagATOMIC_OPCODE {
        ATOMIC_OPCODE_ATOMIC_AND = 0x1,
        ATOMIC_OPCODE_ATOMIC_OR = 0x2,
        ATOMIC_OPCODE_ATOMIC_XOR = 0x3,
        ATOMIC_OPCODE_ATOMIC_MOVE = 0x4,
        ATOMIC_OPCODE_ATOMIC_INC = 0x5,
        ATOMIC_OPCODE_ATOMIC_DEC = 0x6,
        ATOMIC_OPCODE_ATOMIC_ADD = 0x7,
        ATOMIC_OPCODE_ATOMIC_SUB = 0x8,
        ATOMIC_OPCODE_ATOMIC_IMAX = 0xa,
        ATOMIC_OPCODE_ATOMIC_IMIN = 0xb,
        ATOMIC_OPCODE_ATOMIC_UMAX = 0xc,
        ATOMIC_OPCODE_ATOMIC_UMIN = 0xd,
        ATOMIC_OPCODE_ATOMIC_CMPWR = 0xe,
        ATOMIC_OPCODE_ATOMIC_AND8B = 0x21,
        ATOMIC_OPCODE_ATOMIC_OR8B = 0x22,
        ATOMIC_OPCODE_ATOMIC_XOR8B = 0x23,
        ATOMIC_OPCODE_ATOMIC_MOVE8B = 0x24,
        ATOMIC_OPCODE_ATOMIC_INC8B = 0x25,
        ATOMIC_OPCODE_ATOMIC_DEC8B = 0x26,
        ATOMIC_OPCODE_ATOMIC_ADD8B = 0x27,
        ATOMIC_OPCODE_ATOMIC_SUB8B = 0x28,
        ATOMIC_OPCODE_ATOMIC_IMAX8B = 0x2a,
        ATOMIC_OPCODE_ATOMIC_IMIN8B = 0x2b,
        ATOMIC_OPCODE_ATOMIC_UMAX8B = 0x2c,
        ATOMIC_OPCODE_ATOMIC_UMIN8B = 0x2d,
        ATOMIC_OPCODE_ATOMIC_CMPWR8B = 0x2e,
        ATOMIC_OPCODE_ATOMIC_FADD = 0x87,
        ATOMIC_OPCODE_ATOMIC_FSUB = 0x88,
        ATOMIC_OPCODE_ATOMIC_MAX_FLOAT32 = 0x8a,
        ATOMIC_OPCODE_ATOMIC_MIN_FLOAT32 = 0x8b,
        ATOMIC_OPCODE_ATOMIC_CMPWR_FLOAT32 = 0x8e,
    } ATOMIC_OPCODE;
    inline void init() {
        memset(&TheStructure, 0, sizeof(TheStructure));
        TheStructure.Common.Operation = OPERATION_NO_WRITE;
        TheStructure.Common.AtomicDataSize = ATOMIC_DATA_SIZE_DWORD;
    }
    static tagPOSTSYNC_DATA_2 sInit() {
        POSTSYNC_DATA_2 state;
        state.init();
        return state;
    }
    inline uint32_t &getRawData(const uint32_t index) {
    ...
    inline void setInterruptSignalEnable(const bool value) {
        TheStructure.Common.InterruptSignalEnable = value;
    }
    inline bool getInterruptSignalEnable() const {
        return TheStructure.Common.InterruptSignalEnable;
    }
    inline void setMocsEncryptedData(const bool value) {
        TheStructure.Common.MocsEncryptedData = value;
    }
    ...
    inline void setL2Flush(const bool value) {
        TheStructure.Common.L2Flush = value;
    }
    inline bool getL2Flush() const {
        return TheStructure.Common.L2Flush;
    }
    inline void setL2TransientFlush(const bool value) {
        TheStructure.Common.L2TransientFlush = value;
    }
    inline bool getL2TransientFlush() const {
        return TheStructure.Common.L2TransientFlush;
    }
    inline void setOperation(const OPERATION value) {
        TheStructure.Common.Operation = value;
    }
    ...
    inline void setSerializePostsyncOps(const bool value) {
        TheStructure.Common.SerializePostsyncOps = value;
    }
    inline bool getSerializePostsyncOps() const {
        return TheStructure.Common.SerializePostsyncOps;
    }
    inline void setAtomicDataSize(const ATOMIC_DATA_SIZE value) {
        TheStructure.Common.AtomicDataSize = value;
    }
    inline ATOMIC_DATA_SIZE getAtomicDataSize() const {
        return static_cast<ATOMIC_DATA_SIZE>(TheStructure.Common.AtomicDataSize);
    }
    inline void setAtomicOpcode(const ATOMIC_OPCODE value) {
        TheStructure.Common.AtomicOpcode = value;
    }
    inline ATOMIC_OPCODE getAtomicOpcode() const {
        return static_cast<ATOMIC_OPCODE>(TheStructure.Common.AtomicOpcode);
    }
    inline void setDestinationAddress(const uint64_t value) {
        TheStructure.Common.DestinationAddress = value;
    }
    ...
    inline void setImmediateData(const uint64_t value) { // patched
        TheStructure.Common.Data = value;
    }
    inline uint64_t getImmediateData() const { // patched
        return TheStructure.Common.Data;
    }
} POSTSYNC_DATA_2;
STATIC_ASSERT(20 == sizeof(POSTSYNC_DATA_2));
...
typedef struct tagINTERFACE_DESCRIPTOR_DATA {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t Reserved_228 : BITFIELD_RANGE(4, 9);
            uint32_t DynamicPrefSlmIncrease : BITFIELD_RANGE(10, 11);
            uint32_t Reserved_236 : BITFIELD_RANGE(12, 31);
        } Common;
        uint32_t RawData[8];
    } TheStructure;
    ...
    typedef enum tagREGISTERS_PER_THREAD {
        ...
        REGISTERS_PER_THREAD_REGISTERS_512 = 0xf,
    ...
    typedef enum tagSHARED_LOCAL_MEMORY_SIZE {
        ...
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_320K = 0xe,
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_384K = 0xf,
    ...
    typedef enum tagPREFERRED_SLM_ALLOCATION_SIZE {
        ...
        PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_256K = 0x8,
        PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_320K = 0x9,
        PREFERRED_SLM_ALLOCATION_SIZE_SLM_ENCODES_384K = 0xa,
    } PREFERRED_SLM_ALLOCATION_SIZE;
    typedef enum tagDYNAMIC_PREF_SLM_INCREASE {
        DYNAMIC_PREF_SLM_INCREASE_DISABLE = 0x0,
        DYNAMIC_PREF_SLM_INCREASE_MAX_FULL = 0x1,
        DYNAMIC_PREF_SLM_INCREASE_MAX_2X = 0x2,
    } DYNAMIC_PREF_SLM_INCREASE;
    inline void init() {
        memset(&TheStructure, 0, sizeof(TheStructure));
        ...
        TheStructure.Common.RegistersPerThread = REGISTERS_PER_THREAD_REGISTERS_32;
        ...
        TheStructure.Common.DynamicPrefSlmIncrease = DYNAMIC_PREF_SLM_INCREASE_DISABLE;
    }
    ...
    inline void setDynamicPrefSlmIncrease(const DYNAMIC_PREF_SLM_INCREASE value) {
        TheStructure.Common.DynamicPrefSlmIncrease = value;
    }
    inline DYNAMIC_PREF_SLM_INCREASE getDynamicPrefSlmIncrease() const {
        return static_cast<DYNAMIC_PREF_SLM_INCREASE>(TheStructure.Common.DynamicPrefSlmIncrease);
    }
} INTERFACE_DESCRIPTOR_DATA;
STATIC_ASSERT(32 == sizeof(INTERFACE_DESCRIPTOR_DATA));

typedef struct tagINTERFACE_DESCRIPTOR_DATA_2 {
    union tagTheStructure {
        struct tagCommon {
            // DWORD 0
            uint64_t Reserved_0 : BITFIELD_RANGE(0, 5);
            uint64_t KernelStartPointer : BITFIELD_RANGE(6, 63);
            // DWORD 2
            uint32_t EuThreadSchedulingModeOverride : BITFIELD_RANGE(0, 1);
            uint32_t Reserved_66 : BITFIELD_RANGE(2, 6);
            uint32_t SoftwareExceptionEnable : BITFIELD_RANGE(7, 7);
            ...
            uint32_t Reserved_128;
            // DWORD 5
            uint32_t NumberOfThreadsInGpgpuThreadGroup : BITFIELD_RANGE(0, 7);
            uint32_t Reserved_168 : BITFIELD_RANGE(8, 12);
            uint32_t ThreadGroupForwardProgressGuarantee : BITFIELD_RANGE(13, 13);
            uint32_t Reserved_174 : BITFIELD_RANGE(14, 14);
            uint32_t BtdMode : BITFIELD_RANGE(15, 15);
            uint32_t SharedLocalMemorySize : BITFIELD_RANGE(16, 20);
            uint32_t Reserved_181 : BITFIELD_RANGE(21, 21);
            uint32_t RoundingMode : BITFIELD_RANGE(22, 23);
            uint32_t Reserved_184 : BITFIELD_RANGE(24, 24);
            uint32_t ThreadGroupDispatchSize : BITFIELD_RANGE(25, 27);
            uint32_t NumberOfBarriers : BITFIELD_RANGE(28, 31);
            // DWORD 6
            uint32_t Reserved_192 : BITFIELD_RANGE(0, 7);
            uint32_t ZPassAsyncComputeThreadLimit : BITFIELD_RANGE(8, 10);
            uint32_t Reserved_203 : BITFIELD_RANGE(11, 11);
    ...
    typedef enum tagSHARED_LOCAL_MEMORY_SIZE {
        ...
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_320K = 0xe,
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_384K = 0xf,
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_3K = 0x10,  // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_5K = 0x11,  // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_6K = 0x12,  // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_7K = 0x13,  // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_9K = 0x14,  // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_10K = 0x15, // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_11K = 0x16, // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_12K = 0x17, // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_13K = 0x18, // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_14K = 0x19, // patched
        SHARED_LOCAL_MEMORY_SIZE_SLM_ENCODES_15K = 0x1a, // patched
    } SHARED_LOCAL_MEMORY_SIZE;
    typedef enum tagROUNDING_MODE {
        ROUNDING_MODE_RTNE = 0x0,
        ROUNDING_MODE_RU = 0x1,
    ...
    typedef enum tagTHREAD_GROUP_DISPATCH_SIZE {
        THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_8 = 0x0,
        THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_4 = 0x2,
        THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_2 = 0x4,
        THREAD_GROUP_DISPATCH_SIZE_TG_SIZE_1 = 0x6,
    } THREAD_GROUP_DISPATCH_SIZE;
    typedef enum tagNUMBER_OF_BARRIERS {
        NUMBER_OF_BARRIERS_NONE = 0x0,
        NUMBER_OF_BARRIERS_B1 = 0x1,
    ...
    static tagINTERFACE_DESCRIPTOR_DATA_2 sInit() {
        INTERFACE_DESCRIPTOR_DATA_2 state;
        state.init();
        return state;
    }
    inline uint32_t &getRawData(const uint32_t index) {
    ...
    inline void setKernelStartPointer(const uint64_t value) {
        TheStructure.Common.KernelStartPointer = value >> KERNELSTARTPOINTER_BIT_SHIFT;
    }
    inline uint64_t getKernelStartPointer() const {
    ...
    inline uint32_t getSharedLocalMemorySize() const { // patched
        return TheStructure.Common.SharedLocalMemorySize;
    }
    inline void setRoundingMode(const ROUNDING_MODE value) {
        TheStructure.Common.RoundingMode = value;
    }
...
} INTERFACE_DESCRIPTOR_DATA_2;
STATIC_ASSERT(32 == sizeof(INTERFACE_DESCRIPTOR_DATA_2));
...
typedef struct tagCOMPUTE_WALKER_2 {
    union tagTheStructure {
        struct tagCommon {
            // DWORD 0
            uint32_t DwordLength : BITFIELD_RANGE(0, 7);
            ...
            uint32_t WorkloadPartitionEnable : BITFIELD_RANGE(9, 9);
            uint32_t IndirectParameterEnable : BITFIELD_RANGE(10, 10);
            uint32_t PreemptHighPri : BITFIELD_RANGE(11, 11);
            uint32_t Reserved_12 : BITFIELD_RANGE(12, 12);
            uint32_t DispatchComplete : BITFIELD_RANGE(13, 13);
            uint32_t PostsyncAllocated : BITFIELD_RANGE(14, 14);
            uint32_t CfeSubopcodeVariant : BITFIELD_RANGE(15, 17);
            uint32_t CfeSubopcode : BITFIELD_RANGE(18, 23);
            uint32_t ComputeCommandOpcode : BITFIELD_RANGE(24, 26);
            uint32_t Pipeline : BITFIELD_RANGE(27, 28);
            ...
            uint32_t Reserved_64;
            // DWORD 2
            uint32_t ThreadDispatchPolicy : BITFIELD_RANGE(0, 0);
            uint32_t Reserved_97 : BITFIELD_RANGE(1, 1);
            uint32_t StackIdControl : BITFIELD_RANGE(2, 3);
            uint32_t Reserved_100 : BITFIELD_RANGE(4, 4);
            uint32_t DynamicStackIdControl : BITFIELD_RANGE(5, 5);
            uint32_t Reserved_102 : BITFIELD_RANGE(6, 6);
            uint32_t ComputeOverdispatchDisable : BITFIELD_RANGE(7, 7);
            uint32_t Reserved_103 : BITFIELD_RANGE(8, 8);
            uint32_t OverDispatchControl : BITFIELD_RANGE(9, 10);
            uint32_t Reserved_107 : BITFIELD_RANGE(11, 11);
            uint32_t ThreadArbitrationPolicy : BITFIELD_RANGE(12, 13);
            uint32_t Reserved_110 : BITFIELD_RANGE(14, 15);
            ...
            uint32_t ThreadGroupBatchSize : BITFIELD_RANGE(3, 4);
            uint32_t DispatchWalkOrder : BITFIELD_RANGE(5, 7);
            uint32_t Reserved_136 : BITFIELD_RANGE(8, 16);
            uint32_t MessageSimd : BITFIELD_RANGE(17, 18);
            uint32_t TileLayout : BITFIELD_RANGE(19, 21);
            uint32_t WalkOrder : BITFIELD_RANGE(22, 24);
            uint32_t EmitInlineParameter : BITFIELD_RANGE(25, 25);
            ...
            uint32_t ThreadGroupIdStartingZ;
            // DWORD 12
            uint64_t PartitionId : BITFIELD_RANGE(0, 7);
            uint64_t PartitionType : BITFIELD_RANGE(8, 9);
            uint64_t Reserved_426 : BITFIELD_RANGE(10, 11);
            uint64_t DispatchAllModValue : BITFIELD_RANGE(12, 13);
            uint64_t Reserved_430 : BITFIELD_RANGE(14, 15);
            uint64_t Quantumsize : BITFIELD_RANGE(16, 19);
            uint64_t Reserved_436 : BITFIELD_RANGE(20, 22);
            uint64_t QuantumLocalityCheckEnable : BITFIELD_RANGE(23, 23);
            uint64_t XecuFullEmptyCheckEnable : BITFIELD_RANGE(24, 24);
            uint64_t Reserved_441 : BITFIELD_RANGE(25, 31);
            // DWORD 13
            uint64_t PartitionSize : BITFIELD_RANGE(32, 63);
            // DWORD 14
            uint32_t PreemptX;
            ...
            uint32_t PreemptZ;
            // DWORD 17
            uint32_t WalkerId : BITFIELD_RANGE(0, 4);
            uint32_t OverDispatchTgCount : BITFIELD_RANGE(5, 18);
            uint32_t PostsyncId : BITFIELD_RANGE(19, 25);
            uint32_t Apqid : BITFIELD_RANGE(26, 31);
            // DWORD 18
            INTERFACE_DESCRIPTOR_DATA_2 InterfaceDescriptor;
            // DWORD 26
            POSTSYNC_DATA_2 PostSync; // patched
            // DWORD 31
            uint32_t InlineData[16];
            // DWORD 47
            POSTSYNC_DATA_2 PostSyncOpn1;
            // DWORD 52
            POSTSYNC_DATA_2 PostSyncOpn2;
            // DWORD 57
            POSTSYNC_DATA_2 PostSyncOpn3;
            // DWORD 62
            uint32_t PreemptCsInterruptVector : BITFIELD_RANGE(0, 9);
            uint32_t Reserved_2026 : BITFIELD_RANGE(10, 31);
        } Common;
        uint32_t RawData[64];
    } TheStructure;
    typedef enum tagDWORD_LENGTH {
        DWORD_LENGTH_FIXED_SIZE = 0x3e,
    } DWORD_LENGTH;
    typedef enum tagCFE_SUBOPCODE_VARIANT {
        CFE_SUBOPCODE_VARIANT_STANDARD = 0x0,
        CFE_SUBOPCODE_VARIANT_PASS1_RESUME = 0x1,
    ...
    typedef enum tagCFE_SUBOPCODE {
        CFE_SUBOPCODE_COMPUTE_WALKER_2 = 0x8,
    } CFE_SUBOPCODE;
    typedef enum tagCOMPUTE_COMMAND_OPCODE {
        COMPUTE_COMMAND_OPCODE_NEW_CFE_COMMAND = 0x2,
    } COMPUTE_COMMAND_OPCODE;
    ...
    typedef enum tagTHREAD_DISPATCH_POLICY {
        THREAD_DISPATCH_POLICY_BREADTH_WISE = 0x0,
        THREAD_DISPATCH_POLICY_DEPTH_WISE = 0x1,
    } THREAD_DISPATCH_POLICY;
    ...
    typedef enum tagTHREAD_ARBITRATION_POLICY {
        THREAD_ARBITRATION_POLICY_ALWAYS_ROUND_ROBIN = 0x0,
        THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_50 = 0x1,
        THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_25 = 0x2,
        THREAD_ARBITRATION_POLICY_ABRITRATION_SWITCH_AT_75 = 0x3,
    } THREAD_ARBITRATION_POLICY;
    typedef enum tagDISPATCH_WALK_ORDER {
        DISPATCH_WALK_ORDER_LINEAR_WALK = 0x0,
        DISPATCH_WALK_ORDER_Y_ORDER_WALK = 0x1,
        DISPATCH_WALK_ORDER_MORTON_2X2_XY_WALK = 0x2,
        DISPATCH_WALK_ORDER_MORTON_WALK = 0x2, // patched
    } DISPATCH_WALK_ORDER;
    typedef enum tagTHREAD_GROUP_BATCH_SIZE {
        THREAD_GROUP_BATCH_SIZE_TG_BATCH_1 = 0x0,
        THREAD_GROUP_BATCH_SIZE_TG_BATCH_2 = 0x1,
    ...
    typedef enum tagDISPATCH_ALL_MOD_VALUE {
        DISPATCH_ALL_MOD_VALUE_MOD1 = 0x0,
        DISPATCH_ALL_MOD_VALUE_MOD2 = 0x1,
        DISPATCH_ALL_MOD_VALUE_MOD4 = 0x2,
    } DISPATCH_ALL_MOD_VALUE;
    typedef enum tagQUANTUMSIZE {
        QUANTUMSIZE_QUANTUM_DISPATCH_DISABLED = 0x0,
        QUANTUMSIZE_QUANTUM_SIZE_4 = 0x1,
        QUANTUMSIZE_QUANTUM_SIZE_8 = 0x2,
        QUANTUMSIZE_QUANTUM_SIZE_14 = 0x3,
        QUANTUMSIZE_QUANTUM_SIZE_16 = 0x4,
        QUANTUMSIZE_QUANTUM_SIZE_20 = 0x5,
        QUANTUMSIZE_QUANTUM_SIZE_24 = 0x6,
        QUANTUMSIZE_QUANTUM_SIZE_28 = 0x7,
    } QUANTUMSIZE;
    inline void init() { // patched
        memset(&TheStructure, 0, sizeof(TheStructure));
        TheStructure.Common.DwordLength = DWORD_LENGTH_FIXED_SIZE;
        TheStructure.Common.CfeSubopcodeVariant = CFE_SUBOPCODE_VARIANT_STANDARD;
        TheStructure.Common.CfeSubopcode = CFE_SUBOPCODE_COMPUTE_WALKER_2;
        TheStructure.Common.ComputeCommandOpcode = COMPUTE_COMMAND_OPCODE_NEW_CFE_COMMAND;
        TheStructure.Common.Pipeline = PIPELINE_COMPUTE;
        TheStructure.Common.CommandType = COMMAND_TYPE_GFXPIPE;
        TheStructure.Common.ThreadDispatchPolicy = THREAD_DISPATCH_POLICY_BREADTH_WISE;
        ...
        TheStructure.Common.ThreadArbitrationPolicy = THREAD_ARBITRATION_POLICY_ALWAYS_ROUND_ROBIN;
        ...
        TheStructure.Common.EmitLocal = EMIT_LOCAL_EMIT_NONE;
        TheStructure.Common.PartitionType = PARTITION_TYPE_DISABLED;
        TheStructure.Common.DispatchAllModValue = DISPATCH_ALL_MOD_VALUE_MOD1;
        TheStructure.Common.Quantumsize = QUANTUMSIZE_QUANTUM_DISPATCH_DISABLED;
        TheStructure.Common.InterfaceDescriptor.init();
        TheStructure.Common.PostSync.init(); // patched
        TheStructure.Common.PostSyncOpn1.init();
        TheStructure.Common.PostSyncOpn2.init();
        TheStructure.Common.PostSyncOpn3.init();
    }
    static tagCOMPUTE_WALKER_2 sInit() {
        COMPUTE_WALKER_2 state{};
        state.init();
        return state;
    }
    inline uint32_t &getRawData(const uint32_t index) {
        UNRECOVERABLE_IF(index >= 64);
        return TheStructure.RawData[index];
    }
    inline void setDwordLength(const DWORD_LENGTH value) {
        TheStructure.Common.DwordLength = value;
    ...
    inline void setPreemptHighPri(const bool value) {
        TheStructure.Common.PreemptHighPri = value;
    }
    inline bool getPreemptHighPri() const {
        return TheStructure.Common.PreemptHighPri;
    }
    inline void setDispatchComplete(const bool value) {
        TheStructure.Common.DispatchComplete = value;
    }
    ...
    inline void setPostsyncAllocated(const bool value) {
        TheStructure.Common.PostsyncAllocated = value;
    }
    inline bool getPostsyncAllocated() const {
        return TheStructure.Common.PostsyncAllocated;
    }
    inline void setCfeSubopcodeVariant(const CFE_SUBOPCODE_VARIANT value) {
        TheStructure.Common.CfeSubopcodeVariant = value;
    }
    ...
    inline void setThreadDispatchPolicy(const THREAD_DISPATCH_POLICY value) {
        TheStructure.Common.ThreadDispatchPolicy = value;
    }
    inline THREAD_DISPATCH_POLICY getThreadDispatchPolicy() const {
        return static_cast<THREAD_DISPATCH_POLICY>(TheStructure.Common.ThreadDispatchPolicy);
    }
    ...
    inline void setThreadArbitrationPolicy(const THREAD_ARBITRATION_POLICY value) {
        TheStructure.Common.ThreadArbitrationPolicy = value;
    }
    inline THREAD_ARBITRATION_POLICY getThreadArbitrationPolicy() const {
        return static_cast<THREAD_ARBITRATION_POLICY>(TheStructure.Common.ThreadArbitrationPolicy);
    }
    ...
    inline uint32_t getMessageSimd() const { // patched
        return static_cast<uint32_t>(TheStructure.Common.MessageSimd);
    }
    inline void setTileLayout(const TILE_LAYOUT value) {
        TheStructure.Common.TileLayout = value;
    }
    ...
    inline uint32_t getWalkOrder() const { // patched
        return static_cast<uint32_t>(TheStructure.Common.WalkOrder);
    }
    inline void setEmitInlineParameter(const bool value) {
        TheStructure.Common.EmitInlineParameter = value;
    }
    ...
    inline uint32_t getEmitLocalId() const { // patched
        return static_cast<uint32_t>(TheStructure.Common.EmitLocal);
    }
    inline void setGenerateLocalId(const bool value) {
        TheStructure.Common.GenerateLocalId = value;
    }
    ...
    inline void setDispatchAllModValue(const DISPATCH_ALL_MOD_VALUE value) {
        TheStructure.Common.DispatchAllModValue = value;
    }
    inline DISPATCH_ALL_MOD_VALUE getDispatchAllModValue() const {
        return static_cast<DISPATCH_ALL_MOD_VALUE>(TheStructure.Common.DispatchAllModValue);
    }
    inline void setQuantumsize(const QUANTUMSIZE value) {
        TheStructure.Common.Quantumsize = value;
    }
    inline QUANTUMSIZE getQuantumsize() const {
        return static_cast<QUANTUMSIZE>(TheStructure.Common.Quantumsize);
    }
    inline void setQuantumLocalityCheckEnable(const bool value) {
        TheStructure.Common.QuantumLocalityCheckEnable = value;
    }
    inline bool getQuantumLocalityCheckEnable() const {
        return TheStructure.Common.QuantumLocalityCheckEnable;
    }
    inline void setXecuFullEmptyCheckEnable(const bool value) {
        TheStructure.Common.XecuFullEmptyCheckEnable = value;
    }
    inline bool getXecuFullEmptyCheckEnable() const {
        return TheStructure.Common.XecuFullEmptyCheckEnable;
    }
    inline void setPartitionSize(const uint64_t value) {
        TheStructure.Common.PartitionSize = value;
    }
    ...
    inline void setPostsyncId(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x7f);
        TheStructure.Common.PostsyncId = value;
    }
    inline uint32_t getPostsyncId() const {
        return TheStructure.Common.PostsyncId;
    }
    inline void setApqid(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x3f);
        TheStructure.Common.Apqid = value;
    }
    inline uint32_t getApqid() const {
        return TheStructure.Common.Apqid;
    }
    inline void setInterfaceDescriptor(const INTERFACE_DESCRIPTOR_DATA_2 &value) {
        TheStructure.Common.InterfaceDescriptor = value;
    }
    inline INTERFACE_DESCRIPTOR_DATA_2 &getInterfaceDescriptor() {
        return TheStructure.Common.InterfaceDescriptor;
    }
    inline void setPostSync(const POSTSYNC_DATA_2 &value) { // patched
        TheStructure.Common.PostSync = value;
    }
    inline POSTSYNC_DATA_2 &getPostSync() { // patched
        return TheStructure.Common.PostSync;
    }
    inline void setPostSyncOpn1(const POSTSYNC_DATA_2 &value) {
        TheStructure.Common.PostSyncOpn1 = value;
    }
    inline POSTSYNC_DATA_2 &getPostSyncOpn1() {
        return TheStructure.Common.PostSyncOpn1;
    }
    inline void setPostSyncOpn2(const POSTSYNC_DATA_2 &value) {
        TheStructure.Common.PostSyncOpn2 = value;
    }
    inline POSTSYNC_DATA_2 &getPostSyncOpn2() {
        return TheStructure.Common.PostSyncOpn2;
    }
    inline void setPostSyncOpn3(const POSTSYNC_DATA_2 &value) {
        TheStructure.Common.PostSyncOpn3 = value;
    }
    inline POSTSYNC_DATA_2 &getPostSyncOpn3() {
        return TheStructure.Common.PostSyncOpn3;
    }
    inline void setPreemptCsInterruptVector(const uint32_t value) {
        UNRECOVERABLE_IF(value > 0x3ff);
        TheStructure.Common.PreemptCsInterruptVector = value;
    }
    inline uint32_t getPreemptCsInterruptVector() const {
        return TheStructure.Common.PreemptCsInterruptVector;
    }
    inline uint32_t *getInlineDataPointer() { // patched
        return reinterpret_cast<uint32_t *>(&TheStructure.Common.InlineData);
    }
...
STATIC_ASSERT(256 == sizeof(COMPUTE_WALKER_2));
...
typedef struct tagMI_ARB_CHECK {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t DisableMultiQSwitching : BITFIELD_RANGE(1, 1); // patched
            uint32_t Reserved_2 : BITFIELD_RANGE(2, 7);
    ...
    inline void setDisableMultiQSwitching(const bool value) { // patched
        TheStructure.Common.DisableMultiQSwitching = value;
    }
    inline bool getDisableMultiQSwitching() const { // patched
        return TheStructure.Common.DisableMultiQSwitching;
    }
...
typedef struct tagSTATE_COMPUTE_MODE {
    union tagTheStructure {
        struct tagCommon {
            ...
            uint32_t LscSamplerBackingThreshold : BITFIELD_RANGE(5, 6);
            ...
            uint32_t Reserved_72 : BITFIELD_RANGE(8, 8);
            uint32_t PageFaultExceptionEnable : BITFIELD_RANGE(9, 9);
            uint32_t Reserved_74 : BITFIELD_RANGE(10, 10);
            uint32_t SystemMemoryReadFenceEnable : BITFIELD_RANGE(11, 11);
            uint32_t TdlRowArbitrationPolicy : BITFIELD_RANGE(12, 12);
            uint32_t MemoryExceptionEnable : BITFIELD_RANGE(13, 13);
            uint32_t EnableBreakpoints : BITFIELD_RANGE(14, 14);
            uint32_t EnableForceExternalHaltAndForceException : BITFIELD_RANGE(15, 15);
    ...
    typedef enum tagLSC_SAMPLER_BACKING_THRESHOLD { // patched
        LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_0 = 0x0,
        LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_1 = 0x1,
        LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_2 = 0x2,
        LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_3 = 0x3,
    } LSC_SAMPLER_BACKING_THRESHOLD;
    ...
    typedef enum tagOUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE {
        OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_DISABLE = 0x0,
        OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_ENABLE = 0x1,
    } OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE;
    typedef enum tagPAGE_FAULT_EXCEPTION_ENABLE {
        PAGE_FAULT_EXCEPTION_ENABLE_DISABLE = 0x0,
        PAGE_FAULT_EXCEPTION_ENABLE_ENABLE = 0x1,
    } PAGE_FAULT_EXCEPTION_ENABLE;
    typedef enum tagSYSTEM_MEMORY_READ_FENCE_ENABLE {
        SYSTEM_MEMORY_READ_FENCE_ENABLE_DISABLE = 0x0,
        SYSTEM_MEMORY_READ_FENCE_ENABLE_ENABLE = 0x1,
    } SYSTEM_MEMORY_READ_FENCE_ENABLE;
    typedef enum tagTDL_ROW_ARBITRATION_POLICY {
        TDL_ROW_ARBITRATION_POLICY_LEGACY_ROUND_ROBIN = 0x0,
        TDL_ROW_ARBITRATION_POLICY_ORDERED_ROUND_ROBIN = 0x1,
    } TDL_ROW_ARBITRATION_POLICY;
    typedef enum tagMEMORY_EXCEPTION_ENABLE {
        MEMORY_EXCEPTION_ENABLE_DISABLE = 0x0,
        MEMORY_EXCEPTION_ENABLE_ENABLE = 0x1,
    } MEMORY_EXCEPTION_ENABLE;
    typedef enum tagENABLE_BREAKPOINTS {
        ENABLE_BREAKPOINTS_DISABLE = 0x0,
        ENABLE_BREAKPOINTS_ENABLE = 0x1,
    } ENABLE_BREAKPOINTS;
    typedef enum tagENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION {
        ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_DISABLE = 0x0,
        ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_ENABLE = 0x1,
    } ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION;
    inline void init() {
        memset(&TheStructure, 0, sizeof(TheStructure));
        TheStructure.Common.DwordLength = DWORD_LENGTH_EXCLUDES_DWORD_0_1;
        ...
        TheStructure.Common.CommandType = COMMAND_TYPE_GFXPIPE;
        TheStructure.Common.ZPassAsyncComputeThreadLimit = Z_PASS_ASYNC_COMPUTE_THREAD_LIMIT_MAX_60;
        TheStructure.Common.LscSamplerBackingThreshold = LSC_SAMPLER_BACKING_THRESHOLD_LEVEL_0; // patched
        ...
        TheStructure.Common.OutOfBoundariesInTranslationExceptionEnable = OUT_OF_BOUNDARIES_IN_TRANSLATION_EXCEPTION_ENABLE_DISABLE;
        TheStructure.Common.PageFaultExceptionEnable = PAGE_FAULT_EXCEPTION_ENABLE_DISABLE;
        TheStructure.Common.SystemMemoryReadFenceEnable = SYSTEM_MEMORY_READ_FENCE_ENABLE_DISABLE;
        TheStructure.Common.TdlRowArbitrationPolicy = TDL_ROW_ARBITRATION_POLICY_LEGACY_ROUND_ROBIN;
        TheStructure.Common.MemoryExceptionEnable = MEMORY_EXCEPTION_ENABLE_DISABLE;
        TheStructure.Common.EnableBreakpoints = ENABLE_BREAKPOINTS_DISABLE;
        TheStructure.Common.EnableForceExternalHaltAndForceException = ENABLE_FORCE_EXTERNAL_HALT_AND_FORCE_EXCEPTION_DISABLE;
    }
    ...
    inline void setLscSamplerBackingThreshold(const LSC_SAMPLER_BACKING_THRESHOLD value) {
        TheStructure.Common.LscSamplerBackingThreshold = value;
    }
    inline LSC_SAMPLER_BACKING_THRESHOLD getLscSamplerBackingThreshold() const {
        return static_cast<LSC_SAMPLER_BACKING_THRESHOLD>(TheStructure.Common.LscSamplerBackingThreshold);
    }
    ...
    inline void setOutOfBoundariesInTranslationExceptionEnable(const bool value) { // patched
        TheStructure.Common.OutOfBoundariesInTranslationExceptionEnable = value;
    }
    inline bool getOutOfBoundariesInTranslationExceptionEnable() const { // patched
        return TheStructure.Common.OutOfBoundariesInTranslationExceptionEnable;
    }
    inline void setPageFaultExceptionEnable(const bool value) { // patched
        TheStructure.Common.PageFaultExceptionEnable = value;
    }
    inline bool getPageFaultExceptionEnable() const { // patched
        return TheStructure.Common.PageFaultExceptionEnable;
    }
    inline void setSystemMemoryReadFenceEnable(const bool value) { // patched
        TheStructure.Common.SystemMemoryReadFenceEnable = value;
    }
    inline SYSTEM_MEMORY_READ_FENCE_ENABLE getSystemMemoryReadFenceEnable() const {
        return static_cast<SYSTEM_MEMORY_READ_FENCE_ENABLE>(TheStructure.Common.SystemMemoryReadFenceEnable);
    }
    inline void setTdlRowArbitrationPolicy(const TDL_ROW_ARBITRATION_POLICY value) {
        TheStructure.Common.TdlRowArbitrationPolicy = value;
    }
    inline TDL_ROW_ARBITRATION_POLICY getTdlRowArbitrationPolicy() const {
        return static_cast<TDL_ROW_ARBITRATION_POLICY>(TheStructure.Common.TdlRowArbitrationPolicy);
    }
    inline void setMemoryExceptionEnable(const bool value) { // patched
        TheStructure.Common.MemoryExceptionEnable = value;
    }
    inline bool getMemoryExceptionEnable() const { // patched
        return TheStructure.Common.MemoryExceptionEnable;
    }
    inline void setEnableBreakpoints(const bool value) { // patched
        TheStructure.Common.EnableBreakpoints = value;
    }
    inline bool getEnableBreakpoints() const { // patched
        return TheStructure.Common.EnableBreakpoints;
    }
    inline void setEnableForceExternalHaltAndForceException(const bool value) { // patched
        TheStructure.Common.EnableForceExternalHaltAndForceException = value;
    }
    inline bool getEnableForceExternalHaltAndForceException() const { // patched
        return TheStructure.Common.EnableForceExternalHaltAndForceException;
    }
