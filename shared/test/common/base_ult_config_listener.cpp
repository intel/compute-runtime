...
#undef DECLARE_DEBUG_VARIABLE
    ...
    static_assert(sizeof(UltHwConfig) == (19 * sizeof(bool) + sizeof(const char *) + sizeof(ExecutionEnvironment *) + sizeof(UltHwConfig::padding)), ""); // Ensure that there is no internal padding
