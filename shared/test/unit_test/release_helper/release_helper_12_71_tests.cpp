...
TEST_F(ReleaseHelper1271Tests, whenIsPreImageReadFlushRequiredCalledThenFalseReturned) {
...
TEST_F(ReleaseHelper1271Tests, whenIsStateCacheInvalidationWaRequiredCalledThenTrueOnlyForImmediateAndImageOrSampler) {
