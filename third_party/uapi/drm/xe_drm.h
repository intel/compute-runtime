...
/**
 * DRM_XE_RESET_REQUIRED_UEVENT_REASON_GT - Reason provided to XE_RESET_REQUIRED_UEVENT
...
/**
 * DRM_XE_RESET_REQUIRED_UEVENT_REASON_GSC - Reason provided to XE_RESET_REQUIRED_UEVENT
 ...
 */
#define DRM_XE_RESET_REQUIRED_UEVENT_REASON_GSC "REASON=GSC_HW_ERROR"
...
#define XE_HW_ERROR(gt, id) \
	((id) | ((__u64)(gt) << __DRM_XE_PMU_GT_SHIFT))
