...
TEST_F(ReleaseHelper2001Tests, whenIsPreImageReadFlushRequiredCalledThenTrueReturned) {
...
TEST_F(ReleaseHelper2001Tests, whenIsStateCacheInvalidationWaRequiredCalledWithDebugFlagSetThenCorrectValueReturned) {
