...
using CmdParseTestsXe3pCore = ::testing::Test;

XE3P_CORETEST_F(CmdParseTestsXe3pCore, givenMiMemFenceCmdWhenParsingThenFindCommandAndsItsName) {
...
XE3P_CORETEST_F(CmdParseTestsXe3pCore, givenStateSystemMemFenceAddrCmdWhenParsingThenFindCommandAndsItsName) {
