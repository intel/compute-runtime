...
TEST_F(ReleaseHelper2004Tests, whenCallingAdjustMaxThreadsPerEuCountThenCorrectValueIsReturned) {
...
TEST_F(ReleaseHelper2004Tests, whenIsSlmLimitationTo96KNeededCalledThenFalseReturned) {
